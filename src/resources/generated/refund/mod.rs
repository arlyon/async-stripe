...
pub struct Refund {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub next_action: Option<crate::refund::next_action::NextAction>,
    ...
    pub source_transfer_reversal:
        Option<crate::Expandable<crate::transfer_reversal::TransferReversal>>,
    ...
    pub transfer_reversal: Option<crate::Expandable<crate::transfer_reversal::TransferReversal>>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for Refund {
    type Id = crate::refund::RefundId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(RefundId, "re_" | "pyr_");
pub mod next_action;
pub mod requests;

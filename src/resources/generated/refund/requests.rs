...
impl crate::refund::Refund {
    ...
    pub fn list(
        client: &Client,
        params: ListRefund,
    ) -> Response<crate::List<crate::refund::Refund>> {
        client.get_query("/refunds", params)
    }
    /// Create a refund.
    pub fn create(client: &Client, params: CreateRefund) -> Response<crate::refund::Refund> {
        client.send_form("/refunds", params, http_types::Method::Post)
    }
    /// Retrieves the details of an existing refund.
    pub fn retrieve(
        client: &Client,
        refund: &crate::refund::RefundId,
        params: RetrieveRefund,
    ) -> Response<crate::refund::Refund> {

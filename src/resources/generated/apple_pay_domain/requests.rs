...
impl crate::apple_pay_domain::ApplePayDomain {
    /// List apple pay domains.
    pub fn list(
        client: &Client,
        params: ListApplePayDomain,
    ) -> Response<crate::List<crate::apple_pay_domain::ApplePayDomain>> {
    ...
    ) -> Response<crate::apple_pay_domain::ApplePayDomain> {
    ...
    pub fn delete(
        client: &Client,
        domain: &str,
    ) -> Response<crate::apple_pay_domain::DeletedApplePayDomain> {
        client.send(

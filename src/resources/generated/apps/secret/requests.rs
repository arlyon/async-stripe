...
impl crate::apps::secret::Secret {
    /// Finds a secret in the secret store by name and scope.
    pub fn find(client: &Client, params: FindSecret) -> Response<crate::apps::secret::Secret> {
        client.get_query("/apps/secrets/find", params)
    }
    /// Create or replace a secret in the secret store.
    pub fn create(client: &Client, params: CreateSecret) -> Response<crate::apps::secret::Secret> {
    ...
    ) -> Response<crate::apps::secret::Secret> {
    ...
    pub fn list(
        client: &Client,
        params: ListSecret,
    ) -> Response<crate::List<crate::apps::secret::Secret>> {

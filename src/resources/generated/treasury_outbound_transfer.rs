...
impl OutboundTransfersResourceTreasuryReturnedDetailsCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            OutboundTransfersResourceTreasuryReturnedDetailsCode::BankAccountRestricted => "bank_account_restricted",
            OutboundTransfersResourceTreasuryReturnedDetailsCode::BankOwnershipChanged => "bank_ownership_changed",
            OutboundTransfersResourceTreasuryReturnedDetailsCode::Declined => "declined",
            OutboundTransfersResourceTreasuryReturnedDetailsCode::IncorrectAccountHolderName => "incorrect_account_holder_name",
            OutboundTransfersResourceTreasuryReturnedDetailsCode::InvalidAccountNumber => "invalid_account_number",
            OutboundTransfersResourceTreasuryReturnedDetailsCode::InvalidCurrency => "invalid_currency",

...
pub struct NextAction {
    ...
    pub redirect_to_url:
        Option<crate::setup_intent::next_action_redirect_to_url::NextActionRedirectToUrl>,
    ...
    pub verify_with_microdeposits: Option<
        crate::setup_intent::next_action::verify_with_microdeposits::VerifyWithMicrodeposits,
    >,
}
#[cfg(feature = "min-ser")]

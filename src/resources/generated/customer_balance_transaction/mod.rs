...
pub struct CustomerBalanceTransaction {
    ...
    pub credit_note: Option<crate::Expandable<crate::credit_note::CreditNote>>,
    ...
    pub id: crate::customer_balance_transaction::CustomerBalanceTransactionId,
...
impl crate::Object for CustomerBalanceTransaction {
    type Id = crate::customer_balance_transaction::CustomerBalanceTransactionId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(CustomerBalanceTransactionId);
pub mod requests;

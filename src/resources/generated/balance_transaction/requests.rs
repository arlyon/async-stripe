...
impl crate::balance_transaction::BalanceTransaction {
    ...
    ) -> Response<crate::List<crate::balance_transaction::BalanceTransaction>> {
    ...
    ) -> Response<crate::balance_transaction::BalanceTransaction> {
...
pub struct ListBalanceTransaction<'a> {
    ...
    pub available_on: Option<crate::RangeQueryTs>,
    #[serde(skip_serializing_if = "Option::is_none")]

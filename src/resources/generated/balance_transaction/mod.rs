...
pub struct BalanceTransaction {
    ...
    pub available_on: crate::Timestamp,
    ...
    pub fee_details: Vec<crate::balance_transaction::fee::Fee>,
    /// Unique identifier for the object.
    pub id: crate::balance_transaction::BalanceTransactionId,
    ...
    pub source:
        Option<crate::Expandable<crate::balance_transaction_source::BalanceTransactionSource>>,
...
impl crate::Object for BalanceTransaction {
    type Id = crate::balance_transaction::BalanceTransactionId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(BalanceTransactionId, "txn_");
pub mod fee;
pub mod requests;
pub use fee::Fee;

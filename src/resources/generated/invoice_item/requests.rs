...
impl crate::invoice_item::InvoiceItem {
    ...
    ) -> Response<crate::List<crate::invoice_item::InvoiceItem>> {
    ...
    ) -> Response<crate::invoice_item::InvoiceItem> {
        client.send_form("/invoiceitems", params, http_types::Method::Post)
    }
    /// Retrieves the invoice item with the given ID.
    pub fn retrieve(
        client: &Client,
        invoiceitem: &crate::invoice_item::InvoiceitemId,
    ...
    pub fn delete(
        client: &Client,
        invoiceitem: &crate::invoice_item::InvoiceitemId,
    ) -> Response<crate::invoice_item::DeletedInvoiceItem> {
        client.send(
            &format!("/invoiceitems/{invoiceitem}", invoiceitem = invoiceitem),

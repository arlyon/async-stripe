...
pub struct CountrySpec {
    ...
    pub default_currency: crate::Currency,
    /// Unique identifier for the object.
    ///
    /// Represented as the ISO country code for this country.
    pub id: crate::country_spec::CountrySpecId,
    ...
    pub verification_fields: crate::country_spec::verification_fields::VerificationFields,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for CountrySpec {
    type Id = crate::country_spec::CountrySpecId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(CountrySpecId);
pub mod requests;

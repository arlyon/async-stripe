...
impl InboundTransfersResourceFailureDetailsCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            InboundTransfersResourceFailureDetailsCode::BankAccountRestricted => "bank_account_restricted",
            InboundTransfersResourceFailureDetailsCode::BankOwnershipChanged => "bank_ownership_changed",
            InboundTransfersResourceFailureDetailsCode::DebitNotAuthorized => "debit_not_authorized",
            InboundTransfersResourceFailureDetailsCode::IncorrectAccountHolderAddress => "incorrect_account_holder_address",
            InboundTransfersResourceFailureDetailsCode::IncorrectAccountHolderName => "incorrect_account_holder_name",
            InboundTransfersResourceFailureDetailsCode::IncorrectAccountHolderTaxId => "incorrect_account_holder_tax_id",
            InboundTransfersResourceFailureDetailsCode::InsufficientFunds => "insufficient_funds",
            InboundTransfersResourceFailureDetailsCode::InvalidAccountNumber => "invalid_account_number",

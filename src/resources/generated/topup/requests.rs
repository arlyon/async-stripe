...
impl crate::topup::Topup {
    /// Top up the balance of an account.
    pub fn create(client: &Client, params: CreateTopup) -> Response<crate::topup::Topup> {
        client.send_form("/topups", params, http_types::Method::Post)
    }
    /// Returns a list of top-ups.
    pub fn list(client: &Client, params: ListTopup) -> Response<crate::List<crate::topup::Topup>> {
    ...
    pub fn retrieve(
        client: &Client,
        topup: &crate::topup::TopupId,
        params: RetrieveTopup,
    ) -> Response<crate::topup::Topup> {
...
pub struct ListTopup<'a> {
    /// A positive integer representing how much to transfer.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub amount: Option<crate::RangeQueryTs>,

...
pub struct Topup {
    ...
    /// May not be specified depending on status of top-up.
    pub expected_availability_date: Option<crate::Timestamp>,
    /// Error code explaining reason for top-up failure if available (see [the errors section](https://stripe.com/docs/api#errors) for a list of codes).
    pub failure_code: Option<String>,
    /// Message to user further explaining reason for top-up failure if available.
    pub failure_message: Option<String>,
    /// Unique identifier for the object.
    pub id: crate::topup::TopupId,
...
impl crate::Object for Topup {
    type Id = crate::topup::TopupId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TopupId, "tu_");
pub mod requests;

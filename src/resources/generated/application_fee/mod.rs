...
pub struct ApplicationFee {
    ...
    pub application: crate::Expandable<crate::application::Application>,
    ...
    pub id: crate::application_fee::ApplicationFeeId,
    ...
    pub originating_transaction: Option<crate::Expandable<crate::charge::Charge>>,
    ...
    pub refunds: crate::List<crate::fee_refund::FeeRefund>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for ApplicationFee {
    type Id = crate::application_fee::ApplicationFeeId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(ApplicationFeeId, "fee_");
pub mod requests;

...
impl AccountServiceResourceStatusDetailsCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            AccountServiceResourceStatusDetailsCode::CapabilityNotRequested => "capability_not_requested",
            AccountServiceResourceStatusDetailsCode::FinancialAccountClosed => "financial_account_closed",
            AccountServiceResourceStatusDetailsCode::RejectedOther => "rejected_other",
            AccountServiceResourceStatusDetailsCode::RejectedUnsupportedBusiness => "rejected_unsupported_business",
            AccountServiceResourceStatusDetailsCode::RequirementsPastDue => "requirements_past_due",
            AccountServiceResourceStatusDetailsCode::RequirementsPendingVerification => "requirements_pending_verification",
            AccountServiceResourceStatusDetailsCode::RestrictedByPlatform => "restricted_by_platform",
...
impl AccountServiceResourceStatusDetailsResolution {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            AccountServiceResourceStatusDetailsResolution::ProvideInformation => "provide_information",
            AccountServiceResourceStatusDetailsResolution::RemoveRestriction => "remove_restriction",
        }
    }
}

...
use crate::resources::{BillingDetails, CardDetails, CardPresent, Customer, PaymentFlowsPrivatePaymentMethodsAlipay, PaymentMethodAcssDebit, PaymentMethodAffirm, PaymentMethodAfterpayClearpay, PaymentMethodAlma, PaymentMethodAmazonPay, PaymentMethodAuBecsDebit, PaymentMethodBacsDebit, PaymentMethodBancontact, PaymentMethodBlik, PaymentMethodBoleto, PaymentMethodCashapp, PaymentMethodCustomerBalance, PaymentMethodEps, PaymentMethodFpx, PaymentMethodGiropay, PaymentMethodGrabpay, PaymentMethodIdeal, PaymentMethodInteracPresent, PaymentMethodKakaoPay, PaymentMethodKlarna, PaymentMethodKonbini, PaymentMethodKrCard, PaymentMethodLink, PaymentMethodMobilepay, PaymentMethodMultibanco, PaymentMethodNaverPay, PaymentMethodOxxo, PaymentMethodP24, PaymentMethodPayByBank, PaymentMethodPayco, PaymentMethodPaynow, PaymentMethodPaypal, PaymentMethodPix, PaymentMethodPromptpay, PaymentMethodRevolutPay, PaymentMethodSamsungPay, PaymentMethodSepaDebit, PaymentMethodSofort, PaymentMethodSwish, PaymentMethodTwint, PaymentMethodUsBankAccount, PaymentMethodWechatPay, PaymentMethodZip, RadarRadarOptions};
...
pub struct UpdatePaymentMethod<'a> {
    ...
    /// If this is a `naver_pay` PaymentMethod, this hash contains details about the Naver Pay payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub naver_pay: Option<UpdatePaymentMethodNaverPay>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentMethodNaverPay {

    /// Whether to use Naver Pay points or a card to fund this transaction.
    ///
    /// If not provided, this defaults to `card`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub funding: Option<UpdatePaymentMethodNaverPayFunding>,
}
...
/// An enum representing the possible values of an `UpdatePaymentMethodNaverPay`'s `funding` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum UpdatePaymentMethodNaverPayFunding {
    Card,
    Points,
}

impl UpdatePaymentMethodNaverPayFunding {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentMethodNaverPayFunding::Card => "card",
            UpdatePaymentMethodNaverPayFunding::Points => "points",
        }
    }
}

impl AsRef<str> for UpdatePaymentMethodNaverPayFunding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for UpdatePaymentMethodNaverPayFunding {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for UpdatePaymentMethodNaverPayFunding {
    fn default() -> Self {
        Self::Card
    }
}

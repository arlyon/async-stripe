...
pub struct ForwardingRequest {
    ...
    /// The Forwarding Config used when making the forwarded request.
    ///
    /// The config specifes the HTTP method, merchant credentials, connection settings, and supported destination URLs.
    pub config: String,

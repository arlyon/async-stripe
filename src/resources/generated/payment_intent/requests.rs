...
impl crate::payment_intent::PaymentIntent {
    ...
    ) -> Response<crate::payment_intent::PaymentIntent> {
    ...
    ) -> Response<crate::List<crate::payment_intent::PaymentIntent>> {
...
pub struct SearchReturned {
    pub data: Vec<crate::payment_intent::PaymentIntent>,
    pub has_more: bool,

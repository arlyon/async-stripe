...
pub struct Card {
    ...
    pub installments:
        Option<crate::payment_intent::payment_method_options::card::installments::Installments>,
    /// Configuration options for setting up an eMandate for cards issued in India.
    pub mandate_options: Option<
        crate::payment_intent::payment_method_options::card::mandate_options::MandateOptions,
    >,

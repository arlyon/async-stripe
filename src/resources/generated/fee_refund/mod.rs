...
pub struct FeeRefund {
    ...
    pub fee: crate::Expandable<crate::application_fee::ApplicationFee>,
    /// Unique identifier for the object.
    pub id: crate::fee_refund::FeeRefundId,
...
impl crate::Object for FeeRefund {
    type Id = crate::fee_refund::FeeRefundId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(FeeRefundId);
pub mod requests;

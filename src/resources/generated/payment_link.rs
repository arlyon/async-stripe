...
pub struct PaymentLink {
    ...
    ///
    /// If `false`, customers visiting the url will be redirected.
    pub active: bool,
    ...
    ///
    /// When `null`, your [payment methods settings](https://dashboard.stripe.com/settings/payment_methods) will be used.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CreatePaymentLink<'a> {
    ...
    /// The list of payment method types (e.g., card) that customers can use.
    ///
    /// Only `card` is supported.
    /// If no value is passed, your [payment methods settings](https://dashboard.stripe.com/settings/payment_methods) will be used.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct UpdatePaymentLink<'a> {
    ...
    ///
    /// Only `card` is supported.
    /// Pass an empty string to enable automatic payment methods that use your [payment methods settings](https://dashboard.stripe.com/settings/payment_methods).
    #[serde(skip_serializing_if = "Option::is_none")]

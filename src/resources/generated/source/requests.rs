...
impl crate::source::Source {
    ...
    ) -> Response<crate::source::Source> {
        client.get_query(&format!("/sources/{source}", source = source), params)
    }
    /// Creates a new source object.
    pub fn create(client: &Client, params: CreateSource) -> Response<crate::source::Source> {
    ...
    ) -> Response<crate::List<crate::source_transaction::SourceTransaction>> {

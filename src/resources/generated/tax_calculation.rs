...
use crate::resources::{Currency, TaxCalculationLineItem, TaxProductResourceCustomerDetails, TaxProductResourceShipFromDetails};
use serde::{Deserialize, Serialize};

/// The resource representing a Stripe "TaxProductResourceTaxCalculation".
///
/// For more details see <https://stripe.com/api/tax/calculations/object>

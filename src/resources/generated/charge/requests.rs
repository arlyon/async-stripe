...
impl crate::charge::Charge {
    ...
    pub fn list(
        client: &Client,
        params: ListCharge,
    ) -> Response<crate::List<crate::charge::Charge>> {
    ...
    pub fn create(client: &Client, params: CreateCharge) -> Response<crate::charge::Charge> {
    ...
    pub fn retrieve(
        client: &Client,
        charge: &crate::charge::ChargeId,
        params: RetrieveCharge,
    ) -> Response<crate::charge::Charge> {
...
pub struct SearchReturned {
    pub data: Vec<crate::charge::Charge>,
    pub has_more: bool,

...
pub struct Session {
    ...
    pub configuration: crate::Expandable<crate::billing_portal::configuration::Configuration>,
    ...
    pub id: crate::billing_portal::session::BillingPortalSessionId,
...
impl crate::Object for Session {
    type Id = crate::billing_portal::session::BillingPortalSessionId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(BillingPortalSessionId, "bps_");
pub mod requests;

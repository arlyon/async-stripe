...
pub struct Configuration {
    ...
    pub business_profile: crate::billing_portal::configuration::business_profile::BusinessProfile,
    ...
    pub features: crate::billing_portal::configuration::features::Features,
    /// Unique identifier for the object.
    pub id: crate::billing_portal::configuration::BillingPortalConfigurationId,
    ...
    pub livemode: bool,
    pub login_page: crate::billing_portal::configuration::login_page::LoginPage,
...
impl crate::Object for Configuration {
    type Id = crate::billing_portal::configuration::BillingPortalConfigurationId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(BillingPortalConfigurationId, "bpc_");

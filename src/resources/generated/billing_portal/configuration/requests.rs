...
impl crate::billing_portal::configuration::Configuration {
    /// Returns a list of configurations that describe the functionality of the customer portal.
    pub fn list(
        client: &Client,
        params: ListConfiguration,
    ) -> Response<crate::List<crate::billing_portal::configuration::Configuration>> {
    ...
    ) -> Response<crate::billing_portal::configuration::Configuration> {

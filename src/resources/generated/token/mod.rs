...
pub struct Token {
    ...
    pub bank_account: Option<crate::bank_account::BankAccount>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl crate::Object for Token {
    type Id = crate::token::TokenId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TokenId);
pub mod requests;

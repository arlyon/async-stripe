...
impl crate::plan::Plan {
    /// Returns a list of your plans.
    pub fn list(client: &Client, params: ListPlan) -> Response<crate::List<crate::plan::Plan>> {
    ...
    pub fn create(client: &Client, params: CreatePlan) -> Response<crate::plan::Plan> {
    ...
    pub fn delete(
        client: &Client,
        plan: &crate::plan::PlanId,
    ) -> Response<crate::plan::DeletedPlan> {
...
impl<'a> CreatePlan<'a> {
    pub fn new(currency: crate::Currency, interval: CreatePlanInterval) -> Self {
        Self {

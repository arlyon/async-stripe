...
pub struct SubscriptionSchedule {
    ...
    pub current_phase: Option<crate::subscription_schedule::current_phase::CurrentPhase>,
    /// ID of the customer who owns the subscription schedule.
    pub customer: crate::Expandable<crate::customer::Customer>,
    pub default_settings: crate::subscription_schedule::default_settings::DefaultSettings,
    /// Behavior of the subscription schedule and underlying subscription when it ends.
    ///
    /// Possible values are `release` and `cancel`.
    pub end_behavior: SubscriptionScheduleEndBehavior,
    /// Unique identifier for the object.
    pub id: crate::subscription_schedule::SubscriptionScheduleId,
    ...
    pub phases: Vec<crate::subscription_schedule::phase::Phase>,
    /// Time at which the subscription schedule was released.
    ///
    /// Measured in seconds since the Unix epoch.
    pub released_at: Option<crate::Timestamp>,
...
impl crate::Object for SubscriptionSchedule {
    type Id = crate::subscription_schedule::SubscriptionScheduleId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(SubscriptionScheduleId, "sub_sched_");

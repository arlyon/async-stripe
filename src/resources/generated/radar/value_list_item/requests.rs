...
impl crate::radar::value_list_item::ValueListItem {
    ...
    ) -> Response<crate::List<crate::radar::value_list_item::ValueListItem>> {
    ...
    ) -> Response<crate::radar::value_list_item::ValueListItem> {
    ...
    pub fn delete(
        client: &Client,
        item: &crate::line_item::ItemId,
    ) -> Response<crate::radar::value_list_item::DeletedValueListItem> {
        client.send(

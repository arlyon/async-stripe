...
impl crate::radar::early_fraud_warning::EarlyFraudWarning {
    /// Returns a list of early fraud warnings.
    pub fn list(
        client: &Client,
        params: ListEarlyFraudWarning,
    ) -> Response<crate::List<crate::radar::early_fraud_warning::EarlyFraudWarning>> {
    ...
    ) -> Response<crate::radar::early_fraud_warning::EarlyFraudWarning> {
        client.get_query(
            &format!(

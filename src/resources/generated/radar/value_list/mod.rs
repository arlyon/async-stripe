...
pub struct ValueList {
    ...
    pub id: crate::radar::value_list::RadarValueListId,
    ...
    pub list_items: crate::List<crate::radar::value_list_item::ValueListItem>,
...
impl crate::Object for ValueList {
    type Id = crate::radar::value_list::RadarValueListId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(RadarValueListId);
pub mod deleted;
pub mod requests;

...
impl crate::radar::value_list::ValueList {
    ...
    ) -> Response<crate::List<crate::radar::value_list::ValueList>> {
    ...
    ) -> Response<crate::radar::value_list::ValueList> {
        client
    ...
    pub fn delete(
        client: &Client,
        value_list: &str,
    ) -> Response<crate::radar::value_list::DeletedValueList> {
        client.send(
            &format!("/radar/value_lists/{value_list}", value_list = value_list),

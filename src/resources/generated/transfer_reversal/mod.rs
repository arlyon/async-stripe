...
pub struct TransferReversal {
    ...
    pub destination_payment_refund: Option<crate::Expandable<crate::refund::Refund>>,
    /// Unique identifier for the object.
    pub id: crate::transfer_reversal::TransferReversalId,
    ...
    pub source_refund: Option<crate::Expandable<crate::refund::Refund>>,
    /// ID of the transfer that was reversed.
    pub transfer: crate::Expandable<crate::transfer::Transfer>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for TransferReversal {
    type Id = crate::transfer_reversal::TransferReversalId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TransferReversalId, "trr_");
pub mod requests;

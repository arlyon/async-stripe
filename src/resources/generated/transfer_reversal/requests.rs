...
impl crate::transfer_reversal::TransferReversal {
    ...
    ) -> Response<crate::transfer_reversal::TransferReversal> {
        client.send_form(
    ...
    ) -> Response<crate::List<crate::transfer_reversal::TransferReversal>> {

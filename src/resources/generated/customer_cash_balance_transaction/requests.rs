...
impl crate::customer_cash_balance_transaction::CustomerCashBalanceTransaction {
    ...
    pub fn list(
        ...
        crate::List<crate::customer_cash_balance_transaction::CustomerCashBalanceTransaction>,
    > {
        client.get_query(

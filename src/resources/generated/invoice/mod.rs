...
pub struct Invoice {
    ...
    pub account_tax_ids: Option<Vec<crate::Expandable<crate::tax_id::TaxId>>>,
    ...
    pub automatic_tax: crate::invoice::automatic_tax::AutomaticTax,
    ...
    pub customer_address: Option<crate::address::Address>,
    ...
    /// Once the invoice is finalized, this field will no longer be updated.
    pub customer_shipping: Option<crate::shipping_details::ShippingDetails>,
    ...
    /// Once the invoice is finalized, this field will no longer be updated.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub customer_tax_ids: Option<Vec<crate::invoice::customer_tax_id::CustomerTaxId>>,
    ...
    pub default_tax_rates: Vec<crate::tax_rate::TaxRate>,
    ...
    pub due_date: Option<crate::Timestamp>,
    ...
    pub from_invoice: Option<crate::invoice::from_invoice::FromInvoice>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<crate::invoice::InvoiceId>,
    ...
    pub last_finalization_error: Option<Box<crate::api_errors::ApiErrors>>,
    /// The ID of the most recent non-draft revision of this invoice.
    pub latest_revision: Option<crate::Expandable<crate::invoice::Invoice>>,
    /// The individual line items that make up the invoice.
    ///
    /// `lines` is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
    pub lines: crate::List<crate::invoice_line_item::InvoiceLineItem>,
    ...
    pub next_payment_attempt: Option<crate::Timestamp>,
    ...
    pub payment_settings: crate::invoice::payment_settings::PaymentSettings,
    /// End of the usage period during which invoice items were added to this invoice.
    pub period_end: crate::Timestamp,
    /// Start of the usage period during which invoice items were added to this invoice.
    pub period_start: crate::Timestamp,
    /// Total amount of all post-payment credit notes issued for this invoice.
    pub post_payment_credit_notes_amount: i64,
    /// Total amount of all pre-payment credit notes issued for this invoice.
    pub pre_payment_credit_notes_amount: i64,
    /// The quote this invoice was generated from.
    pub quote: Option<crate::Expandable<crate::quote::Quote>>,
    ...
    pub status_transitions: crate::invoice::status_transitions::StatusTransitions,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subscription_proration_date: Option<crate::Timestamp>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub threshold_reason: Option<crate::invoice::threshold_reason::ThresholdReason>,
    /// Total after discounts and taxes.
    pub total: i64,
    /// The aggregate amounts calculated per discount across all line items.
    pub total_discount_amounts: Option<Vec<crate::discount_amount::DiscountAmount>>,
    ...
    pub total_tax_amounts: Vec<crate::invoice::tax_amount::TaxAmount>,
    /// The account (if any) the payment will be attributed to for tax reporting, and where funds from the payment will be transferred to for the invoice.
    pub transfer_data: Option<crate::invoice::transfer_data::TransferData>,
    ...
    pub webhooks_delivered_at: Option<crate::Timestamp>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for Invoice {
    type Id = Option<crate::invoice::InvoiceId>;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(InvoiceId, "in_");
pub mod deleted;
pub mod requests;

...
impl crate::invoice::Invoice {
    ...
    pub fn list(
        client: &Client,
        params: ListInvoice,
    ) -> Response<crate::List<crate::invoice::Invoice>> {
    ...
    pub fn upcoming(client: &Client, params: UpcomingInvoice) -> Response<crate::invoice::Invoice> {
    ...
    pub fn create(client: &Client, params: CreateInvoice) -> Response<crate::invoice::Invoice> {
    ...
    ) -> Response<crate::invoice::Invoice> {
    ...
    pub fn delete(
        client: &Client,
        invoice: &crate::invoice::InvoiceId,
    ) -> Response<crate::invoice::DeletedInvoice> {
...
pub struct SearchReturned {
    pub data: Vec<crate::invoice::Invoice>,
    pub has_more: bool,
...
pub struct ListInvoice<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub due_date: Option<crate::RangeQueryTs>,
...
pub struct UpcomingInvoice<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subscription_cancel_at: Option<crate::Timestamp>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subscription_start_date: Option<crate::Timestamp>,
...
impl UpcomingInvoiceInvoiceItemsPeriod {
    pub fn new(end: crate::Timestamp, start: crate::Timestamp) -> Self {
        Self { end, start }
    }
}
/// Data used to generate a new [Price](https://stripe.com/docs/api/prices) object inline.

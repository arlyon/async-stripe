...
impl crate::transfer::Transfer {
    ...
    pub fn create(client: &Client, params: CreateTransfer) -> Response<crate::transfer::Transfer> {
    ...
    pub fn list(
        client: &Client,
        params: ListTransfer,
    ) -> Response<crate::List<crate::transfer::Transfer>> {
    ...
    ) -> Response<crate::transfer::Transfer> {
...
impl<'a> CreateTransfer<'a> {
    pub fn new(currency: crate::Currency, destination: &'a str) -> Self {
        Self {

...
impl crate::sigma::scheduled_query_run::ScheduledQueryRun {
    /// Returns a list of scheduled query runs.
    pub fn list(
        client: &Client,
        params: ListScheduledQueryRun,
    ) -> Response<crate::List<crate::sigma::scheduled_query_run::ScheduledQueryRun>> {
        client.get_query("/sigma/scheduled_query_runs", params)
    }
    /// Retrieves the details of an scheduled query run.
    pub fn retrieve(
        client: &Client,
        scheduled_query_run: &crate::sigma::scheduled_query_run::ScheduledQueryRunId,
        params: RetrieveScheduledQueryRun,
    ) -> Response<crate::sigma::scheduled_query_run::ScheduledQueryRun> {
        client.get_query(
            &format!(

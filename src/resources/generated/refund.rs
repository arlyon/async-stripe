...
pub struct Refund {
    ...
    pub failure_reason: Box<Option<String>>,
    ...
    pub source_transfer_reversal: Box<Option<Expandable<TransferReversal>>>,
    ...
    pub transfer_reversal: Box<Option<Expandable<TransferReversal>>>,
}

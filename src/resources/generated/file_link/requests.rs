...
impl crate::file_link::FileLink {
    /// Retrieves the file link with the given ID.
    pub fn retrieve(
        client: &Client,
        link: &str,
        params: RetrieveFileLink,
    ) -> Response<crate::file_link::FileLink> {
        client.get_query(&format!("/file_links/{link}", link = link), params)
    }
    /// Creates a new file link object.
    pub fn create(client: &Client, params: CreateFileLink) -> Response<crate::file_link::FileLink> {
    ...
    pub fn list(
        client: &Client,
        params: ListFileLink,
    ) -> Response<crate::List<crate::file_link::FileLink>> {

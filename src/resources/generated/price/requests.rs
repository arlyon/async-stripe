...
impl crate::price::Price {
    ...
    pub fn list(client: &Client, params: ListPrice) -> Response<crate::List<crate::price::Price>> {
        client.get_query("/prices", params)
    }
    /// Creates a new price for an existing product.
    ///
    /// The price can be recurring or one-time.
    pub fn create(client: &Client, params: CreatePrice) -> Response<crate::price::Price> {
        client.send_form("/prices", params, http_types::Method::Post)
    }
    /// Retrieves the price with the given ID.
    pub fn retrieve(
        client: &Client,
        price: &crate::price::PriceId,
        params: RetrievePrice,
    ) -> Response<crate::price::Price> {
...
pub struct SearchReturned {
    pub data: Vec<crate::price::Price>,
    pub has_more: bool,

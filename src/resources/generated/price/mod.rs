...
pub struct Price {
    ...
    pub currency_options: Option<crate::price::currency_option::CurrencyOption>,
    /// When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
    pub custom_unit_amount: Option<crate::price::custom_unit_amount::CustomUnitAmount>,
    /// Unique identifier for the object.
    pub id: crate::price::PriceId,
    ...
    pub recurring: Option<crate::price::recurring::Recurring>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tiers: Option<Vec<crate::price::tier::Tier>>,
    ...
    pub transform_quantity: Option<crate::price::transform_quantity::TransformQuantity>,
...
impl crate::Object for Price {
    type Id = crate::price::PriceId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(PriceId, "price_");
pub mod deleted;
pub mod requests;

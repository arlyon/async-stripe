...
use crate::resources::{Currency, Payout, TreasuryCreditReversal, TreasuryOutboundPayment, TreasuryTransaction, UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails};
...
pub struct TreasuryReceivedCredit {
    ...
    pub initiating_payment_method_details: UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails,
...
impl ReceivedCreditsResourceTreasurySourceFlowsDetailsType {
    pub fn as_str(self) -> &'static str {
        match self {
            ReceivedCreditsResourceTreasurySourceFlowsDetailsType::CreditReversal => "credit_reversal",
            ReceivedCreditsResourceTreasurySourceFlowsDetailsType::Other => "other",
            ReceivedCreditsResourceTreasurySourceFlowsDetailsType::OutboundPayment => "outbound_payment",

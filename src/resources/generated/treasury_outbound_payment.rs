...
impl OutboundPaymentsResourceTreasuryReturnedStatusCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            OutboundPaymentsResourceTreasuryReturnedStatusCode::BankAccountRestricted => "bank_account_restricted",
            OutboundPaymentsResourceTreasuryReturnedStatusCode::BankOwnershipChanged => "bank_ownership_changed",
            OutboundPaymentsResourceTreasuryReturnedStatusCode::Declined => "declined",
            OutboundPaymentsResourceTreasuryReturnedStatusCode::IncorrectAccountHolderName => "incorrect_account_holder_name",
            OutboundPaymentsResourceTreasuryReturnedStatusCode::InvalidAccountNumber => "invalid_account_number",
            OutboundPaymentsResourceTreasuryReturnedStatusCode::InvalidCurrency => "invalid_currency",

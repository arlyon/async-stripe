...
impl crate::subscription_item::SubscriptionItem {
    /// Returns a list of your subscription items for a given subscription.
    pub fn list(
        client: &Client,
        params: ListSubscriptionItem,
    ) -> Response<crate::List<crate::subscription_item::SubscriptionItem>> {
        client.get_query("/subscription_items", params)
    }
    /// Retrieves the subscription item with the given ID.
    pub fn retrieve(
        client: &Client,
        item: &crate::line_item::ItemId,
        params: RetrieveSubscriptionItem,
    ) -> Response<crate::subscription_item::SubscriptionItem> {
    ...
    ) -> Response<crate::subscription_item::DeletedSubscriptionItem> {
        client.send_form(
            &format!("/subscription_items/{item}", item = item),
            params,
    ...
    pub fn usage_record_summaries(
        client: &Client,
        subscription_item: &crate::subscription_item::SubscriptionItemId,
        params: UsageRecordSummariesSubscriptionItem,
    ) -> Response<crate::List<crate::usage_record_summary::UsageRecordSummary>> {
        client.get_query(
            &format!(
...
pub struct CreateSubscriptionItem<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proration_date: Option<crate::Timestamp>,

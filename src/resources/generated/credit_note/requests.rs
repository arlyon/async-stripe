...
impl crate::credit_note::CreditNote {
    ...
    ) -> Response<crate::credit_note::CreditNote> {
    ...
    ) -> Response<crate::List<crate::credit_note::CreditNote>> {
    ...
    ) -> Response<crate::List<crate::credit_note_line_item::CreditNoteLineItem>> {

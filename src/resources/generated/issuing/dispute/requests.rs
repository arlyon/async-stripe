...
impl crate::issuing::dispute::Dispute {
    ...
    pub fn list(
        client: &Client,
        params: ListDispute,
    ) -> Response<crate::List<crate::issuing::dispute::Dispute>> {
    ...
    ) -> Response<crate::issuing::dispute::Dispute> {
    ...
    pub fn update(
        client: &Client,
        dispute: &crate::dispute::DisputeId,

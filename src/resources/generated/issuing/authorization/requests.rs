...
impl crate::issuing::authorization::Authorization {
    ...
    ) -> Response<crate::List<crate::issuing::authorization::Authorization>> {
    ...
    ) -> Response<crate::issuing::authorization::Authorization> {
        client.get_query(

...
pub struct Authorization {
    ...
    pub card: crate::issuing::card::Card,
    /// The cardholder to whom this authorization belongs.
    pub cardholder: Option<crate::Expandable<crate::issuing::cardholder::Cardholder>>,
    ...
    pub id: crate::issuing::authorization::IssuingAuthorizationId,
    ...
    pub merchant_data: crate::issuing::authorization::merchant_data::MerchantData,
    /// Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object.
    ///
    /// This can be useful for storing additional information about the object in a structured format.
    pub metadata: crate::Metadata,
    /// Details about the authorization, such as identifiers, set by the card network.
    pub network_data: Option<crate::issuing::authorization::network_data::NetworkData>,
    ...
    pub pending_request: Option<crate::issuing::authorization::pending_request::PendingRequest>,
    ...
    pub request_history: Vec<crate::issuing::authorization::request_history::RequestHistory>,
    /// The current status of the authorization in its lifecycle.
    pub status: AuthorizationStatus,
    /// List of [transactions](https://stripe.com/docs/api/issuing/transactions) associated with this authorization.
    pub transactions: Vec<crate::issuing::transaction::Transaction>,
    /// [Treasury](https://stripe.com/docs/api/treasury) details related to this authorization if it was created on a [FinancialAccount](https://stripe.com/docs/api/treasury/financial_accounts).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub treasury: Option<crate::issuing::authorization::treasury::Treasury>,
    pub verification_data: crate::issuing::authorization::verification_data::VerificationData,
...
impl crate::Object for Authorization {
    type Id = crate::issuing::authorization::IssuingAuthorizationId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(IssuingAuthorizationId, "iauth_");

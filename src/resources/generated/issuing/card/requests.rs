...
impl crate::issuing::card::Card {
    ...
    pub fn list(
        client: &Client,
        params: ListCard,
    ) -> Response<crate::List<crate::issuing::card::Card>> {
        client.get_query("/issuing/cards", params)
    }
    /// Creates an Issuing `Card` object.
    pub fn create(client: &Client, params: CreateCard) -> Response<crate::issuing::card::Card> {
    ...
    pub fn retrieve(
        ...
        params: RetrieveCard,
    ) -> Response<crate::issuing::card::Card> {
...
impl<'a> CreateCard<'a> {
    pub fn new(currency: crate::Currency, type_: CreateCardType) -> Self {
        Self {

...
pub struct Transaction {
    ...
    pub amount_details: Option<crate::issuing::transaction::amount_details::AmountDetails>,
    /// The `Authorization` object that led to this transaction.
    pub authorization: Option<crate::Expandable<crate::issuing::authorization::Authorization>>,
    /// ID of the [balance transaction](https://stripe.com/docs/api/balance_transactions) associated with this transaction.
    pub balance_transaction:
        Option<crate::Expandable<crate::balance_transaction::BalanceTransaction>>,
    /// The card used to make this transaction.
    pub card: crate::Expandable<crate::issuing::card::Card>,
    ...
    pub dispute: Option<crate::Expandable<crate::issuing::dispute::Dispute>>,
    /// Unique identifier for the object.
    pub id: crate::issuing::transaction::IssuingTransactionId,
    ...
    pub purchase_details: Option<crate::issuing::transaction::purchase_details::PurchaseDetails>,
    /// [Treasury](https://stripe.com/docs/api/treasury) details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub treasury: Option<crate::issuing::transaction::treasury::Treasury>,
...
impl crate::Object for Transaction {
    type Id = crate::issuing::transaction::IssuingTransactionId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(IssuingTransactionId, "ipi_");

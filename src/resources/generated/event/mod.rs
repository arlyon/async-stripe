...
pub struct Event {
    ...
    pub data: crate::event_data::EventData,
    ...
    pub request: Option<crate::event_request::EventRequest>,
...
impl crate::Object for Event {
    type Id = crate::event::EventId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(EventId, "evt_");
pub mod requests;

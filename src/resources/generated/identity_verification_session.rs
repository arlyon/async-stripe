...
pub struct IdentityVerificationSession {
    ...
    ///
    /// [Learn more about accessing detailed verification results.](https://stripe.com/docs/identity/verification-checks).
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    ///
    /// This URL expires after 24 hours and can only be used once.

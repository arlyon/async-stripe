...
impl crate::treasury::financial_account::FinancialAccount {
    ...
    ) -> Response<crate::treasury::financial_account::FinancialAccount> {
    ...
    ) -> Response<crate::treasury::financial_account_features::FinancialAccountFeatures> {
        client.send_form(
            &format!(
    ...
    ) -> Response<crate::List<crate::treasury::financial_account::FinancialAccount>> {

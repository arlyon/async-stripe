...
impl crate::treasury::transaction_entry::TransactionEntry {
    /// Retrieves a TransactionEntry object.
    pub fn retrieve(
        client: &Client,
        id: &str,
        params: RetrieveTransactionEntry,
    ) -> Response<crate::treasury::transaction_entry::TransactionEntry> {
    ...
    ) -> Response<crate::List<crate::treasury::transaction_entry::TransactionEntry>> {
...
pub struct ListTransactionEntry<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub effective_at: Option<crate::RangeQueryTs>,

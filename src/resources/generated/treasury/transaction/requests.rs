...
impl crate::treasury::transaction::Transaction {
    /// Retrieves the details of an existing Transaction.
    pub fn retrieve(
        client: &Client,
        id: &str,
        params: RetrieveTransaction,
    ) -> Response<crate::treasury::transaction::Transaction> {
    ...
    ) -> Response<crate::List<crate::treasury::transaction::Transaction>> {
...
pub struct ListTransactionStatusTransitions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub posted_at: Option<crate::RangeQueryTs>,
}

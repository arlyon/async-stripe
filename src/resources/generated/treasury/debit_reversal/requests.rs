...
impl crate::treasury::debit_reversal::DebitReversal {
    /// Reverses a ReceivedDebit and creates a DebitReversal object.
    pub fn create(
        client: &Client,
        params: CreateDebitReversal,
    ) -> Response<crate::treasury::debit_reversal::DebitReversal> {
    ...
    ) -> Response<crate::List<crate::treasury::debit_reversal::DebitReversal>> {

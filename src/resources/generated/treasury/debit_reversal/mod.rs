...
pub struct DebitReversal {
    ...
    pub id: crate::treasury::debit_reversal::TreasuryDebitReversalId,
    /// Other flows linked to a DebitReversal.
    pub linked_flows: Option<crate::treasury::debit_reversal::linked_flows::LinkedFlows>,
    ...
    pub status_transitions: crate::treasury::received_debit::status_transitions::StatusTransitions,
...
impl crate::Object for DebitReversal {
    type Id = crate::treasury::debit_reversal::TreasuryDebitReversalId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TreasuryDebitReversalId);

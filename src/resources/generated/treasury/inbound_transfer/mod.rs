...
pub failure_details: Option<crate::treasury::inbound_transfer::failure_details::FailureDetails>,
    /// The FinancialAccount that received the funds.
pub financial_account: String,
    /// A [hosted transaction receipt](https://stripe.com/docs/treasury/moving-money/regulatory-receipts) URL that is provided when money movement is considered regulated under Stripe's money transmission licenses.
pub hosted_regulatory_receipt_url: Option<String>,
    /// Unique identifier for the object.
pub id: crate::treasury::inbound_transfer::TreasuryInboundTransferId,
pub linked_flows: crate::treasury::inbound_transfer::linked_flows::LinkedFlows,
...
pub origin_payment_method_details: Option<crate::treasury::inbound_transfer::origin_payment_method_details::OriginPaymentMethodDetails>,
...
pub status_transitions: crate::treasury::inbound_transfer::status_transitions::StatusTransitions,
...
impl crate::Object for InboundTransfer {
    type Id = crate::treasury::inbound_transfer::TreasuryInboundTransferId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TreasuryInboundTransferId);

...
impl crate::treasury::inbound_transfer::InboundTransfer {
    /// Cancels an InboundTransfer.
    pub fn cancel(
        client: &Client,
        inbound_transfer: &str,
        params: CancelInboundTransfer,
    ) -> Response<crate::treasury::inbound_transfer::InboundTransfer> {
        client.send_form(
            &format!(
    ...
    ) -> Response<crate::List<crate::treasury::inbound_transfer::InboundTransfer>> {

...
impl crate::treasury::outbound_payment::OutboundPayment {
    /// Creates an OutboundPayment.
    pub fn create(
        client: &Client,
        params: CreateOutboundPayment,
    ) -> Response<crate::treasury::outbound_payment::OutboundPayment> {
    ...
    ) -> Response<crate::List<crate::treasury::outbound_payment::OutboundPayment>> {

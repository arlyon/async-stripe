...
impl crate::treasury::outbound_transfer::OutboundTransfer {
    /// Creates an OutboundTransfer.
    pub fn create(
        client: &Client,
        params: CreateOutboundTransfer,
    ) -> Response<crate::treasury::outbound_transfer::OutboundTransfer> {
    ...
    ) -> Response<crate::List<crate::treasury::outbound_transfer::OutboundTransfer>> {
...
impl<'a> CreateOutboundTransfer<'a> {
    pub fn new(amount: i64, currency: crate::Currency, financial_account: &'a str) -> Self {
        Self {
            amount,
            currency,

...
impl crate::treasury::credit_reversal::CreditReversal {
    /// Returns a list of CreditReversals.
    pub fn list(
        client: &Client,
        params: ListCreditReversal,
    ) -> Response<crate::List<crate::treasury::credit_reversal::CreditReversal>> {
    ...
    ) -> Response<crate::treasury::credit_reversal::CreditReversal> {
        client.get_query(
            &format!(

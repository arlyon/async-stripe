...
pub struct Mandate {
    pub customer_acceptance: crate::mandate::customer_acceptance::CustomerAcceptance,
    /// Unique identifier for the object.
    pub id: crate::mandate::MandateId,
    /// Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
    pub livemode: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub multi_use: Option<crate::mandate::multi_use::MultiUse>,
    ...
    pub payment_method_details: crate::mandate::payment_method_details::PaymentMethodDetails,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub single_use: Option<crate::mandate::single_use::SingleUse>,
...
impl crate::Object for Mandate {
    type Id = crate::mandate::MandateId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(MandateId, "mandate_");

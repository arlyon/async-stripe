...
pub struct UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails {
    ...
    pub balance: Option<UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance>,
...
impl std::fmt::Display for UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance {
    fn default() -> Self {
        Self::Payments
    }
}
...
impl std::fmt::Display for UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType {
    fn default() -> Self {
        Self::Balance
    }
}

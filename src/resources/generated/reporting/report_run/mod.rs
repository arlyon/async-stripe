...
pub struct ReportRun {
    ...
    pub id: crate::reporting::report_run::ReportingReportRunId,
    ...
    pub parameters: crate::reporting::report_run::parameters::Parameters,
    /// The ID of the [report type](https://stripe.com/docs/reports/report-types) to run, such as `"balance.summary.1"`.
    pub report_type: String,
    /// The file object representing the result of the report run (populated when
    ///  `status=succeeded`).
    pub result: Option<crate::file::File>,
...
impl crate::Object for ReportRun {
    type Id = crate::reporting::report_run::ReportingReportRunId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(ReportingReportRunId);
pub mod parameters;
pub mod requests;

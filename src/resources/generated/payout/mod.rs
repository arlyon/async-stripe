...
pub struct Payout {
    ...
    pub arrival_date: crate::Timestamp,
    ...
    pub destination: Option<crate::Expandable<crate::external_account::ExternalAccount>>,
    ...
    pub original_payout: Option<crate::Expandable<crate::payout::Payout>>,
    /// If the payout was reversed, this is the ID of the payout that reverses this payout.
    pub reversed_by: Option<crate::Expandable<crate::payout::Payout>>,
...
impl crate::Object for Payout {
    type Id = crate::payout::PayoutId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(PayoutId, "po_");
pub mod requests;

...
impl crate::payout::Payout {
    ...
    pub fn retrieve(
        client: &Client,
        payout: &crate::payout::PayoutId,
        params: RetrievePayout,
    ) -> Response<crate::payout::Payout> {
    ...
    pub fn list(
        client: &Client,
        params: ListPayout,
    ) -> Response<crate::List<crate::payout::Payout>> {
    ...
    pub fn create(client: &Client, params: CreatePayout) -> Response<crate::payout::Payout> {
...
pub struct ListPayout<'a> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub arrival_date: Option<crate::RangeQueryTs>,
    #[serde(skip_serializing_if = "Option::is_none")]

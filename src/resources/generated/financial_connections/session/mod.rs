...
pub struct Session {
    ...
    pub accounts: crate::List<crate::financial_connections::account::Account>,
    /// A value that will be passed to the client to launch the authentication flow.
    pub client_secret: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub filters: Option<crate::financial_connections::session::filters::Filters>,
    /// Unique identifier for the object.
    pub id: crate::financial_connections::session::FinancialConnectionsSessionId,
...
impl crate::Object for Session {
    type Id = crate::financial_connections::session::FinancialConnectionsSessionId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(FinancialConnectionsSessionId);
pub mod filters;
pub mod requests;

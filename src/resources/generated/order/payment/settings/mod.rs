...
pub struct Settings {
    ...
    pub automatic_payment_methods:
        Option<crate::order::payment::settings::automatic_payment_methods::AutomaticPaymentMethods>,
    /// PaymentMethod-specific configuration to provide to the order's PaymentIntent.
    pub payment_method_options:
        Option<crate::order::payment::settings::payment_method_options::PaymentMethodOptions>,
    ...
    pub transfer_data: Option<crate::order::payment::settings::transfer_data::TransferData>,
}
#[cfg(feature = "min-ser")]

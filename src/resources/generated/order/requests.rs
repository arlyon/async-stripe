...
impl crate::order::Order {
    /// Creates a new `open` order object.
    pub fn create(client: &Client, params: CreateOrder) -> Response<crate::order::Order> {
    ...
    pub fn list(client: &Client, params: ListOrder) -> Response<crate::List<crate::order::Order>> {
    ...
    pub fn update(client: &Client, id: &str, params: UpdateOrder) -> Response<crate::order::Order> {
    ...
    pub fn submit(client: &Client, id: &str, params: SubmitOrder) -> Response<crate::order::Order> {
        client.send_form(&format!("/orders/{id}/submit", id = id), params, http_types::Method::Post)
    }
    /// Cancels the order as well as the payment intent if one is attached.
    pub fn cancel(client: &Client, id: &str, params: CancelOrder) -> Response<crate::order::Order> {
        client.send_form(&format!("/orders/{id}/cancel", id = id), params, http_types::Method::Post)
    }
    /// Reopens a `submitted` order.
    pub fn reopen(client: &Client, id: &str, params: ReopenOrder) -> Response<crate::order::Order> {
...
impl<'a> CreateOrder<'a> {
    pub fn new(currency: crate::Currency, line_items: &'a [CreateOrderLineItems<'a>]) -> Self {
        Self {

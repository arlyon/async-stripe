...
impl crate::payment_link::PaymentLink {
    /// Returns a list of your payment links.
    pub fn list(
        client: &Client,
        params: ListPaymentLink,
    ) -> Response<crate::List<crate::payment_link::PaymentLink>> {
        client.get_query("/payment_links", params)
    }
    /// Retrieve a payment link.
    pub fn retrieve(
        client: &Client,
        payment_link: &crate::payment_link::PaymentLinkId,
        params: RetrievePaymentLink,
    ) -> Response<crate::payment_link::PaymentLink> {
        client.get_query(

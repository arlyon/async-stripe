...
impl crate::terminal::location::Location {
    ...
    ) -> Response<crate::terminal::location::Location> {
    ...
    pub fn list(
        client: &Client,
        params: ListLocation,
    ) -> Response<crate::List<crate::terminal::location::Location>> {
    ...
    pub fn delete(
        client: &Client,
        location: &str,
    ) -> Response<crate::terminal::location::DeletedLocation> {
        client.send(
            &format!("/terminal/locations/{location}", location = location),
...
pub enum RetrieveReturned {
    TerminalLocation(crate::terminal::location::Location),
    DeletedTerminalLocation(crate::terminal::location::DeletedLocation),
}
#[cfg(feature = "min-ser")]

...
pub struct Reader {
    ...
    pub action: Option<crate::terminal::reader::reader_action::ReaderAction>,
    /// The current software version of the reader.
    pub device_sw_version: Option<String>,
    /// Type of reader, one of `bbpos_wisepad3`, `stripe_m2`, `bbpos_chipper2x`, `bbpos_wisepos_e`, `verifone_P400`, or `simulated_wisepos_e`.
    pub device_type: ReaderDeviceType,
    /// Unique identifier for the object.
    pub id: crate::terminal::reader::TerminalReaderId,
    ...
    pub location: Option<crate::Expandable<crate::terminal::location::Location>>,
...
impl crate::Object for Reader {
    type Id = crate::terminal::reader::TerminalReaderId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TerminalReaderId, "tmr_");
pub mod deleted;
pub mod requests;

...
impl crate::terminal::reader::Reader {
    ...
    pub fn create(
        client: &Client,
        params: CreateReader,
    ) -> Response<crate::terminal::reader::Reader> {
    ...
    pub fn list(
        client: &Client,
        params: ListReader,
    ) -> Response<crate::List<crate::terminal::reader::Reader>> {
    ...
    pub fn delete(
        client: &Client,
        reader: &str,
    ) -> Response<crate::terminal::reader::DeletedReader> {
        client.send(
            &format!("/terminal/readers/{reader}", reader = reader),
...
pub enum UpdateReturned {
    TerminalReader(crate::terminal::reader::Reader),
    DeletedTerminalReader(crate::terminal::reader::DeletedReader),
}
#[cfg(feature = "min-ser")]

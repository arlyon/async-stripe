...
pub struct Configuration {
    ...
    pub bbpos_wisepos_e: Option<
        crate::terminal::configuration::device_type_specific_config::DeviceTypeSpecificConfig,
    >,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tipping: Option<crate::terminal::configuration::tipping::Tipping>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
crate::def_id!(TerminalConfigurationId, "tmc_");
pub mod deleted;
pub mod requests;

...
impl crate::terminal::configuration::Configuration {
    /// Creates a new `Configuration` object.
    pub fn create(
        client: &Client,
        params: CreateConfiguration,
    ) -> Response<crate::terminal::configuration::Configuration> {
    ...
    ) -> Response<crate::List<crate::terminal::configuration::Configuration>> {
    ...
    pub fn delete(
        client: &Client,
        configuration: &str,
    ) -> Response<crate::terminal::configuration::DeletedConfiguration> {
        client.send(
            &format!("/terminal/configurations/{configuration}", configuration = configuration),
...
pub enum RetrieveReturned {
    TerminalConfiguration(crate::terminal::configuration::Configuration),
    DeletedTerminalConfiguration(crate::terminal::configuration::DeletedConfiguration),
}
#[cfg(feature = "min-ser")]

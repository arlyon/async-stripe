...
pub struct ShippingRate {
    ...
    pub delivery_estimate: Option<crate::shipping_rate::delivery_estimate::DeliveryEstimate>,
    /// The name of the shipping rate, meant to be displayable to the customer.
    ///
    /// This will appear on CheckoutSessions.
    pub display_name: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fixed_amount: Option<crate::shipping_rate::fixed_amount::FixedAmount>,
    /// Unique identifier for the object.
    pub id: crate::shipping_rate::ShippingRateId,
...
impl crate::Object for ShippingRate {
    type Id = crate::shipping_rate::ShippingRateId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(ShippingRateId, "shr_");

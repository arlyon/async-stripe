...
pub struct Person {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address_kana: Option<crate::person::japan_address::JapanAddress>,
    /// The Kanji variation of the person's address (Japan only).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address_kanji: Option<crate::person::japan_address::JapanAddress>,
    /// Time at which the object was created.
    ///
    /// Measured in seconds since the Unix epoch.
    pub created: crate::Timestamp,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dob: Option<crate::person::date_of_birth::DateOfBirth>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub future_requirements: Option<crate::person::future_requirements::FutureRequirements>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub registered_address: Option<crate::address::Address>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub relationship: Option<crate::person::relationship::Relationship>,
    /// Information about the requirements for this person, including what information needs to be collected, and by when.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requirements: Option<crate::person::requirements::Requirements>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub verification: Option<crate::person::verification::Verification>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for Person {
    type Id = crate::person::PersonId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(PersonId, "person_");
pub mod deleted;
pub mod requests;

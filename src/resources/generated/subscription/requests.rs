...
impl crate::subscription::Subscription {
    ...
    ) -> Response<crate::List<crate::subscription::Subscription>> {
    ...
    ) -> Response<crate::subscription::Subscription> {
...
pub struct SearchReturned {
    pub data: Vec<crate::subscription::Subscription>,
    pub has_more: bool,
...
pub struct ListSubscription<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub current_period_end: Option<crate::RangeQueryTs>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub current_period_start: Option<crate::RangeQueryTs>,
...
pub struct CreateSubscription<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub backdate_start_date: Option<crate::Timestamp>,

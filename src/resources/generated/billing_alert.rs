...
///
/// For more details see <https://stripe.com/api/billing/alert/object>
...
pub struct BillingAlert {
    ...
    pub filter: Option<ThresholdsResourceAlertFilter>,
    ...
    pub usage_threshold_config: Option<ThresholdsResourceUsageThresholdConfig>,
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct ThresholdsResourceAlertFilter {

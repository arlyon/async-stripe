...
pub struct Subscription {
    ...
    pub cancel_at: Box<Option<Timestamp>>,
    ...
    pub ended_at: Box<Option<Timestamp>>,

    /// List of subscription items, each with an attached price.
    pub items: List<SubscriptionItem>,

    /// The most recent invoice this subscription has generated.
    pub latest_invoice: Box<Option<Expandable<Invoice>>>,
    ...
    pub next_pending_invoice_item_invoice: Box<Option<Timestamp>>,

    /// If specified, payment collection for this subscription will be paused.
    pub pause_collection: Box<Option<SubscriptionsResourcePauseCollection>>,

    /// Payment settings passed on to invoices created by the subscription.
    pub payment_settings: Box<Option<SubscriptionsResourcePaymentSettings>>,
    ...
    pub pending_invoice_item_interval: Box<Option<SubscriptionPendingInvoiceItemInterval>>,
    ...
    pub pending_setup_intent: Box<Option<Expandable<SetupIntent>>>,

    /// If specified, [pending updates](https://stripe.com/docs/billing/subscriptions/pending-updates) that will be applied to the subscription once the `latest_invoice` has been paid.
    pub pending_update: Box<Option<SubscriptionsResourcePendingUpdate>>,

    /// The schedule attached to the subscription.
    pub schedule: Box<Option<Expandable<SubscriptionSchedule>>>,
    ...
    pub trial_start: Box<Option<Timestamp>>,
}
...
pub struct SubscriptionsResourcePauseCollection {
    ...
    pub resumes_at: Box<Option<Timestamp>>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SubscriptionsResourcePaymentSettings {
    /// Payment-method-specific configuration to provide to invoices created by the subscription.
    pub payment_method_options: Box<Option<SubscriptionsResourcePaymentMethodOptions>>,
    ...
    pub payment_method_types:
        Box<Option<Vec<SubscriptionsResourcePaymentSettingsPaymentMethodTypes>>>,
}
...
pub struct SubscriptionsResourcePendingUpdate {
    ...
    pub billing_cycle_anchor: Box<Option<Timestamp>>,

    /// The point after which the changes reflected by this update will be discarded and no longer applied.
    pub expires_at: Timestamp,

    /// List of subscription items, each with an attached plan, that will be set if the update is applied.
    pub subscription_items: Box<Option<Vec<SubscriptionItem>>>,
...
pub struct CreateSubscription<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub automatic_tax: Box<Option<CreateSubscriptionAutomaticTax>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub items: Box<Option<Vec<CreateSubscriptionItems>>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payment_settings: Box<Option<CreateSubscriptionPaymentSettings>>,

    /// Specifies an interval for how often to bill for any pending invoice items.
    ///
    /// It is analogous to calling [Create an invoice](https://stripe.com/docs/api#create_invoice) for the given subscription at the specified interval.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pending_invoice_item_interval: Box<Option<CreateSubscriptionPendingInvoiceItemInterval>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transfer_data: Box<Option<CreateSubscriptionTransferData>>,
...
pub struct UpdateSubscription<'a> {
    ...
    /// Automatic tax settings for this subscription.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub automatic_tax: Box<Option<UpdateSubscriptionAutomaticTax>>,
    ...
    /// A list of up to 20 subscription items, each with an attached price.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub items: Box<Option<Vec<UpdateSubscriptionItems>>>,
    ...
    /// If specified, payment collection for this subscription will be paused.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pause_collection: Box<Option<UpdateSubscriptionPauseCollection>>,
    ...
    /// Payment settings to pass to invoices created by the subscription.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payment_settings: Box<Option<UpdateSubscriptionPaymentSettings>>,

    /// Specifies an interval for how often to bill for any pending invoice items.
    ///
    /// It is analogous to calling [Create an invoice](https://stripe.com/docs/api#create_invoice) for the given subscription at the specified interval.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pending_invoice_item_interval: Box<Option<UpdateSubscriptionPendingInvoiceItemInterval>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transfer_data: Box<Option<UpdateSubscriptionTransferData>>,
...
pub struct CreateSubscriptionItems {
    pub billing_thresholds: Box<Option<CreateSubscriptionItemsBillingThresholds>>,
...
pub struct CreateSubscriptionPaymentSettings {
    pub payment_method_options: Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptions>>,

    pub payment_method_types: Box<Option<Vec<CreateSubscriptionPaymentSettingsPaymentMethodTypes>>>,
}
...
pub struct UpdateSubscriptionItems {
    ...
    pub clear_usage: Box<Option<bool>>,

    pub deleted: Box<Option<bool>>,
...
pub struct UpdateSubscriptionPaymentSettings {
    pub payment_method_options: Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptions>>,

    pub payment_method_types: Box<Option<Vec<UpdateSubscriptionPaymentSettingsPaymentMethodTypes>>>,
}
...
pub struct CreateSubscriptionPaymentSettingsPaymentMethodOptions {
    pub acss_debit: Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit>>,

    pub bancontact: Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptionsBancontact>>,

    pub card: Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptionsCard>>,
}
...
pub struct UpdateSubscriptionPaymentSettingsPaymentMethodOptions {
    pub acss_debit: Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit>>,

    pub bancontact: Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptionsBancontact>>,

    pub card: Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptionsCard>>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct CreateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit {
    pub mandate_options:
        Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptions>>,

    pub verification_method: Box<
...
pub struct CreateSubscriptionPaymentSettingsPaymentMethodOptionsCard {
    pub request_three_d_secure:
        Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptionsCardRequestThreeDSecure>>,
}
...
pub struct UpdateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebit {
    pub mandate_options:
        Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptions>>,
...
pub struct UpdateSubscriptionPaymentSettingsPaymentMethodOptionsCard {
    pub request_three_d_secure:
        Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptionsCardRequestThreeDSecure>>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct CreateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptions {

    pub transaction_type: Box<Option<CreateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptionsTransactionType>>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct UpdateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptions {

    pub transaction_type: Box<Option<UpdateSubscriptionPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptionsTransactionType>>,
}

...
impl ApiErrorsCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            ApiErrorsCode::BillingPolicyRemoteFunctionResponseInvalid => "billing_policy_remote_function_response_invalid",
            ApiErrorsCode::BillingPolicyRemoteFunctionTimeout => "billing_policy_remote_function_timeout",
            ApiErrorsCode::BillingPolicyRemoteFunctionUnexpectedStatusCode => "billing_policy_remote_function_unexpected_status_code",
            ApiErrorsCode::BillingPolicyRemoteFunctionUnreachable => "billing_policy_remote_function_unreachable",
            ...
            ApiErrorsCode::PaymentIntentFxQuoteInvalid => "payment_intent_fx_quote_invalid",

...
pub struct Quote {
    ...
    pub automatic_tax: crate::quote::automatic_tax::AutomaticTax,
    ...
    pub computed: crate::quote::computed::Computed,
    ...
    pub default_tax_rates: Option<Vec<crate::Expandable<crate::tax_rate::TaxRate>>>,
    /// A description that will be displayed on the quote PDF.
    pub description: Option<String>,
    /// The discounts applied to this quote.
    pub discounts: Vec<crate::Expandable<crate::discount::Discount>>,
    ...
    pub from_quote: Option<crate::quote::from_quote::FromQuote>,
    /// A header that will be displayed on the quote PDF.
    pub header: Option<String>,
    /// Unique identifier for the object.
    pub id: crate::quote::QuoteId,
    /// The invoice that was created from this quote.
    pub invoice: Option<crate::Expandable<crate::invoice::Invoice>>,
    /// All invoices will be billed using the specified settings.
    pub invoice_settings: Option<crate::quote::invoice_settings::InvoiceSettings>,
    ...
    pub status_transitions: crate::quote::status_transitions::StatusTransitions,
    /// The subscription that was created or updated from this quote.
    pub subscription: Option<crate::Expandable<crate::subscription::Subscription>>,
    pub subscription_data: crate::quote::subscription_data::SubscriptionData,
    /// The subscription schedule that was created or updated from this quote.
    pub subscription_schedule:
        Option<crate::Expandable<crate::subscription_schedule::SubscriptionSchedule>>,
    /// ID of the test clock this quote belongs to.
    pub test_clock: Option<crate::Expandable<crate::test_helpers::test_clock::TestClock>>,
    pub total_details: crate::quote::total_details::TotalDetails,
    /// The account (if any) the payments will be attributed to for tax reporting, and where funds from each payment will be transferred to for each of the invoices.
    pub transfer_data: Option<crate::quote::transfer_data::TransferData>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for Quote {
    type Id = crate::quote::QuoteId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(QuoteId, "qt_");

...
pub struct Wallet {
    ...
    pub amex_express_checkout:
        Option<crate::payment_method::card::wallet::amex_express_checkout::AmexExpressCheckout>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub apple_pay: Option<crate::payment_method::card::wallet::apple_pay::ApplePay>,
    /// (For tokenized numbers only.) The last four digits of the device account number.
    pub dynamic_last4: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub google_pay: Option<crate::payment_method::card::wallet::google_pay::GooglePay>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub masterpass: Option<crate::payment_method::card::wallet::masterpass::Masterpass>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub samsung_pay: Option<crate::payment_method::card::wallet::samsung_pay::SamsungPay>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub visa_checkout: Option<crate::payment_method::card::wallet::visa_checkout::VisaCheckout>,
}
#[cfg(feature = "min-ser")]

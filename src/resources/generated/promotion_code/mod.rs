...
pub struct PromotionCode {
    ...
    pub id: crate::promotion_code::PromotionCodeId,
    ...
    pub restrictions: crate::promotion_code::restrictions::Restrictions,
...
impl crate::Object for PromotionCode {
    type Id = crate::promotion_code::PromotionCodeId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(PromotionCodeId, "promo_");

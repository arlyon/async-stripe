...
impl crate::promotion_code::PromotionCode {
    ...
    pub fn retrieve(
        client: &Client,
        promotion_code: &crate::promotion_code::PromotionCodeId,
        params: RetrievePromotionCode,
    ) -> Response<crate::promotion_code::PromotionCode> {
        client.get_query(
    ...
    ) -> Response<crate::List<crate::promotion_code::PromotionCode>> {
...
pub struct CreatePromotionCodeRestrictions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub minimum_amount_currency: Option<crate::Currency>,
}

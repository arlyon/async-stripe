...
pub struct Customer {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cash_balance: Option<crate::cash_balance::CashBalance>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub invoice_settings: Option<crate::customer::invoice_settings::InvoiceSettings>,
    ...
    #[serde(default)]
    pub sources: crate::List<Option<crate::payment_source::PaymentSource>>,
    /// The customer's current subscriptions, if any.
    #[serde(default)]
    pub subscriptions: crate::List<Option<crate::subscription::Subscription>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tax: Option<crate::customer::tax::Tax>,
    ...
    #[serde(default)]
    pub tax_ids: crate::List<Option<crate::tax_id::TaxId>>,
...
impl crate::Object for Customer {
    type Id = crate::customer::CustomerId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(CustomerId, "cs_");
pub mod deleted;
pub mod requests;

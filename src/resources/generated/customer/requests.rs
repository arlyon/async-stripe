...
impl crate::customer::Customer {
    ...
    pub fn list(
        client: &Client,
        params: ListCustomer,
    ) -> Response<crate::List<crate::customer::Customer>> {
        client.get_query("/customers", params)
    }
    /// Creates a new customer object.
    pub fn create(client: &Client, params: CreateCustomer) -> Response<crate::customer::Customer> {
    ...
    ) -> Response<crate::customer::Customer> {
        client.send_form(
    ...
    pub fn delete(
        client: &Client,
        customer: &crate::customer::CustomerId,
    ) -> Response<crate::customer::DeletedCustomer> {
        client.send(
            &format!("/customers/{customer}", customer = customer),
    ...
    ) -> Response<crate::List<crate::payment_method::PaymentMethod>> {
        client.get_query(
    ...
    pub fn retrieve_payment_method(
        client: &Client,
        customer: &crate::customer::CustomerId,
        payment_method: &crate::payment_method::PaymentMethodId,
        params: RetrievePaymentMethodCustomer,
    ) -> Response<crate::payment_method::PaymentMethod> {
        client.get_query(
            &format!(
    ...
    ) -> Response<crate::List<crate::customer_balance_transaction::CustomerBalanceTransaction>>
    {
        client.get_query(
    ...
    ) -> Response<crate::customer_cash_balance_transaction::CustomerCashBalanceTransaction> {
        client.send_form(
    ...
    ) -> Response<crate::funding_instructions::FundingInstructions> {
        client.send_form(
    ...
    pub fn delete_discount(
        client: &Client,
        customer: &crate::customer::CustomerId,
    ) -> Response<crate::discount::DeletedDiscount> {
        client.send(
...
pub struct SearchReturned {
    pub data: Vec<crate::customer::Customer>,
    pub has_more: bool,
...
pub enum RetrieveReturned {
    ...
    DeletedCustomer(crate::customer::DeletedCustomer),
}
#[cfg(feature = "min-ser")]

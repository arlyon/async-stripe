...
pub struct Document {
    ...
    pub dob: Option<crate::identity::verification_report::document::date_of_birth::DateOfBirth>,
    /// Details on the verification error.
    ///
    /// Present when status is `unverified`.
    pub error: Option<
        crate::identity::verification_report::document::document_check_error::DocumentCheckError,
    >,
    /// Expiration date of the document.
    pub expiration_date:
        Option<crate::identity::verification_report::document::expiration_date::ExpirationDate>,
    ...
    pub issued_date:
        Option<crate::identity::verification_report::document::issued_date::IssuedDate>,

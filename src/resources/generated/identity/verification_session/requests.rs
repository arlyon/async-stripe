...
impl crate::identity::verification_session::VerificationSession {
    ...
    ) -> Response<crate::identity::verification_session::VerificationSession> {
    ...
    ) -> Response<crate::List<crate::identity::verification_session::VerificationSession>> {

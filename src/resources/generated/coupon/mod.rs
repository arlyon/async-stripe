...
pub struct Coupon {
    ...
    pub applies_to: Option<crate::coupon::applies_to::AppliesTo>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub currency_options: Option<crate::coupon::currency_option::CurrencyOption>,
...
impl crate::Object for Coupon {
    type Id = crate::coupon::CouponId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(CouponId);
pub mod deleted;
pub mod requests;

...
impl crate::test_helpers::test_clock::TestClock {
    /// Retrieves a test clock.
    pub fn retrieve(
        client: &Client,
        test_clock: &str,
        params: RetrieveTestClock,
    ) -> Response<crate::test_helpers::test_clock::TestClock> {
        client.get_query(
    ...
    pub fn delete(
        client: &Client,
        test_clock: &str,
    ) -> Response<crate::test_helpers::test_clock::DeletedTestClock> {
        client.send(
            &format!("/test_helpers/test_clocks/{test_clock}", test_clock = test_clock),
    ...
    ) -> Response<crate::List<crate::test_helpers::test_clock::TestClock>> {
...
pub struct CreateTestClock<'a> {
    ...
    pub frozen_time: crate::Timestamp,
    /// The name for this test clock.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: Option<&'a str>,
}
impl<'a> CreateTestClock<'a> {
    pub fn new(frozen_time: crate::Timestamp) -> Self {

...
pub struct TestClock {
    ...
    pub deletes_after: crate::Timestamp,
    /// Time at which all objects belonging to this clock are frozen.
    pub frozen_time: crate::Timestamp,
    /// Unique identifier for the object.
    pub id: crate::test_helpers::test_clock::TestHelpersTestClockId,
...
impl crate::Object for TestClock {
    type Id = crate::test_helpers::test_clock::TestHelpersTestClockId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TestHelpersTestClockId, "clock_");
pub mod deleted;
pub mod requests;

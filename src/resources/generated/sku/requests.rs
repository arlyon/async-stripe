...
impl crate::sku::Sku {
    ...
    pub fn list(client: &Client, params: ListSku) -> Response<crate::List<crate::sku::Sku>> {
    ...
    pub fn update(client: &Client, id: &str, params: UpdateSku) -> Response<crate::sku::Sku> {
        client.send_form(&format!("/skus/{id}", id = id), params, http_types::Method::Post)
    }
    /// Creates a new SKU associated with a product.
    pub fn create(client: &Client, params: CreateSku) -> Response<crate::sku::Sku> {
        client.send_form("/skus", params, http_types::Method::Post)
    }
    /// Delete a SKU.
    ///
    /// Deleting a SKU is only possible until it has been used in an order.
    pub fn delete(client: &Client, id: &str) -> Response<crate::sku::DeletedSku> {
...
pub enum RetrieveReturned {
    Sku(crate::sku::Sku),
    DeletedSku(crate::sku::DeletedSku),
}
#[cfg(feature = "min-ser")]

...
use crate::resources::{Currency, TreasuryTransaction, UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails};
...
pub struct TreasuryReceivedDebit {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub initiating_payment_method_details: Option<UfaResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails>,

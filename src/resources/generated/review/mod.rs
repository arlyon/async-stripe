...
pub struct Review {
    ...
    pub ip_address_location: Option<crate::review::location::Location>,
    ...
    pub session: Option<crate::review::session::Session>,
}
#[cfg(feature = "min-ser")]
...
impl crate::Object for Review {
    type Id = crate::review::ReviewId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(ReviewId, "prv_");
pub mod location;
pub mod requests;

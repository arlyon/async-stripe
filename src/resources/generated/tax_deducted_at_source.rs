...
pub struct TaxDeductedAtSource {
    ...
    pub id: crate::tax_deducted_at_source::TaxDeductedAtSourceId,
...
impl crate::Object for TaxDeductedAtSource {
    type Id = crate::tax_deducted_at_source::TaxDeductedAtSourceId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}
crate::def_id!(TaxDeductedAtSourceId, "itds_");

...
impl<'de> serde::Deserialize<'de> for RadarReviewClosedReason {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for RadarReviewClosedReason"))
    }
}
/// String representing the object's type.
///
/// Objects of the same type share the same value.
#[derive(Copy, Clone, Eq, PartialEq)]
pub enum RadarReviewObject {
    Review,
}

impl RadarReviewObject {
    pub fn as_str(self) -> &'static str {
        use RadarReviewObject::*;
        match self {
            Review => "review",
        }
    }
...
impl std::str::FromStr for RadarReviewObject {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use RadarReviewObject::*;
        match s {
...
impl AsRef<str> for RadarReviewObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for RadarReviewObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for RadarReviewObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for RadarReviewObject {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> serde::Deserialize<'de> for RadarReviewObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for RadarReviewObject"))
    }
}
/// The reason the review was opened.
///
...
impl<'de> serde::Deserialize<'de> for RadarReviewOpenedReason {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for RadarReviewOpenedReason"))
    }
}

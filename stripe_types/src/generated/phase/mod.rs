...
pub struct Phase {
    ...
    pub add_invoice_items: Vec<stripe_types::add_invoice_item::AddInvoiceItem>,
    ...
    pub automatic_tax: Option<stripe_types::automatic_tax::AutomaticTax>,
    ...
    pub items: Vec<stripe_types::phase_item::PhaseItem>,

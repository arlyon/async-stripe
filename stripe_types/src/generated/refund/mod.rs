...
pub struct Refund {
    ...
    pub source_transfer_reversal:
        Option<stripe_types::Expandable<stripe_types::transfer_reversal::TransferReversal>>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for RefundObject {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<RefundObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(RefundObject::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}
/// Reason for the refund, either user-provided (`duplicate`, `fraudulent`, or `requested_by_customer`) or generated by Stripe internally (`expired_uncaptured_charge`).

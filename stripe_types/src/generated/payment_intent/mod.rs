...
pub source: Option<stripe_types::Expandable<stripe_types::payment_source::PaymentSource>>,
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<PaymentIntentObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentObject::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.

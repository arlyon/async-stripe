...
pub struct Cashapp {
    ...
    pub capture_method: Option<CashappCaptureMethod>,
...
pub enum CashappCaptureMethod {
    Manual,
}

impl CashappCaptureMethod {
    pub fn as_str(self) -> &'static str {
        use CashappCaptureMethod::*;
        match self {
            Manual => "manual",
        }
    }
...
impl std::str::FromStr for CashappCaptureMethod {
    type Err = ();
...
impl AsRef<str> for CashappCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for CashappCaptureMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl serde::Serialize for CashappCaptureMethod {
...
impl<'de> serde::Deserialize<'de> for CashappCaptureMethod {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s)
            .map_err(|_| serde::de::Error::custom("Unknown value for CashappCaptureMethod"))
    }
}
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
///

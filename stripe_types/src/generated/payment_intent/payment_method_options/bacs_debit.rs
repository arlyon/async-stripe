...
pub struct BacsDebit {
    ...
    pub setup_future_usage: Option<BacsDebitSetupFutureUsage>,
}
#[cfg(feature = "min-ser")]
...
impl BacsDebitSetupFutureUsage {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<BacsDebitSetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(BacsDebitSetupFutureUsage::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}

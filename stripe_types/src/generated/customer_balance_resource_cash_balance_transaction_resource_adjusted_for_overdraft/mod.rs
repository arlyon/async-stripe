...
pub struct CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft {
    ...
    pub balance_transaction: stripe_types::Expandable<stripe_types::BalanceTransaction>,
    /// The [Cash Balance Transaction](https://stripe.com/docs/api/cash_balance_transactions/object) that brought the customer balance negative, triggering the clawback of funds.
    pub linked_transaction: stripe_types::Expandable<stripe_types::CustomerCashBalanceTransaction>,
}

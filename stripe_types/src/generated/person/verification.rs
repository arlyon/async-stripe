...
pub struct Verification {
    ...
    pub additional_document:
        Option<stripe_types::person::verification_document::VerificationDocument>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub document: Option<stripe_types::person::verification_document::VerificationDocument>,

...
pub struct CustomField {
    ...
    pub dropdown: Option<stripe_types::custom_field_dropdown::CustomFieldDropdown>,
    ...
    pub key: String,
    pub label: stripe_types::custom_field_label::CustomFieldLabel,
    /// Configuration for `type=numeric` fields.
    pub numeric: Option<stripe_types::custom_field_numeric::CustomFieldNumeric>,
    /// Whether the customer is required to complete the field before completing the Checkout Session.
    ///
    /// Defaults to `false`.
    pub optional: bool,
    /// Configuration for `type=text` fields.
    pub text: Option<stripe_types::custom_field_text::CustomFieldText>,

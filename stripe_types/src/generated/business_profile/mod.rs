...
pub struct BusinessProfile {
    ...
    pub monthly_estimated_revenue:
        Option<stripe_types::monthly_estimated_revenue::MonthlyEstimatedRevenue>,
    ...
    pub support_address: Option<stripe_types::address::Address>,

...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for FeeRefundObject {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<FeeRefundObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(FeeRefundObject::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}

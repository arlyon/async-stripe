...
pub struct Wallet {
    ...
    pub apple_pay:
        Option<stripe_types::charge::payment_method_details::card::wallet::apple_pay::ApplePay>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub google_pay:
        Option<stripe_types::charge::payment_method_details::card::wallet::google_pay::GooglePay>,

...
#[serde(skip_serializing_if = "Option::is_none")]
pub redirect_to_url: Option<stripe_types::setup_intent::next_action_redirect_to_url::NextActionRedirectToUrl>,
...
#[serde(skip_serializing_if = "Option::is_none")]
pub verify_with_microdeposits: Option<stripe_types::setup_intent::next_action::verify_with_microdeposits::VerifyWithMicrodeposits>,

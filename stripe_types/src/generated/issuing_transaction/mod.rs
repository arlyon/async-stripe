...
impl std::str::FromStr for IssuingTransactionObject {
    type Err = ();
...
impl AsRef<str> for IssuingTransactionObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::fmt::Debug for IssuingTransactionObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for IssuingTransactionObject {
...
impl<'de> serde::Deserialize<'de> for IssuingTransactionObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for IssuingTransactionObject"))
    }
}
/// The nature of the transaction.
#[derive(Copy, Clone, Eq, PartialEq)]

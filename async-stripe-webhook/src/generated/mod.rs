    ...
    impl Visitor for Place<AccountExternalAccountCreated> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            ...
            self.out = Some(match tag.as_str() {
                "bank_account" => {
                    AccountExternalAccountCreated::BankAccount(stripe_miniserde::json::from_str(bytes)?)
                }
                "card" => AccountExternalAccountCreated::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => {
                    AccountExternalAccountCreated::Source(stripe_miniserde::json::from_str(bytes)?)
                }
...
const _: () = {
    ...
    impl Visitor for Place<AccountExternalAccountDeleted> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            ...
            self.out = Some(match tag.as_str() {
                "bank_account" => {
                    AccountExternalAccountDeleted::BankAccount(stripe_miniserde::json::from_str(bytes)?)
                }
                "card" => AccountExternalAccountDeleted::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => {
                    AccountExternalAccountDeleted::Source(stripe_miniserde::json::from_str(bytes)?)
                }
...
const _: () = {
    ...
    impl Visitor for Place<AccountExternalAccountUpdated> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            ...
            self.out = Some(match tag.as_str() {
                "bank_account" => {
                    AccountExternalAccountUpdated::BankAccount(stripe_miniserde::json::from_str(bytes)?)
                }
                "card" => AccountExternalAccountUpdated::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => {
                    AccountExternalAccountUpdated::Source(stripe_miniserde::json::from_str(bytes)?)
                }
...
const _: () = {
    ...
    impl Visitor for Place<CustomerSourceCreated> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            ...
            self.out = Some(match tag.as_str() {
                "bank_account" => {
                    CustomerSourceCreated::BankAccount(stripe_miniserde::json::from_str(bytes)?)
                }
                "card" => CustomerSourceCreated::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => CustomerSourceCreated::Source(stripe_miniserde::json::from_str(bytes)?),
...
const _: () = {
    ...
    impl Visitor for Place<CustomerSourceDeleted> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            ...
            self.out = Some(match tag.as_str() {
                "bank_account" => {
                    CustomerSourceDeleted::BankAccount(stripe_miniserde::json::from_str(bytes)?)
                }
                "card" => CustomerSourceDeleted::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => CustomerSourceDeleted::Source(stripe_miniserde::json::from_str(bytes)?),
...
const _: () = {
    ...
    impl Visitor for Place<CustomerSourceExpiring> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            let tag = peek_object_tag(bytes).ok_or(Error)?;
            self.out = Some(match tag.as_str() {
                "card" => CustomerSourceExpiring::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => CustomerSourceExpiring::Source(stripe_miniserde::json::from_str(bytes)?),
...
const _: () = {
    ...
    impl Visitor for Place<CustomerSourceUpdated> {
        ...
        fn raw(&mut self, bytes: &str) -> Result<()> {
            ...
            self.out = Some(match tag.as_str() {
                "bank_account" => {
                    CustomerSourceUpdated::BankAccount(stripe_miniserde::json::from_str(bytes)?)
                }
                "card" => CustomerSourceUpdated::Card(stripe_miniserde::json::from_str(bytes)?),
                "source" => CustomerSourceUpdated::Source(stripe_miniserde::json::from_str(bytes)?),
...
impl EventObject {
    ...
    pub(crate) fn from_raw_data(typ: &str, data: stripe_miniserde::json::Value) -> Option<Self> {
        #[inline(always)]
        fn parse_and_box<T: stripe_miniserde::Deserialize>(
            data: &stripe_miniserde::json::Value,
        ) -> Option<Box<T>> {

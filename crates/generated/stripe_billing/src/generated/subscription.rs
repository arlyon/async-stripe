...
use async_stripe_core::{
    ...
    resources::{CollectionMethod, PaymentSource, SubscriptionItemBillingThresholds},
    BaseClient, Client,
};
use serde::{Deserialize, Serialize};

use crate::resources::{
    Account, Application, CollectionMethod, Customer, Discount, Invoice, PaymentMethod, Scheduled,
    SetupIntent, SubscriptionItem, SubscriptionSchedule, SubscriptionsResourcePaymentMethodOptions,
...
impl Subscription {
    ...
    ) -> <C as BaseClient>::Response<List<Subscription>> {
    ...
    ) -> <C as BaseClient>::Response<Subscription> {
    ...
    pub fn delete<C: BaseClient>(
        client: &Client<C>,
        id: &SubscriptionId,
    ) -> <C as BaseClient>::Response<Deleted<SubscriptionId>> {

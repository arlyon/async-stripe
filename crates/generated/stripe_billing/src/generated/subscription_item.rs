...
use crate::resources::{Price, TaxRate};
...
impl SubscriptionItem {
    ...
    ) -> <C as BaseClient>::Response<List<SubscriptionItem>> {
    ...
    ) -> <C as BaseClient>::Response<SubscriptionItem> {
    ...
    pub fn delete<C: BaseClient>(
        client: &Client<C>,
        id: &SubscriptionItemId,
    ) -> <C as BaseClient>::Response<Deleted<SubscriptionItemId>> {

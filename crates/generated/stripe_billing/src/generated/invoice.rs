...
use async_stripe_core::{
    ...
    resources::PaymentSource,
    BaseClient, Client,
};
use serde::{Deserialize, Serialize};
use stripe_unknown::resources::TaxRate;

use crate::resources::{
    Account, ApiErrors, Application, Charge, Customer, Discount, DiscountsResourceDiscountAmount,
    InvoiceLineItem, InvoicesPaymentMethodOptions, PaymentIntent, PaymentMethod, Quote,
    Subscription, TaxId, TaxRate, TestHelpersTestClock,
};
...
impl Invoice {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListInvoices<'_>,
    ) -> <C as BaseClient>::Response<List<Invoice>> {
    ...
    ) -> <C as BaseClient>::Response<Invoice> {
    ...
    pub fn delete<C: BaseClient>(
        client: &Client<C>,
        id: &InvoiceId,
    ) -> <C as BaseClient>::Response<Deleted<InvoiceId>> {

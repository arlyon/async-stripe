...
use crate::resources::{Account, BalanceTransaction, Charge, TransferReversal};
...
impl Transfer {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListTransfers<'_>,
    ) -> <C as BaseClient>::Response<List<Transfer>> {
    ...
    ) -> <C as BaseClient>::Response<Transfer> {

...
use crate::resources::{Account, Application, ApplicationFeeRefund, BalanceTransaction, Charge};
...
impl ApplicationFee {
    ...
    ) -> <C as BaseClient>::Response<List<ApplicationFee>> {
    ...
    pub fn retrieve<C: BaseClient>(
        ...
        id: &ApplicationFeeId,
        expand: &[&str],
    ) -> <C as BaseClient>::Response<ApplicationFee> {

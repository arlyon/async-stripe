...
use async_stripe_core::{
    ...
    resources::{
        SourceRedirectFlowFailureReason, SourceRedirectFlowStatus, SourceStatus, SourceUsage,
    },
    BaseClient, Client,
};
use serde::{Deserialize, Serialize};

use crate::resources::BillingDetails;
...
impl Source {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListSources<'_>,
    ) -> <C as BaseClient>::Response<List<Source>> {
    ...
    ) -> <C as BaseClient>::Response<Source> {

...
use stripe_unknown::resources::ShippingRate;

use crate::resources::{Account, CheckoutSessionItem, PaymentLinksResourceAfterCompletion};
...
impl PaymentLink {
    ...
    ) -> <C as BaseClient>::Response<List<PaymentLink>> {
    ...
    ) -> <C as BaseClient>::Response<PaymentLink> {

...
use stripe_unknown::resources::{Discount, ShippingRate, TaxRate};

use crate::resources::{
    CheckoutSessionItem, CheckoutSessionPaymentMethodOptions, Customer, PaymentIntent, PaymentLink,
    SetupIntent, ShippingRate, Subscription,
};
...
impl CheckoutSession {
    ...
    ) -> <C as BaseClient>::Response<List<CheckoutSession>> {
    ...
    ) -> <C as BaseClient>::Response<CheckoutSession> {

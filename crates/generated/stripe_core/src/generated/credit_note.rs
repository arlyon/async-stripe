...
use crate::resources::{
    CreditNoteLineItem, Customer, CustomerBalanceTransaction, DiscountsResourceDiscountAmount,
    Invoice, Refund,
};
...
impl CreditNote {
    ...
    ) -> <C as BaseClient>::Response<List<CreditNote>> {
    ...
    ) -> <C as BaseClient>::Response<CreditNote> {

...
use async_stripe_core::{
    ids::{ChargeId, CustomerId, PaymentIntentId, RefundId},
    params::{Expand, Expandable, List, Metadata, Object, Paginable, RangeQuery, Timestamp},
    BaseClient, Client,
};
use serde::{Deserialize, Serialize};

use crate::resources::{BalanceTransaction, Charge, PaymentIntent, TransferReversal};
...
impl Refund {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListRefunds<'_>,
    ) -> <C as BaseClient>::Response<List<Refund>> {
    ...
    ) -> <C as BaseClient>::Response<Refund> {

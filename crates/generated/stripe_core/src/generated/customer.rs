...
use crate::resources::{
    CashBalance, Discount, InvoiceSettingCustomerSetting, PaymentSourceParams, Subscription, TaxId,
...
impl Customer {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListCustomers<'_>,
    ) -> <C as BaseClient>::Response<List<Customer>> {
    ...
    ) -> <C as BaseClient>::Response<Customer> {
    ...
    pub fn delete<C: BaseClient>(
        client: &Client<C>,
        id: &CustomerId,
    ) -> <C as BaseClient>::Response<Deleted<CustomerId>> {

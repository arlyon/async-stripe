...
use crate::resources::{
    Account, ApiErrors, Application, Charge, Customer, Invoice, PaymentIntentNextAction,
    PaymentIntentOffSession, PaymentIntentPaymentMethodOptions, PaymentMethod, Review,
};
...
impl PaymentIntent {
    ...
    ) -> <C as BaseClient>::Response<List<PaymentIntent>> {
    ...
    ) -> <C as BaseClient>::Response<PaymentIntent> {

...
use crate::resources::{BalanceTransaction, Charge, File, PaymentIntent};
...
impl Dispute {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListDisputes<'_>,
    ) -> <C as BaseClient>::Response<List<Dispute>> {
    ...
    pub fn retrieve<C: BaseClient>(
        ...
        id: &DisputeId,
        expand: &[&str],
    ) -> <C as BaseClient>::Response<Dispute> {

...
use crate::resources::{
    Application, CheckoutSessionItem, Customer, Discount, OrdersV2ResourcePayment, ShippingRate,
};
...
impl Order {
    ...
    pub fn list<C: BaseClient>(
        client: &Client<C>,
        params: &ListOrders<'_>,
    ) -> <C as BaseClient>::Response<List<Order>> {
    ...
    ) -> <C as BaseClient>::Response<Order> {

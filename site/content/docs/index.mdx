...
import {CargoFeatures} from "@/components/cargo-features"
...
`async-stripe` uses feature flags to keep the dependency tree lean and allow you to choose your preferred HTTP client and TLS stack.

<CargoFeatures file="async-stripe/Cargo.toml" />

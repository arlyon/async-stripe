...
<CodeFromFile
  file="examples/errors/src/error_handling_basic.rs"
  href={{base: "https://github.com/arlyon/async-stripe/blob/master/"}}
  lang="rust"
  startLine={18}
  endLine={31}
...
<CodeFromFile
  file="examples/errors/src/error_handling_status_codes.rs"
  href={{base: "https://github.com/arlyon/async-stripe/blob/master/"}}
  lang="rust"
  startLine={21}
  endLine={67}
...
```toml
[dependencies]
stripe-core = { version = "1.0.0-rc.0", features = ["customer", "deserialize"] }
```
...
<CodeFromFile
  file="examples/errors/src/error_handling_retry.rs"
  href={{base: "https://github.com/arlyon/async-stripe/blob/master/"}}
  lang="rust"
  startLine={17}
  endLine={26}

...
/// The openapi generator creates a forest of objects that refer to other objects.
/// Any objects defined here will be placed in the paired crate with its descendants.
///  A node that depends on a node in a different crate will cause a dependency on that crate.
pub fn crate_mappings() -> ObjectMap {
    [
        ("account", "stripe-connect"),
        ("account_link", "stripe-connect"),
        ("alipay_account", "stripe-payment"),
        ("apple_pay_domain", "stripe-core"),
        ("application", "stripe-connect"),
        ("application_fee", "stripe-connect"),
        ("balance", "stripe-core"),
        ("balance_transaction", "stripe-core"),
        ("bank_account", "stripe-payment"),
        ("billing_portal.configuration", "stripe-billing"),
        ("billing_portal.session", "stripe-billing"),
        ("bitcoin_receiver", "stripe-core"),
        ("bitcoin_transaction", "stripe-core"),
        ("capability", "stripe-core"),
        ("card", "stripe-payment"),
        ("charge", "stripe-core"),
        ("checkout.session", "stripe-checkout"),
        ("connect_collection_transfer", "stripe-connect"),
        ("country_spec", "stripe-core"),
        ("coupon", "stripe-core"),
        ("credit_note", "stripe-core"),
        ("credit_note_line_item", "stripe-core"),
        ("customer", "stripe-core"),
        ("customer_balance_transaction", "stripe-core"),
        ("discount", "stripe-billing"),
        ("dispute", "stripe-core"),
        ("ephemeral_key", "stripe-core"),
        ("event", "stripe-events"),
        ("exchange_rate", "stripe-core"),
        ("fee_refund", "stripe-connect"),
        ("file", "stripe-core"),
        ("file_link", "stripe-core"),
        ("identity.verification_report", "stripe-core"),
        ("identity.verification_session", "stripe-core"),
        ("invoice", "stripe-billing"),
        ("invoiceitem", "stripe-billing"),
        ("issuer_fraud_record", "stripe-core"),
        ("issuing.authorization", "stripe-issuing"),
        ("issuing.card", "stripe-issuing"),
        ("issuing.cardholder", "stripe-issuing"),
        ("issuing.dispute", "stripe-issuing"),
        ("issuing.settlement", "stripe-issuing"),
        ("issuing.transaction", "stripe-issuing"),
        ("item", "stripe-core"),
        ("line_item", "stripe-billing"),
        ("login_link", "stripe-connect"),
        ("mandate", "stripe-core"),
        ("notification_event_data", "stripe-core"),
        ("order", "stripe-orders"),
        ("order_item", "stripe-orders"),
        ("order_return", "stripe-orders"),
        ("payment_intent", "stripe-core"),
        ("payment_link", "stripe-checkout"),
        ("payment_method", "stripe-payment"),
        ("payout", "stripe-core"),
        ("person", "stripe-connect"),
        ("plan", "stripe-billing"),
        ("platform_tax_fee", "stripe-core"),
        ("price", "stripe-billing"),
        ("product", "stripe-core"),
        ("promotion_code", "stripe-billing"),
        ("quote", "stripe-billing"),
        ("radar.early_fraud_warning", "stripe-core"),
        ("radar.value_list", "stripe-core"),
        ("radar.value_list_item", "stripe-core"),
        ("recipient", "stripe-connect"),
        ("refund", "stripe-core"),
        ("reporting.report_run", "stripe-core"),
        ("reporting.report_type", "stripe-core"),
        ("reserve_transaction", "stripe-core"),
        ("review", "stripe-fraud"),
        ("scheduled_query_run", "stripe-sigma"),
        ("setup_attempt", "stripe-core"),
        ("setup_intent", "stripe-core"),
        ("shipping_rate", "stripe-core"),
        ("sku", "stripe-core"),
        ("source", "stripe-payment"),
        ("source_mandate_notification", "stripe-core"),
        ("source_transaction", "stripe-core"),
        ("subscription", "stripe-billing"),
        ("subscription_item", "stripe-billing"),
        ("subscription_schedule", "stripe-billing"),
        ("tax_code", "stripe-core"),
        ("tax_deducted_at_source", "stripe-core"),
        ("tax_id", "stripe-billing"),
        ("tax_rate", "stripe-billing"),
        ("terminal.connection_token", "stripe-core"),
        ("terminal.location", "stripe-core"),
        ("terminal.reader", "stripe-core"),
        ("test_helpers.test_clock", "stripe-core"),
        ("three_d_secure", "stripe-core"),
        ("token", "stripe-core"),
        ("topup", "stripe-connect"),
        ("transfer", "stripe-connect"),
        ("transfer_reversal", "stripe-connect"),
        ("usage_record", "stripe-core"),
        ("usage_record_summary", "stripe-billing"),
        ("webhook_endpoint", "stripe-events"),
    ]
    .iter()
    .copied()
    .collect()

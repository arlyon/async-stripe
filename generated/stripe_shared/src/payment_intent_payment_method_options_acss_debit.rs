...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage);
/// Bank account verification method.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod);

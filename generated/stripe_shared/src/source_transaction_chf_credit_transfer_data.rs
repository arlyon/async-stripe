        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "sender_address_country" => b.sender_address_country = Some(FromValueOpt::from_value(v)?),
                    "sender_address_line1" => b.sender_address_line1 = Some(FromValueOpt::from_value(v)?),

        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "first_time_transaction" => b.first_time_transaction = Some(FromValueOpt::from_value(v)?),
                    "minimum_amount" => b.minimum_amount = Some(FromValueOpt::from_value(v)?),
                    "minimum_amount_currency" => b.minimum_amount_currency = Some(FromValueOpt::from_value(v)?),

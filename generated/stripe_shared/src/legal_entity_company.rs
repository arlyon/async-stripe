        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "directors_provided" => b.directors_provided = Some(FromValueOpt::from_value(v)?),
                    "executives_provided" => b.executives_provided = Some(FromValueOpt::from_value(v)?),
                    "export_license_id" => b.export_license_id = Some(FromValueOpt::from_value(v)?),
                    "export_purpose_code" => b.export_purpose_code = Some(FromValueOpt::from_value(v)?),
                    ...
                    "ownership_declaration" => b.ownership_declaration = Some(FromValueOpt::from_value(v)?),

...
const _: () = {
    ...
    impl MapBuilder for SourceTypeCardPresentBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "application_preferred_name" => Deserialize::begin(&mut self.application_preferred_name),
                ...
                "evidence_customer_signature" => Deserialize::begin(&mut self.evidence_customer_signature),
                "evidence_transaction_certificate" => Deserialize::begin(&mut self.evidence_transaction_certificate),
                ...
                "terminal_verification_results" => Deserialize::begin(&mut self.terminal_verification_results),
                "transaction_status_information" => Deserialize::begin(&mut self.transaction_status_information),
    ...
    impl FromValueOpt for SourceTypeCardPresent {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "application_cryptogram" => b.application_cryptogram = Some(FromValueOpt::from_value(v)?),
                    "application_preferred_name" => b.application_preferred_name = Some(FromValueOpt::from_value(v)?),
                    "authorization_code" => b.authorization_code = Some(FromValueOpt::from_value(v)?),
                    "authorization_response_code" => b.authorization_response_code = Some(FromValueOpt::from_value(v)?),
                    ...
                    "dedicated_file_name" => b.dedicated_file_name = Some(FromValueOpt::from_value(v)?),
                    "description" => b.description = Some(FromValueOpt::from_value(v)?),
                    "emv_auth_data" => b.emv_auth_data = Some(FromValueOpt::from_value(v)?),
                    "evidence_customer_signature" => b.evidence_customer_signature = Some(FromValueOpt::from_value(v)?),
                    "evidence_transaction_certificate" => b.evidence_transaction_certificate = Some(FromValueOpt::from_value(v)?),
                    ...
                    "terminal_verification_results" => b.terminal_verification_results = Some(FromValueOpt::from_value(v)?),
                    "transaction_status_information" => b.transaction_status_information = Some(FromValueOpt::from_value(v)?),

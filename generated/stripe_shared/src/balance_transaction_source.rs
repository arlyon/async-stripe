...
const _: () = {
    ...
    impl BalanceTransactionSource {
        fn construct(key: &str, o: miniserde::json::Object) -> Option<Self> {
            Some(match key {
                "application_fee" => Self::ApplicationFee(FromValueOpt::from_value(Value::Object(o))?),
                "charge" => Self::Charge(FromValueOpt::from_value(Value::Object(o))?),
                "connect_collection_transfer" => Self::ConnectCollectionTransfer(FromValueOpt::from_value(Value::Object(o))?),
                "customer_cash_balance_transaction" => Self::CustomerCashBalanceTransaction(FromValueOpt::from_value(Value::Object(o))?),
                "dispute" => Self::Dispute(FromValueOpt::from_value(Value::Object(o))?),
                "fee_refund" => Self::ApplicationFeeRefund(FromValueOpt::from_value(Value::Object(o))?),
                "issuing.authorization" => Self::IssuingAuthorization(FromValueOpt::from_value(Value::Object(o))?),
                "issuing.dispute" => Self::IssuingDispute(FromValueOpt::from_value(Value::Object(o))?),
                "issuing.transaction" => Self::IssuingTransaction(FromValueOpt::from_value(Value::Object(o))?),
                "payout" => Self::Payout(FromValueOpt::from_value(Value::Object(o))?),
                "platform_tax_fee" => Self::PlatformTaxFee(FromValueOpt::from_value(Value::Object(o))?),
                "refund" => Self::Refund(FromValueOpt::from_value(Value::Object(o))?),
                "reserve_transaction" => Self::ReserveTransaction(FromValueOpt::from_value(Value::Object(o))?),
                "tax_deducted_at_source" => Self::TaxDeductedAtSource(FromValueOpt::from_value(Value::Object(o))?),
                "topup" => Self::Topup(FromValueOpt::from_value(Value::Object(o))?),
                "transfer" => Self::Transfer(FromValueOpt::from_value(Value::Object(o))?),
                "transfer_reversal" => Self::TransferReversal(FromValueOpt::from_value(Value::Object(o))?),

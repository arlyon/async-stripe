...
const _: () = {
    ...
    impl FromValueOpt for AccountRequirementsAlternative {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "alternative_fields_due" => b.alternative_fields_due = Some(FromValueOpt::from_value(v)?),
                    "original_fields_due" => b.original_fields_due = Some(FromValueOpt::from_value(v)?),

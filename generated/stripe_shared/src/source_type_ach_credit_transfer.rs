    ...
    impl MapBuilder for SourceTypeAchCreditTransferBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "refund_account_holder_type" => Deserialize::begin(&mut self.refund_account_holder_type),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "refund_account_holder_type" => b.refund_account_holder_type = Some(FromValueOpt::from_value(v)?),
                    "refund_routing_number" => b.refund_routing_number = Some(FromValueOpt::from_value(v)?),

...
const _: () = {
    ...
    impl FromValueOpt for PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebit {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebitBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule);
/// Transaction type of the mandate.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType);

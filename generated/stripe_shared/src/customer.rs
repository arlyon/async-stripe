        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "invoice_credit_balance" => b.invoice_credit_balance = Some(FromValueOpt::from_value(v)?),
                    ...
                    "next_invoice_sequence" => b.next_invoice_sequence = Some(FromValueOpt::from_value(v)?),

...
const _: () = {
    ...
    impl MapBuilder for DisputeEvidenceBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "cancellation_policy_disclosure" => Deserialize::begin(&mut self.cancellation_policy_disclosure),
                ...
                "duplicate_charge_documentation" => Deserialize::begin(&mut self.duplicate_charge_documentation),
                "duplicate_charge_explanation" => Deserialize::begin(&mut self.duplicate_charge_explanation),
                ...
                "refund_policy_disclosure" => Deserialize::begin(&mut self.refund_policy_disclosure),
                "refund_refusal_explanation" => Deserialize::begin(&mut self.refund_refusal_explanation),
                ...
                "shipping_tracking_number" => Deserialize::begin(&mut self.shipping_tracking_number),
    ...
    impl FromValueOpt for DisputeEvidence {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "access_activity_log" => b.access_activity_log = Some(FromValueOpt::from_value(v)?),
                    "billing_address" => b.billing_address = Some(FromValueOpt::from_value(v)?),
                    "cancellation_policy" => b.cancellation_policy = Some(FromValueOpt::from_value(v)?),
                    "cancellation_policy_disclosure" => b.cancellation_policy_disclosure = Some(FromValueOpt::from_value(v)?),
                    "cancellation_rebuttal" => b.cancellation_rebuttal = Some(FromValueOpt::from_value(v)?),
                    "customer_communication" => b.customer_communication = Some(FromValueOpt::from_value(v)?),
                    "customer_email_address" => b.customer_email_address = Some(FromValueOpt::from_value(v)?),
                    "customer_name" => b.customer_name = Some(FromValueOpt::from_value(v)?),
                    "customer_purchase_ip" => b.customer_purchase_ip = Some(FromValueOpt::from_value(v)?),
                    "customer_signature" => b.customer_signature = Some(FromValueOpt::from_value(v)?),
                    "duplicate_charge_documentation" => b.duplicate_charge_documentation = Some(FromValueOpt::from_value(v)?),
                    "duplicate_charge_explanation" => b.duplicate_charge_explanation = Some(FromValueOpt::from_value(v)?),
                    "duplicate_charge_id" => b.duplicate_charge_id = Some(FromValueOpt::from_value(v)?),
                    ...
                    "refund_policy_disclosure" => b.refund_policy_disclosure = Some(FromValueOpt::from_value(v)?),
                    "refund_refusal_explanation" => b.refund_refusal_explanation = Some(FromValueOpt::from_value(v)?),
                    "service_date" => b.service_date = Some(FromValueOpt::from_value(v)?),
                    "service_documentation" => b.service_documentation = Some(FromValueOpt::from_value(v)?),
                    ...
                    "shipping_documentation" => b.shipping_documentation = Some(FromValueOpt::from_value(v)?),
                    "shipping_tracking_number" => b.shipping_tracking_number = Some(FromValueOpt::from_value(v)?),
                    "uncategorized_file" => b.uncategorized_file = Some(FromValueOpt::from_value(v)?),
                    "uncategorized_text" => b.uncategorized_text = Some(FromValueOpt::from_value(v)?),

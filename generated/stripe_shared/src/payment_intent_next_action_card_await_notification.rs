    ...
    impl MapBuilder for PaymentIntentNextActionCardAwaitNotificationBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "customer_approval_required" => Deserialize::begin(&mut self.customer_approval_required),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "customer_approval_required" => b.customer_approval_required = Some(FromValueOpt::from_value(v)?),

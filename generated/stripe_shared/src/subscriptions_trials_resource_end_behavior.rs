...
const _: () = {
    ...
    impl FromValueOpt for SubscriptionsTrialsResourceEndBehavior {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "missing_payment_method" => b.missing_payment_method = Some(FromValueOpt::from_value(v)?),
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod);

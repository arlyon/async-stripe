...
const _: () = {
    ...
    impl FromValueOpt for CustomerCashBalanceTransaction {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "adjusted_for_overdraft" => b.adjusted_for_overdraft = Some(FromValueOpt::from_value(v)?),
                    "applied_to_payment" => b.applied_to_payment = Some(FromValueOpt::from_value(v)?),
                    ...
                    "refunded_from_payment" => b.refunded_from_payment = Some(FromValueOpt::from_value(v)?),
                    "type" => b.type_ = Some(FromValueOpt::from_value(v)?),
                    "unapplied_from_payment" => b.unapplied_from_payment = Some(FromValueOpt::from_value(v)?),

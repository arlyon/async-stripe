    ...
    impl MapBuilder for SubscriptionBillingThresholdsBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "reset_billing_cycle_anchor" => Deserialize::begin(&mut self.reset_billing_cycle_anchor),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "reset_billing_cycle_anchor" => b.reset_billing_cycle_anchor = Some(FromValueOpt::from_value(v)?),

    ...
    impl MapBuilder for ChargeBuilder {
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            Some(Self::Out {
                ...
                application_fee: self.application_fee.take()?,
                ...
                calculated_statement_descriptor: self.calculated_statement_descriptor.take()?,
                ...
                fraud_details: self.fraud_details.take()?,
                id: self.id.take()?,
                invoice: self.invoice.take()?,
                level3: self.level3.take()?,
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "calculated_statement_descriptor" => {
                        b.calculated_statement_descriptor = Some(FromValueOpt::from_value(v)?)
                    }

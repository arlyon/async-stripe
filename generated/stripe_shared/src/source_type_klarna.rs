...
const _: () = {
    ...
    impl MapBuilder for SourceTypeKlarnaBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "pay_later_asset_urls_descriptive" => Deserialize::begin(&mut self.pay_later_asset_urls_descriptive),
                "pay_later_asset_urls_standard" => Deserialize::begin(&mut self.pay_later_asset_urls_standard),
                ...
                "pay_now_asset_urls_descriptive" => Deserialize::begin(&mut self.pay_now_asset_urls_descriptive),
                "pay_now_asset_urls_standard" => Deserialize::begin(&mut self.pay_now_asset_urls_standard),
                "pay_now_name" => Deserialize::begin(&mut self.pay_now_name),
                "pay_now_redirect_url" => Deserialize::begin(&mut self.pay_now_redirect_url),
                "pay_over_time_asset_urls_descriptive" => Deserialize::begin(&mut self.pay_over_time_asset_urls_descriptive),
                "pay_over_time_asset_urls_standard" => Deserialize::begin(&mut self.pay_over_time_asset_urls_standard),
                "pay_over_time_name" => Deserialize::begin(&mut self.pay_over_time_name),
                "pay_over_time_redirect_url" => Deserialize::begin(&mut self.pay_over_time_redirect_url),
    ...
    impl FromValueOpt for SourceTypeKlarna {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "background_image_url" => b.background_image_url = Some(FromValueOpt::from_value(v)?),
                    ...
                    "pay_later_asset_urls_descriptive" => b.pay_later_asset_urls_descriptive = Some(FromValueOpt::from_value(v)?),
                    "pay_later_asset_urls_standard" => b.pay_later_asset_urls_standard = Some(FromValueOpt::from_value(v)?),
                    "pay_later_name" => b.pay_later_name = Some(FromValueOpt::from_value(v)?),
                    "pay_later_redirect_url" => b.pay_later_redirect_url = Some(FromValueOpt::from_value(v)?),
                    "pay_now_asset_urls_descriptive" => b.pay_now_asset_urls_descriptive = Some(FromValueOpt::from_value(v)?),
                    "pay_now_asset_urls_standard" => b.pay_now_asset_urls_standard = Some(FromValueOpt::from_value(v)?),
                    "pay_now_name" => b.pay_now_name = Some(FromValueOpt::from_value(v)?),
                    "pay_now_redirect_url" => b.pay_now_redirect_url = Some(FromValueOpt::from_value(v)?),
                    "pay_over_time_asset_urls_descriptive" => b.pay_over_time_asset_urls_descriptive = Some(FromValueOpt::from_value(v)?),
                    "pay_over_time_asset_urls_standard" => b.pay_over_time_asset_urls_standard = Some(FromValueOpt::from_value(v)?),
                    "pay_over_time_name" => b.pay_over_time_name = Some(FromValueOpt::from_value(v)?),
                    "pay_over_time_redirect_url" => b.pay_over_time_redirect_url = Some(FromValueOpt::from_value(v)?),
                    "payment_method_categories" => b.payment_method_categories = Some(FromValueOpt::from_value(v)?),
                    ...
                    "shipping_first_name" => b.shipping_first_name = Some(FromValueOpt::from_value(v)?),
                    "shipping_last_name" => b.shipping_last_name = Some(FromValueOpt::from_value(v)?),

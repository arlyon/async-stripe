    ...
    impl MapBuilder for SourceTypeAcssDebitBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "bank_address_postal_code" => Deserialize::begin(&mut self.bank_address_postal_code),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "bank_address_line_1" => b.bank_address_line_1 = Some(FromValueOpt::from_value(v)?),
                    "bank_address_line_2" => b.bank_address_line_2 = Some(FromValueOpt::from_value(v)?),
                    "bank_address_postal_code" => b.bank_address_postal_code = Some(FromValueOpt::from_value(v)?),

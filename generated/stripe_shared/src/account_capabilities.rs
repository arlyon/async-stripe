...
const _: () = {
    ...
    impl MapBuilder for AccountCapabilitiesBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "afterpay_clearpay_payments" => Deserialize::begin(&mut self.afterpay_clearpay_payments),
                ...
                "cartes_bancaires_payments" => Deserialize::begin(&mut self.cartes_bancaires_payments),
                ...
                "india_international_payments" => Deserialize::begin(&mut self.india_international_payments),
                ...
                "tax_reporting_us_1099_misc" => Deserialize::begin(&mut self.tax_reporting_us_1099_misc),
                "transfers" => Deserialize::begin(&mut self.transfers),
                "treasury" => Deserialize::begin(&mut self.treasury),
                "us_bank_account_ach_payments" => Deserialize::begin(&mut self.us_bank_account_ach_payments),
    ...
    impl FromValueOpt for AccountCapabilities {
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    "acss_debit_payments" => b.acss_debit_payments = Some(FromValueOpt::from_value(v)?),
                    "affirm_payments" => b.affirm_payments = Some(FromValueOpt::from_value(v)?),
                    "afterpay_clearpay_payments" => b.afterpay_clearpay_payments = Some(FromValueOpt::from_value(v)?),
                    "au_becs_debit_payments" => b.au_becs_debit_payments = Some(FromValueOpt::from_value(v)?),
                    "bacs_debit_payments" => b.bacs_debit_payments = Some(FromValueOpt::from_value(v)?),
                    "bancontact_payments" => b.bancontact_payments = Some(FromValueOpt::from_value(v)?),
                    "bank_transfer_payments" => b.bank_transfer_payments = Some(FromValueOpt::from_value(v)?),
                    ...
                    "cartes_bancaires_payments" => b.cartes_bancaires_payments = Some(FromValueOpt::from_value(v)?),
                    ...
                    "india_international_payments" => b.india_international_payments = Some(FromValueOpt::from_value(v)?),
                    ...
                    "promptpay_payments" => b.promptpay_payments = Some(FromValueOpt::from_value(v)?),
                    "revolut_pay_payments" => b.revolut_pay_payments = Some(FromValueOpt::from_value(v)?),
                    ...
                    "tax_reporting_us_1099_k" => b.tax_reporting_us_1099_k = Some(FromValueOpt::from_value(v)?),
                    "tax_reporting_us_1099_misc" => b.tax_reporting_us_1099_misc = Some(FromValueOpt::from_value(v)?),
                    "transfers" => b.transfers = Some(FromValueOpt::from_value(v)?),
                    "treasury" => b.treasury = Some(FromValueOpt::from_value(v)?),
                    "us_bank_account_ach_payments" => b.us_bank_account_ach_payments = Some(FromValueOpt::from_value(v)?),

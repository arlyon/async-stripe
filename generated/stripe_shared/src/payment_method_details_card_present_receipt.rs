    ...
    impl MapBuilder for PaymentMethodDetailsCardPresentReceiptBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "cardholder_verification_method" => Deserialize::begin(&mut self.cardholder_verification_method),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "cardholder_verification_method" => b.cardholder_verification_method = Some(FromValueOpt::from_value(v)?),

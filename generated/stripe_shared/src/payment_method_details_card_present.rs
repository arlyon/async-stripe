    ...
    impl MapBuilder for PaymentMethodDetailsCardPresentBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "incremental_authorization_supported" => Deserialize::begin(&mut self.incremental_authorization_supported),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "incremental_authorization_supported" => b.incremental_authorization_supported = Some(FromValueOpt::from_value(v)?),
                    ...
                    "overcapture_supported" => b.overcapture_supported = Some(FromValueOpt::from_value(v)?),

        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "token_reference_id" => b.token_reference_id = Some(FromValueOpt::from_value(v)?),
                    "token_requestor_id" => b.token_requestor_id = Some(FromValueOpt::from_value(v)?),
                    "token_requestor_name" => b.token_requestor_name = Some(FromValueOpt::from_value(v)?),

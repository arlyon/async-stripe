    ...
    impl MapBuilder for SubscriptionsResourcePaymentSettingsBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "save_default_payment_method" => Deserialize::begin(&mut self.save_default_payment_method),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "save_default_payment_method" => b.save_default_payment_method = Some(FromValueOpt::from_value(v)?),
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SubscriptionsResourcePaymentSettingsSaveDefaultPaymentMethod);

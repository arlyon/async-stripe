    ...
    impl MapBuilder for AccountPaymentsSettingsBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "statement_descriptor_kana" => Deserialize::begin(&mut self.statement_descriptor_kana),
                "statement_descriptor_kanji" => Deserialize::begin(&mut self.statement_descriptor_kanji),
                "statement_descriptor_prefix_kana" => Deserialize::begin(&mut self.statement_descriptor_prefix_kana),
                "statement_descriptor_prefix_kanji" => Deserialize::begin(&mut self.statement_descriptor_prefix_kanji),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "statement_descriptor_kana" => b.statement_descriptor_kana = Some(FromValueOpt::from_value(v)?),
                    "statement_descriptor_kanji" => b.statement_descriptor_kanji = Some(FromValueOpt::from_value(v)?),
                    "statement_descriptor_prefix_kana" => b.statement_descriptor_prefix_kana = Some(FromValueOpt::from_value(v)?),
                    "statement_descriptor_prefix_kanji" => b.statement_descriptor_prefix_kanji = Some(FromValueOpt::from_value(v)?),

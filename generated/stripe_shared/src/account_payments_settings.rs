    ...
    impl MapBuilder for AccountPaymentsSettingsBuilder {
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            Some(Self::Out {
                ...
                statement_descriptor_kana: self.statement_descriptor_kana.take()?,
                statement_descriptor_kanji: self.statement_descriptor_kanji.take()?,
                statement_descriptor_prefix_kana: self.statement_descriptor_prefix_kana.take()?,
                statement_descriptor_prefix_kanji: self.statement_descriptor_prefix_kanji.take()?,
            })
        }
    }
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "statement_descriptor_kana" => {
                        b.statement_descriptor_kana = Some(FromValueOpt::from_value(v)?)
                    }
                    "statement_descriptor_kanji" => {
                        b.statement_descriptor_kanji = Some(FromValueOpt::from_value(v)?)
                    }
                    "statement_descriptor_prefix_kana" => {
                        b.statement_descriptor_prefix_kana = Some(FromValueOpt::from_value(v)?)
                    }
                    "statement_descriptor_prefix_kanji" => {
                        b.statement_descriptor_prefix_kanji = Some(FromValueOpt::from_value(v)?)
                    }

    ...
    impl MapBuilder for PaymentIntentPaymentMethodOptionsCardBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "request_extended_authorization" => Deserialize::begin(&mut self.request_extended_authorization),
                "request_incremental_authorization" => Deserialize::begin(&mut self.request_incremental_authorization),
                ...
                "statement_descriptor_suffix_kanji" => Deserialize::begin(&mut self.statement_descriptor_suffix_kanji),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "request_extended_authorization" => b.request_extended_authorization = Some(FromValueOpt::from_value(v)?),
                    "request_incremental_authorization" => b.request_incremental_authorization = Some(FromValueOpt::from_value(v)?),
                    "request_multicapture" => b.request_multicapture = Some(FromValueOpt::from_value(v)?),
                    "request_overcapture" => b.request_overcapture = Some(FromValueOpt::from_value(v)?),
                    "request_three_d_secure" => b.request_three_d_secure = Some(FromValueOpt::from_value(v)?),
                    "setup_future_usage" => b.setup_future_usage = Some(FromValueOpt::from_value(v)?),
                    "statement_descriptor_suffix_kana" => b.statement_descriptor_suffix_kana = Some(FromValueOpt::from_value(v)?),
                    "statement_descriptor_suffix_kanji" => b.statement_descriptor_suffix_kanji = Some(FromValueOpt::from_value(v)?),
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization);
/// Request ability to [increment](https://stripe.com/docs/payments/incremental-authorization) for this PaymentIntent.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization);
/// Request ability to make [multiple captures](https://stripe.com/docs/payments/multicapture) for this PaymentIntent.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsCardRequestMulticapture);
/// Request ability to [overcapture](https://stripe.com/docs/payments/overcapture) for this PaymentIntent.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure);
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
///
/// Providing this parameter will [attach the payment method](https://stripe.com/docs/payments/save-during-payment) to the PaymentIntent's Customer, if present, after the PaymentIntent is confirmed and any required actions from the user are complete.
/// If no Customer was provided, the payment method can still be [attached](https://stripe.com/docs/api/payment_methods/attach) to a Customer after the transaction completes.

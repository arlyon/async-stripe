    ...
    impl MapBuilder for SourceTypeSepaCreditTransferBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "refund_account_holder_address_city" => Deserialize::begin(&mut self.refund_account_holder_address_city),
                "refund_account_holder_address_country" => Deserialize::begin(&mut self.refund_account_holder_address_country),
                "refund_account_holder_address_line1" => Deserialize::begin(&mut self.refund_account_holder_address_line1),
                "refund_account_holder_address_line2" => Deserialize::begin(&mut self.refund_account_holder_address_line2),
                "refund_account_holder_address_postal_code" => Deserialize::begin(&mut self.refund_account_holder_address_postal_code),
                "refund_account_holder_address_state" => Deserialize::begin(&mut self.refund_account_holder_address_state),
                "refund_account_holder_name" => Deserialize::begin(&mut self.refund_account_holder_name),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "refund_account_holder_address_city" => b.refund_account_holder_address_city = Some(FromValueOpt::from_value(v)?),
                    "refund_account_holder_address_country" => b.refund_account_holder_address_country = Some(FromValueOpt::from_value(v)?),
                    "refund_account_holder_address_line1" => b.refund_account_holder_address_line1 = Some(FromValueOpt::from_value(v)?),
                    "refund_account_holder_address_line2" => b.refund_account_holder_address_line2 = Some(FromValueOpt::from_value(v)?),
                    "refund_account_holder_address_postal_code" => b.refund_account_holder_address_postal_code = Some(FromValueOpt::from_value(v)?),
                    "refund_account_holder_address_state" => b.refund_account_holder_address_state = Some(FromValueOpt::from_value(v)?),
                    "refund_account_holder_name" => b.refund_account_holder_name = Some(FromValueOpt::from_value(v)?),

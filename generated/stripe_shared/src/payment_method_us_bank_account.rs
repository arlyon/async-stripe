    ...
    impl MapBuilder for PaymentMethodUsBankAccountBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "financial_connections_account" => Deserialize::begin(&mut self.financial_connections_account),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "financial_connections_account" => b.financial_connections_account = Some(FromValueOpt::from_value(v)?),

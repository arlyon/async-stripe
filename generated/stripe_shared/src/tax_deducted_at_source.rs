    ...
    impl MapBuilder for TaxDeductedAtSourceBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "tax_deduction_account_number" => Deserialize::begin(&mut self.tax_deduction_account_number),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "tax_deduction_account_number" => b.tax_deduction_account_number = Some(FromValueOpt::from_value(v)?),

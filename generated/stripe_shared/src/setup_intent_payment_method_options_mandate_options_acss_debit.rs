...
const _: () = {
    ...
    impl FromValueOpt for SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
                    "custom_mandate_url" => b.custom_mandate_url = Some(FromValueOpt::from_value(v)?),
                    "default_for" => b.default_for = Some(FromValueOpt::from_value(v)?),
                    "interval_description" => b.interval_description = Some(FromValueOpt::from_value(v)?),
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor);
/// Payment schedule for the mandate.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule);
/// Transaction type of the mandate.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType);

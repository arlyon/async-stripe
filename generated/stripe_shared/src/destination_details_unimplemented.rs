...
const _: () = {
    ...
    impl Visitor for Place<DestinationDetailsUnimplemented> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder: DestinationDetailsUnimplementedBuilder::deser_default(),
            }))
        }
    }

    impl MapBuilder for DestinationDetailsUnimplementedBuilder {
        type Out = DestinationDetailsUnimplemented;
    ...
    impl ObjectDeser for DestinationDetailsUnimplemented {
        type Builder = DestinationDetailsUnimplementedBuilder;
    }

    impl FromValueOpt for DestinationDetailsUnimplemented {

    ...
    impl MapBuilder for SourceReceiverFlowBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "refund_attributes_method" => Deserialize::begin(&mut self.refund_attributes_method),
                "refund_attributes_status" => Deserialize::begin(&mut self.refund_attributes_status),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "refund_attributes_method" => b.refund_attributes_method = Some(FromValueOpt::from_value(v)?),
                    "refund_attributes_status" => b.refund_attributes_status = Some(FromValueOpt::from_value(v)?),

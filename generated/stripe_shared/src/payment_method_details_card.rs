    ...
    impl MapBuilder for PaymentMethodDetailsCardBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "incremental_authorization" => Deserialize::begin(&mut self.incremental_authorization),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "extended_authorization" => b.extended_authorization = Some(FromValueOpt::from_value(v)?),
                    ...
                    "incremental_authorization" => b.incremental_authorization = Some(FromValueOpt::from_value(v)?),

    ...
    impl MapBuilder for InvoiceBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "post_payment_credit_notes_amount" => Deserialize::begin(&mut self.post_payment_credit_notes_amount),
                "pre_payment_credit_notes_amount" => Deserialize::begin(&mut self.pre_payment_credit_notes_amount),
                ...
                "subscription_proration_date" => Deserialize::begin(&mut self.subscription_proration_date),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "customer_tax_exempt" => b.customer_tax_exempt = Some(FromValueOpt::from_value(v)?),
                    ...
                    "hosted_invoice_url" => b.hosted_invoice_url = Some(FromValueOpt::from_value(v)?),
                    "id" => b.id = Some(FromValueOpt::from_value(v)?),
                    "invoice_pdf" => b.invoice_pdf = Some(FromValueOpt::from_value(v)?),
                    "last_finalization_error" => b.last_finalization_error = Some(FromValueOpt::from_value(v)?),
                    ...
                    "next_payment_attempt" => b.next_payment_attempt = Some(FromValueOpt::from_value(v)?),
                    ...
                    "post_payment_credit_notes_amount" => b.post_payment_credit_notes_amount = Some(FromValueOpt::from_value(v)?),
                    "pre_payment_credit_notes_amount" => b.pre_payment_credit_notes_amount = Some(FromValueOpt::from_value(v)?),
                    ...
                    "subscription_details" => b.subscription_details = Some(FromValueOpt::from_value(v)?),
                    "subscription_proration_date" => b.subscription_proration_date = Some(FromValueOpt::from_value(v)?),
                    ...
                    "total_discount_amounts" => b.total_discount_amounts = Some(FromValueOpt::from_value(v)?),
                    ...
                    "webhooks_delivered_at" => b.webhooks_delivered_at = Some(FromValueOpt::from_value(v)?),

...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SetupIntentPaymentMethodOptionsCardMandateOptionsAmountType);
/// Specifies payment frequency. One of `day`, `week`, `month`, `year`, or `sporadic`.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SetupIntentPaymentMethodOptionsCardMandateOptionsInterval);
/// Specifies the type of mandates supported. Possible values are `india`.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(SetupIntentPaymentMethodOptionsCardMandateOptionsSupportedTypes);

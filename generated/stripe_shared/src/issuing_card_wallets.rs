    ...
    impl MapBuilder for IssuingCardWalletsBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "primary_account_identifier" => Deserialize::begin(&mut self.primary_account_identifier),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "primary_account_identifier" => b.primary_account_identifier = Some(FromValueOpt::from_value(v)?),

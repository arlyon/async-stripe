    ...
    impl MapBuilder for IssuingDisputeEvidenceBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "merchandise_not_as_described" => Deserialize::begin(&mut self.merchandise_not_as_described),
                ...
                "service_not_as_described" => Deserialize::begin(&mut self.service_not_as_described),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "merchandise_not_as_described" => b.merchandise_not_as_described = Some(FromValueOpt::from_value(v)?),
                    ...
                    "service_not_as_described" => b.service_not_as_described = Some(FromValueOpt::from_value(v)?),

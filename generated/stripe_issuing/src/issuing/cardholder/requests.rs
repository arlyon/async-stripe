...
pub fn list(client:&stripe::Client,params:ListCardholder) -> stripe::Response<stripe_types::List<stripe_types::issuing::cardholder::Cardholder>> {
    client.get_query("/issuing/cardholders", params)
}
        /// Creates a new Issuing `Cardholder` object that can be issued cards.
pub fn create(client:&stripe::Client,params:CreateCardholder) -> stripe::Response<stripe_types::issuing::cardholder::Cardholder> {
    client.send_form("/issuing/cardholders", params, http_types::Method::Post)
}
        /// Retrieves an Issuing `Cardholder` object.
pub fn retrieve(client:&stripe::Client,cardholder:&stripe_types::issuing::cardholder::IssuingCardholderId,params:RetrieveCardholder) -> stripe::Response<stripe_types::issuing::cardholder::Cardholder> {
...
pub fn update(client:&stripe::Client,cardholder:&stripe_types::issuing::cardholder::IssuingCardholderId,params:UpdateCardholder) -> stripe::Response<stripe_types::issuing::cardholder::Cardholder> {
    client.send_form(&format!("/issuing/cardholders/{cardholder}", cardholder=cardholder), params, http_types::Method::Post)
}
...
impl<'a> CreateCardholder<'a> {
    ...
    Self {
        billing,company: Default::default(),email: Default::default(),expand: Default::default(),individual: Default::default(),metadata: Default::default(),name,phone_number: Default::default(),preferred_locales: Default::default(),spending_controls: Default::default(),status: Default::default(),type_: Default::default(),
    }
} 
...
impl CreateCardholderSpendingControlsAllowedCategories {
    pub fn as_str(self) -> &'static str {
        use CreateCardholderSpendingControlsAllowedCategories::*;
        match self {
...
impl CreateCardholderSpendingControlsBlockedCategories {
    pub fn as_str(self) -> &'static str {
        use CreateCardholderSpendingControlsBlockedCategories::*;
        match self {
AcRefrigerationRepair => "ac_refrigeration_repair",
AccountingBookkeepingServices => "accounting_bookkeeping_services",
AdvertisingServices => "advertising_services",
...
impl CreateCardholderSpendingControlsSpendingLimitsCategories {
    pub fn as_str(self) -> &'static str {
        use CreateCardholderSpendingControlsSpendingLimitsCategories::*;
        match self {
AcRefrigerationRepair => "ac_refrigeration_repair",
AccountingBookkeepingServices => "accounting_bookkeeping_services",
AdvertisingServices => "advertising_services",
...
impl UpdateCardholderSpendingControlsAllowedCategories {
    pub fn as_str(self) -> &'static str {
        use UpdateCardholderSpendingControlsAllowedCategories::*;
        match self {
AcRefrigerationRepair => "ac_refrigeration_repair",
AccountingBookkeepingServices => "accounting_bookkeeping_services",
AdvertisingServices => "advertising_services",
...
impl UpdateCardholderSpendingControlsBlockedCategories {
    pub fn as_str(self) -> &'static str {
        use UpdateCardholderSpendingControlsBlockedCategories::*;
        match self {
AcRefrigerationRepair => "ac_refrigeration_repair",
AccountingBookkeepingServices => "accounting_bookkeeping_services",
AdvertisingServices => "advertising_services",
...
impl UpdateCardholderSpendingControlsSpendingLimitsCategories {
    pub fn as_str(self) -> &'static str {
        use UpdateCardholderSpendingControlsSpendingLimitsCategories::*;
        match self {
AcRefrigerationRepair => "ac_refrigeration_repair",
AccountingBookkeepingServices => "accounting_bookkeeping_services",
AdvertisingServices => "advertising_services",

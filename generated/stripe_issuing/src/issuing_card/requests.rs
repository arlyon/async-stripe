...
pub fn list(client: &stripe::Client, params: ListIssuingCard) -> stripe::Response<stripe_types::List<stripe_types::IssuingCard>> {
    client.get_query("/issuing/cards", params)
}
/// Creates an Issuing `Card` object.
pub fn create(client: &stripe::Client, params: CreateIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
    client.send_form("/issuing/cards", params, http_types::Method::Post)
}
/// Retrieves an Issuing `Card` object.
pub fn retrieve(client: &stripe::Client, card: &stripe_types::card::CardId, params: RetrieveIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
...
pub fn update(client: &stripe::Client, card: &stripe_types::card::CardId, params: UpdateIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
    client.send_form(&format!("/issuing/cards/{card}", card = card), params, http_types::Method::Post)
}
/// Updates the shipping status of the specified Issuing `Card` object to `delivered`.
pub fn deliver_card(client: &stripe::Client, card: &stripe_types::card::CardId, params: DeliverCardIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
...
pub fn ship_card(client: &stripe::Client, card: &stripe_types::card::CardId, params: ShipCardIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
...
pub fn return_card(client: &stripe::Client, card: &stripe_types::card::CardId, params: ReturnCardIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
...
pub fn fail_card(client: &stripe::Client, card: &stripe_types::card::CardId, params: FailCardIssuingCard) -> stripe::Response<stripe_types::IssuingCard> {
...
impl<'a> CreateIssuingCardShipping<'a> {
    pub fn new(address: CreateIssuingCardShippingAddress<'a>, name: &'a str) -> Self {
        Self { address, customs: Default::default(), name, phone_number: Default::default(), require_signature: Default::default(), service: Default::default(), type_: Default::default() }
    }
}
/// The address that the card is shipped to.
#[derive(Copy, Clone, Debug, serde::Serialize)]
...
impl<'a> CreateIssuingCardShippingAddress<'a> {
    pub fn new(city: &'a str, country: &'a str, line1: &'a str, postal_code: &'a str) -> Self {
        Self { city, country, line1, line2: Default::default(), postal_code, state: Default::default() }
    }
}
/// Customs information for the shipment.

...
struct ListPaymentRecordBuilder {
    #[serde(skip_serializing_if = "Option::is_none")]
    created_after: Option<stripe_types::Timestamp>,
    #[serde(skip_serializing_if = "Option::is_none")]
    created_before: Option<stripe_types::Timestamp>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl std::fmt::Debug for ListPaymentRecordBuilder {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("ListPaymentRecordBuilder").finish_non_exhaustive()
    }
}
impl ListPaymentRecordBuilder {
    fn new() -> Self {
        Self {
            created_after: None,
            created_before: None,
...
#[cfg_attr(not(feature = "redact-generated-debug"), derive(Debug))]
#[derive(serde::Serialize)]
pub struct ListPaymentRecord {
    inner: ListPaymentRecordBuilder,
}
#[cfg(feature = "redact-generated-debug")]
impl std::fmt::Debug for ListPaymentRecord {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("ListPaymentRecord").finish_non_exhaustive()
    }
}
impl ListPaymentRecord {
    /// Construct a new `ListPaymentRecord`.
    pub fn new() -> Self {
        Self { inner: ListPaymentRecordBuilder::new() }
    }
    /// Only return Payment Records that were created after this unix timestamp.
    pub fn created_after(mut self, created_after: impl Into<stripe_types::Timestamp>) -> Self {
        self.inner.created_after = Some(created_after.into());
        self
    }
    /// Only return Payment Records that were created before this unix timestamp.
    pub fn created_before(mut self, created_before: impl Into<stripe_types::Timestamp>) -> Self {
        self.inner.created_before = Some(created_before.into());
        self
    }
...
impl Default for ListPaymentRecord {
    fn default() -> Self {
        Self::new()
    }
}
impl ListPaymentRecord {
    ...
    pub fn paginate(
        &self,
    ) -> stripe_client_core::ListPaginator<stripe_types::List<stripe_shared::PaymentRecord>> {
        stripe_client_core::ListPaginator::new_list("/payment_records", &self.inner)
    }
}

impl StripeRequest for ListPaymentRecord {
    type Output = stripe_types::List<stripe_shared::PaymentRecord>;

    fn build(&self) -> RequestBuilder {
        RequestBuilder::new(StripeMethod::Get, "/payment_records").query(&self.inner)
    }
}
#[derive(Clone, Eq, PartialEq)]
#[cfg_attr(not(feature = "redact-generated-debug"), derive(Debug))]

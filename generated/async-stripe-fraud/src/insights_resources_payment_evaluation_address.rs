...
impl std::fmt::Debug for InsightsResourcesPaymentEvaluationAddress {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("InsightsResourcesPaymentEvaluationAddress").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(InsightsResourcesPaymentEvaluationAddress {
                city,
                country,
                line1,
                line2,

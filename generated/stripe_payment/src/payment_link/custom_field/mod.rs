...
pub struct CustomField {
    ...
    pub dropdown: Option<
        stripe_payment::payment_link::custom_field::custom_field_dropdown::CustomFieldDropdown,
    >,
    ...
    pub key: String,
    pub label: stripe_payment::payment_link::custom_field::custom_field_label::CustomFieldLabel,

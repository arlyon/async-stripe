...
const _: () = {
    ...
    impl MapBuilder for DeleteCustomerCardReturnedBuilder {
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            ...
            Some(if deleted {
                DeleteCustomerCardReturned::DeletedPaymentSource(FromValueOpt::from_value(Value::Object(o))?)
            } else {
                DeleteCustomerCardReturned::PaymentSource(FromValueOpt::from_value(Value::Object(o))?)
            })
        }
    }

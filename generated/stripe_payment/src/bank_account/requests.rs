...
const _: () = {
    ...
    impl MapBuilder for DeleteCustomerBankAccountReturnedBuilder {
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            ...
            Some(if deleted {
                DeleteCustomerBankAccountReturned::DeletedPaymentSource(FromValueOpt::from_value(Value::Object(o))?)
            } else {
                DeleteCustomerBankAccountReturned::PaymentSource(FromValueOpt::from_value(Value::Object(o))?)
            })
        }
    }

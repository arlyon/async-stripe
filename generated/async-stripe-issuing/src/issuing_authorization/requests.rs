        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    ...
                    v,
                    "CreateIssuingAuthorizationFleetPurchaseType"
                );
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationFleetServiceType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationFuelType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationFuelUnit"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationMerchantDataCategory"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
...
pub struct CreateIssuingAuthorizationRiskAssessment {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fraud_risk: Option<CreateIssuingAuthorizationRiskAssessmentFraudRisk>,
...
impl CreateIssuingAuthorizationRiskAssessment {
    pub fn new() -> Self {
        Self { card_testing_risk: None, fraud_risk: None, merchant_dispute_risk: None }
    }
}
...
impl CreateIssuingAuthorizationRiskAssessmentFraudRisk {
    pub fn new(level: impl Into<CreateIssuingAuthorizationRiskAssessmentFraudRiskLevel>) -> Self {
        Self { level: level.into(), score: None }
    }
}
/// Stripe’s assessment of the likelihood of fraud on an authorization.
#[derive(Clone, Eq, PartialEq)]
...
impl std::fmt::Display for CreateIssuingAuthorizationRiskAssessmentFraudRiskLevel {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
#[cfg(feature = "deserialize")]
impl<'de> serde::Deserialize<'de> for CreateIssuingAuthorizationRiskAssessmentFraudRiskLevel {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: std::borrow::Cow<'de, str> = serde::Deserialize::deserialize(deserializer)?;
        Ok(Self::from_str(&s).expect("infallible"))
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationVerificationDataAddressLine1Check"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationVerificationDataCvcCheck"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationVerificationDataExpiryCheck"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationVerificationDataThreeDSecureResult"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CreateIssuingAuthorizationWallet"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CaptureIssuingAuthorizationPurchaseDetailsFleetPurchaseType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CaptureIssuingAuthorizationPurchaseDetailsFleetServiceType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CaptureIssuingAuthorizationPurchaseDetailsFuelType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CaptureIssuingAuthorizationPurchaseDetailsFuelUnit"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "FinalizeAmountIssuingAuthorizationFleetPurchaseType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "FinalizeAmountIssuingAuthorizationFleetServiceType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "FinalizeAmountIssuingAuthorizationFuelType"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "FinalizeAmountIssuingAuthorizationFuelUnit"
                );
                Ok(Unknown(v.to_owned()))
            }
        }

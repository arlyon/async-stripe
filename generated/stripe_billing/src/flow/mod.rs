...
pub struct Flow {
    pub after_completion: stripe_billing::after_completion::AfterCompletion,
    /// Configuration when `flow.type=subscription_cancel`.
    pub subscription_cancel: Option<stripe_billing::subscription_cancel::SubscriptionCancel>,
    /// Configuration when `flow.type=subscription_update`.
    pub subscription_update: Option<stripe_billing::subscription_update::SubscriptionUpdate>,
    /// Configuration when `flow.type=subscription_update_confirm`.
    pub subscription_update_confirm:
        Option<stripe_billing::subscription_update_confirm::SubscriptionUpdateConfirm>,

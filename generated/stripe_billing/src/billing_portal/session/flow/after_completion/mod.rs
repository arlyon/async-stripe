...
pub hosted_confirmation: Option<stripe_billing::billing_portal::session::flow::after_completion::hosted_confirmation::HostedConfirmation>,
    /// Configuration when `after_completion.type=redirect`.
pub redirect: Option<stripe_billing::billing_portal::session::flow::after_completion::redirect::Redirect>,

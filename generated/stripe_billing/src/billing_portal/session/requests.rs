...
) -> stripe::Response<stripe_billing::billing_portal::session::Session> {
...
pub struct CreateSession<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flow_data: Option<CreateSessionFlowData<'a>>,
...
/// See the [docs](https://stripe.com/docs/customer-management/portal-deep-links) to learn more about using customer portal deep links and flows.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowData<'a> {
    /// Behavior after the flow is completed.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub after_completion: Option<CreateSessionFlowDataAfterCompletion<'a>>,
    /// Configuration when `flow_data.type=subscription_cancel`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subscription_cancel: Option<CreateSessionFlowDataSubscriptionCancel<'a>>,
    /// Configuration when `flow_data.type=subscription_update`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subscription_update: Option<CreateSessionFlowDataSubscriptionUpdate<'a>>,
    /// Configuration when `flow_data.type=subscription_update_confirm`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subscription_update_confirm: Option<CreateSessionFlowDataSubscriptionUpdateConfirm<'a>>,
    /// Type of flow that the customer will go through.
    #[serde(rename = "type")]
    pub type_: CreateSessionFlowDataType,
}
impl<'a> CreateSessionFlowData<'a> {
    pub fn new(type_: CreateSessionFlowDataType) -> Self {
        Self {
...
/// Behavior after the flow is completed.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowDataAfterCompletion<'a> {
    /// Configuration when `after_completion.type=hosted_confirmation`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosted_confirmation: Option<CreateSessionFlowDataAfterCompletionHostedConfirmation<'a>>,
    /// Configuration when `after_completion.type=redirect`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub redirect: Option<CreateSessionFlowDataAfterCompletionRedirect<'a>>,
    /// The specified behavior after the flow is completed.
    #[serde(rename = "type")]
    pub type_: CreateSessionFlowDataAfterCompletionType,
}
impl<'a> CreateSessionFlowDataAfterCompletion<'a> {
    pub fn new(type_: CreateSessionFlowDataAfterCompletionType) -> Self {
        Self { hosted_confirmation: Default::default(), redirect: Default::default(), type_ }
    }
}
/// Configuration when `after_completion.type=hosted_confirmation`.
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
pub struct CreateSessionFlowDataAfterCompletionHostedConfirmation<'a> {
    /// A custom message to display to the customer after the flow is completed.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub custom_message: Option<&'a str>,
}
impl<'a> CreateSessionFlowDataAfterCompletionHostedConfirmation<'a> {
    pub fn new() -> Self {
        Self::default()
    }
}
/// Configuration when `after_completion.type=redirect`.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowDataAfterCompletionRedirect<'a> {
    /// The URL the customer will be redirected to after the flow is completed.
    pub return_url: &'a str,
}
impl<'a> CreateSessionFlowDataAfterCompletionRedirect<'a> {
...
pub enum CreateSessionFlowDataAfterCompletionType {
    HostedConfirmation,
    PortalHomepage,
    Redirect,
}

impl CreateSessionFlowDataAfterCompletionType {
    pub fn as_str(self) -> &'static str {
        use CreateSessionFlowDataAfterCompletionType::*;
        match self {
...
impl std::str::FromStr for CreateSessionFlowDataAfterCompletionType {
    type Err = ();
...
impl AsRef<str> for CreateSessionFlowDataAfterCompletionType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for CreateSessionFlowDataAfterCompletionType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl serde::Serialize for CreateSessionFlowDataAfterCompletionType {
...
/// Configuration when `flow_data.type=subscription_cancel`.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowDataSubscriptionCancel<'a> {
    /// The ID of the subscription to be canceled.
    pub subscription: &'a str,
}
impl<'a> CreateSessionFlowDataSubscriptionCancel<'a> {
...
/// Configuration when `flow_data.type=subscription_update`.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowDataSubscriptionUpdate<'a> {
    /// The ID of the subscription to be updated.
    pub subscription: &'a str,
}
impl<'a> CreateSessionFlowDataSubscriptionUpdate<'a> {
    pub fn new(subscription: &'a str) -> Self {
        Self { subscription }
    }
}
/// Configuration when `flow_data.type=subscription_update_confirm`.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowDataSubscriptionUpdateConfirm<'a> {
    /// The coupon or promotion code to apply to this subscription update.
    ///
    /// Currently, only up to one may be specified.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub discounts: Option<&'a [CreateSessionFlowDataSubscriptionUpdateConfirmDiscounts<'a>]>,
    ...
    pub items: &'a [CreateSessionFlowDataSubscriptionUpdateConfirmItems<'a>],
    /// The ID of the subscription to be updated.
    pub subscription: &'a str,
}
impl<'a> CreateSessionFlowDataSubscriptionUpdateConfirm<'a> {
    pub fn new(
        items: &'a [CreateSessionFlowDataSubscriptionUpdateConfirmItems<'a>],
        subscription: &'a str,
    ) -> Self {
...
/// Currently, only up to one may be specified.
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
pub struct CreateSessionFlowDataSubscriptionUpdateConfirmDiscounts<'a> {
...
impl<'a> CreateSessionFlowDataSubscriptionUpdateConfirmDiscounts<'a> {
    pub fn new() -> Self {
        Self::default()
    }
}
...
/// Currently, only up to one may be specified and subscriptions with multiple items are not updatable.
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateSessionFlowDataSubscriptionUpdateConfirmItems<'a> {
...
impl<'a> CreateSessionFlowDataSubscriptionUpdateConfirmItems<'a> {
...
/// Type of flow that the customer will go through.
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum CreateSessionFlowDataType {
    PaymentMethodUpdate,
    SubscriptionCancel,
    SubscriptionUpdate,
...
impl CreateSessionFlowDataType {
    pub fn as_str(self) -> &'static str {
        use CreateSessionFlowDataType::*;
        match self {
...
impl std::str::FromStr for CreateSessionFlowDataType {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use CreateSessionFlowDataType::*;
        match s {
...
impl AsRef<str> for CreateSessionFlowDataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for CreateSessionFlowDataType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl serde::Serialize for CreateSessionFlowDataType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {

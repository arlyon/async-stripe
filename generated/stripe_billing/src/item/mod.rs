...
pub struct Item {
    ...
    pub id: Option<stripe_billing::item::PortalFlowsSubscriptionUpdateConfirmItemId>,
...
impl stripe_types::Object for Item {
    type Id = Option<stripe_billing::item::PortalFlowsSubscriptionUpdateConfirmItemId>;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

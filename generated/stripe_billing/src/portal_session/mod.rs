...
impl<'de> serde::Deserialize<'de> for PortalSessionLocale {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for PortalSessionLocale"))
    }
}
/// String representing the object's type.
///
...
impl std::str::FromStr for PortalSessionObject {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use PortalSessionObject::*;
        match s {
...
impl AsRef<str> for PortalSessionObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::fmt::Debug for PortalSessionObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for PortalSessionObject {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> serde::Deserialize<'de> for PortalSessionObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for PortalSessionObject"))
    }
}

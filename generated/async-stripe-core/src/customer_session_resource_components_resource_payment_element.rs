...
const _: () = {
    ...
    impl Visitor for Place<CustomerSessionResourceComponentsResourcePaymentElement> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder:
                    CustomerSessionResourceComponentsResourcePaymentElementBuilder::deser_default(),
            }))
        }
    }

    impl MapBuilder for CustomerSessionResourceComponentsResourcePaymentElementBuilder {
        type Out = CustomerSessionResourceComponentsResourcePaymentElement;
    ...
    impl ObjectDeser for CustomerSessionResourceComponentsResourcePaymentElement {
        type Builder = CustomerSessionResourceComponentsResourcePaymentElementBuilder;
    }

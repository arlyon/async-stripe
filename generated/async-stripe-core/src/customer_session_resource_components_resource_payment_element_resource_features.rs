...
impl std::fmt::Debug for CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures")
    ...
    impl Map for Builder<'_> {
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "payment_method_redisplay_limit" => {
                    Deserialize::begin(&mut self.builder.payment_method_redisplay_limit)
                }
                ...
                "payment_method_save_usage" => {
                    Deserialize::begin(&mut self.builder.payment_method_save_usage)
                }
        ...
        fn finish(&mut self) -> Result<()> {
            let (
                ...
                self.builder.payment_method_redisplay_limit,
                self.builder.payment_method_remove.take(),
                self.builder.payment_method_save.take(),
                self.builder.payment_method_save_usage.take(),
            )
            else {
                return Ok(());
            };
            *self.out =
                Some(CustomerSessionResourceComponentsResourcePaymentElementResourceFeatures {
                    payment_method_allow_redisplay_filters,
                    payment_method_redisplay,
                    payment_method_redisplay_limit,
                    payment_method_remove,
...
impl std::fmt::Debug for CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodAllowRedisplayFilters {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodAllowRedisplayFilters)).finish_non_exhaustive()
    }
}
...
impl stripe_miniserde::Deserialize for CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodAllowRedisplayFilters {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodAllowRedisplayFilters> {
...
impl std::fmt::Debug for CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodRedisplay {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodRedisplay)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
...
impl stripe_miniserde::Deserialize for CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodRedisplay {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodRedisplay> {
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
...
{
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodRemove)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
...
{
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodSave)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
impl serde::Serialize
...
impl std::fmt::Debug for CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodSaveUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodSaveUsage)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
...
impl stripe_miniserde::Deserialize for CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodSaveUsage {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<CustomerSessionResourceComponentsResourcePaymentElementResourceFeaturesPaymentMethodSaveUsage> {
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;

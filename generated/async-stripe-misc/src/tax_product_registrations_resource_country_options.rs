    ...
    impl MapBuilder for TaxProductRegistrationsResourceCountryOptionsBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "lk" => Deserialize::begin(&mut self.lk),
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            Some(Self::Out {
                ae: self.ae.take().flatten(),
                al: self.al.take().flatten(),
                am: self.am.take().flatten(),
                ao: self.ao.take().flatten(),
                at: self.at.take().flatten(),
                au: self.au.take().flatten(),
                aw: self.aw.take().flatten(),
                az: self.az.take().flatten(),
                ba: self.ba.take().flatten(),
                bb: self.bb.take().flatten(),
                bd: self.bd.take().flatten(),
                be: self.be.take().flatten(),
                bf: self.bf.take().flatten(),
                bg: self.bg.take().flatten(),
                bh: self.bh.take().flatten(),
                bj: self.bj.take().flatten(),
                bs: self.bs.take().flatten(),
                by: self.by.take().flatten(),
                ca: self.ca.take().flatten(),
                cd: self.cd.take().flatten(),
                ch: self.ch.take().flatten(),
                cl: self.cl.take().flatten(),
                cm: self.cm.take().flatten(),
                co: self.co.take().flatten(),
                cr: self.cr.take().flatten(),
                cv: self.cv.take().flatten(),
                cy: self.cy.take().flatten(),
                cz: self.cz.take().flatten(),
                de: self.de.take().flatten(),
                dk: self.dk.take().flatten(),
                ec: self.ec.take().flatten(),
                ee: self.ee.take().flatten(),
                eg: self.eg.take().flatten(),
                es: self.es.take().flatten(),
                et: self.et.take().flatten(),
                fi: self.fi.take().flatten(),
                fr: self.fr.take().flatten(),
                gb: self.gb.take().flatten(),
                ge: self.ge.take().flatten(),
                gn: self.gn.take().flatten(),
                gr: self.gr.take().flatten(),
                hr: self.hr.take().flatten(),
                hu: self.hu.take().flatten(),
                id: self.id.take().flatten(),
                ie: self.ie.take().flatten(),
                in_: self.in_.take().flatten(),
                is: self.is.take().flatten(),
                it: self.it.take().flatten(),
                jp: self.jp.take().flatten(),
                ke: self.ke.take().flatten(),
                kg: self.kg.take().flatten(),
                kh: self.kh.take().flatten(),
                kr: self.kr.take().flatten(),
                kz: self.kz.take().flatten(),
                la: self.la.take().flatten(),
                lk: self.lk.take().flatten(),
                lt: self.lt.take().flatten(),
                lu: self.lu.take().flatten(),
                lv: self.lv.take().flatten(),
                ma: self.ma.take().flatten(),
                md: self.md.take().flatten(),
                me: self.me.take().flatten(),
                mk: self.mk.take().flatten(),
                mr: self.mr.take().flatten(),
                mt: self.mt.take().flatten(),
                mx: self.mx.take().flatten(),
                my: self.my.take().flatten(),
                ng: self.ng.take().flatten(),
                nl: self.nl.take().flatten(),
                no: self.no.take().flatten(),
                np: self.np.take().flatten(),
                nz: self.nz.take().flatten(),
                om: self.om.take().flatten(),
                pe: self.pe.take().flatten(),
                ph: self.ph.take().flatten(),
                pl: self.pl.take().flatten(),
                pt: self.pt.take().flatten(),
                ro: self.ro.take().flatten(),
                rs: self.rs.take().flatten(),
                ru: self.ru.take().flatten(),
                sa: self.sa.take().flatten(),
                se: self.se.take().flatten(),
                sg: self.sg.take().flatten(),
                si: self.si.take().flatten(),
                sk: self.sk.take().flatten(),
                sn: self.sn.take().flatten(),
                sr: self.sr.take().flatten(),
                th: self.th.take().flatten(),
                tj: self.tj.take().flatten(),
                tr: self.tr.take().flatten(),
                tw: self.tw.take().flatten(),
                tz: self.tz.take().flatten(),
                ua: self.ua.take().flatten(),
                ug: self.ug.take().flatten(),
                us: self.us.take().flatten(),
                uy: self.uy.take().flatten(),
                uz: self.uz.take().flatten(),
                vn: self.vn.take().flatten(),
                za: self.za.take().flatten(),
                zm: self.zm.take().flatten(),
                zw: self.zw.take().flatten(),
            })
        }
    }
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "lk" => b.lk = FromValueOpt::from_value(v),

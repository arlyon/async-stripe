...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(TaxProductResourceTaxCalculationShippingCost {
                amount,
                amount_tax,
                shipping_rate,
                tax_behavior,
...
impl stripe_miniserde::Deserialize for TaxProductResourceTaxCalculationShippingCostTaxBehavior {

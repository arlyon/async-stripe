...
impl std::fmt::Debug for GelatoIdNumberReportError {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("GelatoIdNumberReportError").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(GelatoIdNumberReportError { code, reason });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for GelatoIdNumberReportErrorCode {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(GelatoIdNumberReportErrorCode)).finish_non_exhaustive()
    }
}
...
impl stripe_miniserde::Deserialize for GelatoIdNumberReportErrorCode {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<GelatoIdNumberReportErrorCode> {

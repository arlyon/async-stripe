...
impl std::fmt::Debug for GelatoDataDocumentReportDateOfBirth {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("GelatoDataDocumentReportDateOfBirth").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(GelatoDataDocumentReportDateOfBirth { day, month, year });
            Ok(())
        }
    }
};

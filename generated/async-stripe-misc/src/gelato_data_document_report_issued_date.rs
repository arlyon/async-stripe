...
impl std::fmt::Debug for GelatoDataDocumentReportIssuedDate {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("GelatoDataDocumentReportIssuedDate").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(GelatoDataDocumentReportIssuedDate { day, month, year });
            Ok(())
        }
    }
};

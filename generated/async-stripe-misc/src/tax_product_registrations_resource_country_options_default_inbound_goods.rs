...
impl std::fmt::Debug for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods")
...
const _: () = {
    ...
    impl Deserialize for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods {
    ...
    struct Builder<'a> {
        out: &'a mut Option<TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods>,
        builder: TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsBuilder,
    }

    impl Visitor for Place<TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
            out: &mut self.out,
            builder: TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsBuilder::deser_default(),
        }))
        }
    }

    impl MapBuilder for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsBuilder {
    ...
    impl ObjectDeser for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoods {
        type Builder = TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsBuilder;
    }
...
impl std::fmt::Debug for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl serde::Serialize for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsType {
...
impl miniserde::Deserialize
    for TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsType
{
...
impl miniserde::de::Visitor
    for crate::Place<TaxProductRegistrationsResourceCountryOptionsDefaultInboundGoodsType>
{

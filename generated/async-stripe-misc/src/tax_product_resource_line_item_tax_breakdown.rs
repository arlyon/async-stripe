    ...
    impl Map for Builder<'_> {
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "sourcing" => Deserialize::begin(&mut self.builder.sourcing),
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(TaxProductResourceLineItemTaxBreakdown {
                amount,
                jurisdiction,
                sourcing,
                tax_rate_details,
...
impl stripe_miniserde::Deserialize for TaxProductResourceLineItemTaxBreakdownSourcing {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<TaxProductResourceLineItemTaxBreakdownSourcing> {
...
impl stripe_miniserde::Deserialize for TaxProductResourceLineItemTaxBreakdownTaxabilityReason {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

...
impl std::fmt::Debug for TaxProductResourceCustomerDetailsResourceTaxId {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("TaxProductResourceCustomerDetailsResourceTaxId").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
impl std::fmt::Debug for TaxProductResourceCustomerDetailsResourceTaxIdType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(TaxProductResourceCustomerDetailsResourceTaxIdType))

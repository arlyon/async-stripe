...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentDataCaptureMethod> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentDataCaptureMethod::from_str(s)?);
        Ok(())
    }
}
/// Indicates that you intend to make future payments with the payment method collected during checkout.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentDataSetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentDataSetupFutureUsage::from_str(s)?);
        Ok(())
    }
}

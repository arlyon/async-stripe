...
pub struct AfterCompletion {
    ...
    pub hosted_confirmation: Option<
        stripe_core::payment_link::after_completion::hosted_confirmation::HostedConfirmation,
    >,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub redirect: Option<stripe_core::payment_link::after_completion::redirect::Redirect>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for AfterCompletionType {
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<AfterCompletionType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(AfterCompletionType::from_str(s)?);
        Ok(())
    }
}

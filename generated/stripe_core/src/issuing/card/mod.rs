...
pub struct Card {
    ...
    pub cardholder: stripe_core::issuing::cardholder::Cardholder,
    ...
    pub id: stripe_core::issuing::card::IssuingCardId,
    ...
    pub replaced_by: Option<stripe_types::Expandable<stripe_core::issuing::card::Card>>,
    /// The card this card replaces, if any.
    pub replacement_for: Option<stripe_types::Expandable<stripe_core::issuing::card::Card>>,
    /// The reason why the previous card needed to be replaced.
    pub replacement_reason: Option<CardReplacementReason>,
    /// Where and how the card will be shipped.
    pub shipping: Option<stripe_core::issuing::card::shipping::Shipping>,
    pub spending_controls: stripe_core::issuing::card::spending_controls::SpendingControls,
    ...
    pub wallets: Option<stripe_core::issuing::card::wallets::Wallets>,
}
#[cfg(feature = "min-ser")]
...
impl stripe_types::Object for Card {
    type Id = stripe_core::issuing::card::IssuingCardId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

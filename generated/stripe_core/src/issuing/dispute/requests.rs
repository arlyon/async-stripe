...
pub fn list(client:&stripe::Client,params:ListDispute) -> stripe::Response<stripe_types::List<stripe_types::issuing::dispute::Dispute>> {
...
pub fn create(client:&stripe::Client,params:CreateDispute) -> stripe::Response<stripe_types::issuing::dispute::Dispute> {
...
pub fn update(client:&stripe::Client,dispute:&stripe_types::dispute::DisputeId,params:UpdateDispute) -> stripe::Response<stripe_types::issuing::dispute::Dispute> {
    client.send_form(&format!("/issuing/disputes/{dispute}", dispute=dispute), params, http_types::Method::Post)
}
        /// Retrieves an Issuing `Dispute` object.
pub fn retrieve(client:&stripe::Client,dispute:&stripe_types::dispute::DisputeId,params:RetrieveDispute) -> stripe::Response<stripe_types::issuing::dispute::Dispute> {
...
pub fn submit(client:&stripe::Client,dispute:&stripe_types::dispute::DisputeId,params:SubmitDispute) -> stripe::Response<stripe_types::issuing::dispute::Dispute> {

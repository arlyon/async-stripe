...
pub canceled: Option<stripe_core::issuing::dispute::evidence::canceled::Canceled>,
#[serde(skip_serializing_if = "Option::is_none")]
pub duplicate: Option<stripe_core::issuing::dispute::evidence::duplicate::Duplicate>,
#[serde(skip_serializing_if = "Option::is_none")]
pub fraudulent: Option<stripe_core::issuing::dispute::evidence::fraudulent::Fraudulent>,
#[serde(skip_serializing_if = "Option::is_none")]
pub merchandise_not_as_described: Option<stripe_core::issuing::dispute::evidence::merchandise_not_as_described::MerchandiseNotAsDescribed>,
#[serde(skip_serializing_if = "Option::is_none")]
pub not_received: Option<stripe_core::issuing::dispute::evidence::not_received::NotReceived>,
#[serde(skip_serializing_if = "Option::is_none")]
pub other: Option<stripe_core::issuing::dispute::evidence::other::Other>,
    /// The reason for filing the dispute.
    ///
    /// Its value will match the field containing the evidence.
pub reason: EvidenceReason,
#[serde(skip_serializing_if = "Option::is_none")]
pub service_not_as_described: Option<stripe_core::issuing::dispute::evidence::service_not_as_described::ServiceNotAsDescribed>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<EvidenceReason> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(EvidenceReason::from_str(s)?);
        Ok(())
    }
}
pub mod canceled;

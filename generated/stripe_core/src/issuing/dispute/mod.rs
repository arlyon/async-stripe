...
pub struct Dispute {
    ...
    pub balance_transactions: Option<Vec<stripe_core::balance_transaction::BalanceTransaction>>,
    ...
    pub evidence: stripe_core::issuing::dispute::evidence::Evidence,
    /// Unique identifier for the object.
    pub id: stripe_core::issuing::dispute::IssuingDisputeId,
    ...
    pub transaction: stripe_types::Expandable<stripe_core::issuing::transaction::Transaction>,
    /// [Treasury](https://stripe.com/docs/api/treasury) details related to this dispute if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub treasury: Option<stripe_core::issuing::dispute::treasury::Treasury>,
}
#[cfg(feature = "min-ser")]
...
impl stripe_types::Object for Dispute {
    type Id = stripe_core::issuing::dispute::IssuingDisputeId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

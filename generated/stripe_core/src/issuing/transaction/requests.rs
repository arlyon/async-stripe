...
pub fn list(client:&stripe::Client,params:ListTransaction) -> stripe::Response<stripe_types::List<stripe_types::issuing::transaction::Transaction>> {
    client.get_query("/issuing/transactions", params)
}
        /// Retrieves an Issuing `Transaction` object.
pub fn retrieve(client:&stripe::Client,transaction:&stripe_types::issuing::transaction::IssuingTransactionId,params:RetrieveTransaction) -> stripe::Response<stripe_types::issuing::transaction::Transaction> {
...
pub fn update(client:&stripe::Client,transaction:&stripe_types::issuing::transaction::IssuingTransactionId,params:UpdateTransaction) -> stripe::Response<stripe_types::issuing::transaction::Transaction> {

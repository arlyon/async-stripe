...
pub struct Cardholder {
    pub billing: stripe_core::issuing::cardholder::billing::Billing,
    /// Additional information about a `company` cardholder.
    pub company: Option<stripe_core::issuing::cardholder::company::Company>,
    ...
    pub id: stripe_core::issuing::cardholder::IssuingCardholderId,
    /// Additional information about an `individual` cardholder.
    pub individual: Option<stripe_core::issuing::cardholder::individual::Individual>,
    ...
    pub requirements: stripe_core::issuing::cardholder::requirements::Requirements,
    ...
    pub spending_controls:
        Option<stripe_core::issuing::cardholder::spending_controls::SpendingControls>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CardholderObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CardholderObject::from_str(s)?);
        Ok(())
    }
}
/// Specifies whether to permit authorizations on this cardholder's cards.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CardholderStatus> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CardholderStatus::from_str(s)?);
        Ok(())
    }
}
/// One of `individual` or `company`.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CardholderType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CardholderType::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for Cardholder {
    type Id = stripe_core::issuing::cardholder::IssuingCardholderId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

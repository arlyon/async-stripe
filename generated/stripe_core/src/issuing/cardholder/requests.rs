...
impl<'a> CreateCardholder<'a> {
    ...
    Self {
        billing,company: Default::default(),email: Default::default(),expand: Default::default(),individual: Default::default(),metadata: Default::default(),name,phone_number: Default::default(),spending_controls: Default::default(),status: Default::default(),type_: Default::default(),
    }
} 

...
pub struct SpendingControls {
    ...
    pub spending_limits: Option<
        Vec<stripe_core::issuing::cardholder::spending_controls::spending_limit::SpendingLimit>,
    >,
...
impl std::str::FromStr for SpendingControlsAllowedCategories {
    type Err = ();
...
impl serde::Serialize for SpendingControlsAllowedCategories {
...
impl<'de> serde::Deserialize<'de> for SpendingControlsAllowedCategories {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: String = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(&s).map_err(|_| {
            serde::de::Error::custom("Unknown value for SpendingControlsAllowedCategories")
        })
    }
}
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<SpendingControlsAllowedCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(SpendingControlsAllowedCategories::from_str(s)?);
        Ok(())
    }
}
/// Array of strings containing [categories](https://stripe.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to decline.
...
impl std::str::FromStr for SpendingControlsBlockedCategories {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "ac_refrigeration_repair" => Ok(Self::AcRefrigerationRepair),
...
impl serde::Serialize for SpendingControlsBlockedCategories {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> serde::Deserialize<'de> for SpendingControlsBlockedCategories {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: String = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(&s).map_err(|_| {
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<SpendingControlsBlockedCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(SpendingControlsBlockedCategories::from_str(s)?);
        Ok(())
    }
}

...
pub struct CreditNoteLineItem {
    ...
    pub id: stripe_core::credit_note_line_item::CreditNoteLineItemId,
    ...
    pub tax_rates: Vec<stripe_core::tax_rate::TaxRate>,
...
impl stripe_types::Object for CreditNoteLineItem {
    type Id = stripe_core::credit_note_line_item::CreditNoteLineItemId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

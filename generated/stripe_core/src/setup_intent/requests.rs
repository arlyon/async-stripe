impl stripe_core::setup_intent::SetupIntent {
    ...
    ) -> stripe::Response<stripe_core::setup_intent::SetupIntent> {
    ...
    ) -> stripe::Response<stripe_types::List<stripe_core::setup_intent::SetupIntent>> {

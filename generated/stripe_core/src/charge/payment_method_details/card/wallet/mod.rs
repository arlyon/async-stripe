...
pub amex_express_checkout: Option<stripe_core::charge::payment_method_details::card::wallet::amex_express_checkout::AmexExpressCheckout>,
#[serde(skip_serializing_if = "Option::is_none")]
pub apple_pay: Option<stripe_core::charge::payment_method_details::card::wallet::apple_pay::ApplePay>,
    /// (For tokenized numbers only.) The last four digits of the device account number.
pub dynamic_last4: Option<String>,
#[serde(skip_serializing_if = "Option::is_none")]
pub google_pay: Option<stripe_core::charge::payment_method_details::card::wallet::google_pay::GooglePay>,
#[serde(skip_serializing_if = "Option::is_none")]
pub masterpass: Option<stripe_core::charge::payment_method_details::card::wallet::masterpass::Masterpass>,
#[serde(skip_serializing_if = "Option::is_none")]
pub samsung_pay: Option<stripe_core::charge::payment_method_details::card::wallet::samsung_pay::SamsungPay>,
...
#[serde(skip_serializing_if = "Option::is_none")]
pub visa_checkout: Option<stripe_core::charge::payment_method_details::card::wallet::visa_checkout::VisaCheckout>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for WalletType {
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<WalletType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(WalletType::from_str(s)?);
        Ok(())
    }
}

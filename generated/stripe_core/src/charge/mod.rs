...
pub struct Charge {
    ...
    pub alternate_statement_descriptors:
        Option<stripe_core::charge::alternate_statement_descriptors::AlternateStatementDescriptors>,
    ...
    pub application_fee:
        Option<stripe_types::Expandable<stripe_core::application_fee::ApplicationFee>>,
    ...
    pub dispute: Option<stripe_types::Expandable<stripe_core::dispute::Dispute>>,
    ...
    pub fraud_details: Option<stripe_core::charge::fraud_details::FraudDetails>,
    /// Unique identifier for the object.
    pub id: stripe_core::charge::ChargeId,
    /// ID of the invoice this charge is for if one exists.
    pub invoice: Option<stripe_types::Expandable<stripe_core::invoice::Invoice>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub level3: Option<stripe_core::charge::level3::Level3>,
    ...
    pub outcome: Option<stripe_core::charge::outcome::Outcome>,
    ...
    pub payment_method_details:
        Option<stripe_core::charge::payment_method_details::PaymentMethodDetails>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default)]
    pub refunds: stripe_types::List<Option<stripe_core::refund::Refund>>,
    ...
    pub source_transfer: Option<stripe_types::Expandable<stripe_core::transfer::Transfer>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub transfer: Option<stripe_types::Expandable<stripe_core::transfer::Transfer>>,
    /// An optional dictionary including the account to automatically transfer to as part of a destination charge.
    ///
    /// [See the Connect documentation](https://stripe.com/docs/connect/destination-charges) for details.
    pub transfer_data: Option<stripe_core::charge::transfer_data::TransferData>,
...
impl stripe_types::Object for Charge {
    type Id = stripe_core::charge::ChargeId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

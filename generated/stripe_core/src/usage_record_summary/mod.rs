...
pub struct UsageRecordSummary {
    ...
    pub id: stripe_core::usage_record_summary::UsageRecordSummaryId,
    ...
    pub period: stripe_core::usage_record_summary::period::Period,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<UsageRecordSummaryObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(UsageRecordSummaryObject::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for UsageRecordSummary {
    type Id = stripe_core::usage_record_summary::UsageRecordSummaryId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

...
pub struct UsageRecord {
    ...
    pub id: stripe_core::usage_record::UsageRecordId,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<UsageRecordObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(UsageRecordObject::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for UsageRecord {
    type Id = stripe_core::usage_record::UsageRecordId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

...
impl stripe_core::account::Account {
    ...
    ) -> Response<stripe_core::account::Account> {
    ...
    pub fn list(
        client: &Client,
        params: ListAccount,
    ) -> Response<stripe_types::List<stripe_core::account::Account>> {
    ...
    pub fn delete(
        client: &Client,
        account: &stripe_types::AccountId,
    ) -> Response<stripe_core::account::DeletedAccount> {
    ...
    ) -> Response<stripe_types::List<stripe_core::capability::Capability>> {

...
pub struct Account {
    ...
    pub business_profile: Option<stripe_core::account::business_profile::BusinessProfile>,
    /// The business type.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub business_type: Option<AccountBusinessType>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capabilities: Option<stripe_core::account::capabilities::Capabilities>,
    /// Whether the account can create live charges.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub charges_enabled: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub company: Option<stripe_core::account::company::Company>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub controller: Option<stripe_core::account::controller::Controller>,
    ...
    pub external_accounts:
        stripe_types::List<Option<stripe_core::external_account::ExternalAccount>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub future_requirements: Option<stripe_core::account::future_requirements::FutureRequirements>,
    /// Unique identifier for the object.
    pub id: stripe_types::AccountId,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub individual: Option<stripe_core::person::Person>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requirements: Option<stripe_core::account::requirements::Requirements>,
    /// Options for customizing how the account functions within Stripe.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub settings: Option<stripe_core::account::settings::Settings>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tos_acceptance: Option<stripe_core::account::tos_acceptance::TosAcceptance>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<AccountBusinessType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(AccountBusinessType::from_str(s)?);
        Ok(())
    }
}
/// String representing the object's type.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<AccountType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(AccountType::from_str(s)?);
        Ok(())
    }
}

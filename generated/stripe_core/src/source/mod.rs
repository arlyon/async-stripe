...
pub struct Source {
    ...
    pub ach_credit_transfer: Option<stripe_core::source::ach_credit_transfer::AchCreditTransfer>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ach_debit: Option<stripe_core::source::ach_debit::AchDebit>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub acss_debit: Option<stripe_core::source::acss_debit::AcssDebit>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alipay: Option<stripe_core::source::alipay::Alipay>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub au_becs_debit: Option<stripe_core::source::au_becs_debit::AuBecsDebit>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bancontact: Option<stripe_core::source::bancontact::Bancontact>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub card: Option<stripe_core::source::card::Card>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub card_present: Option<stripe_core::source::card_present::CardPresent>,
    ...
    pub code_verification:
        Option<stripe_core::source::code_verification_flow::CodeVerificationFlow>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub eps: Option<stripe_core::source::eps::Eps>,
    /// The authentication `flow` of the source.
    ///
    /// `flow` is one of `redirect`, `receiver`, `code_verification`, `none`.
    pub flow: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub giropay: Option<stripe_core::source::giropay::Giropay>,
    /// Unique identifier for the object.
    pub id: stripe_core::source::SourceId,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ideal: Option<stripe_core::source::ideal::Ideal>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub klarna: Option<stripe_core::source::klarna::Klarna>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub multibanco: Option<stripe_core::source::multibanco::Multibanco>,
    /// String representing the object's type.
    ///
    /// Objects of the same type share the same value.
    pub object: SourceObject,
    /// Information about the owner of the payment instrument that may be used or required by particular source types.
    pub owner: Option<stripe_core::source::owner::Owner>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub p24: Option<stripe_core::source::p24::P24>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub receiver: Option<stripe_core::source::receiver_flow::ReceiverFlow>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub redirect: Option<stripe_core::source::redirect_flow::RedirectFlow>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sepa_credit_transfer: Option<stripe_core::source::sepa_credit_transfer::SepaCreditTransfer>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sepa_debit: Option<stripe_core::source::sepa_debit::SepaDebit>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sofort: Option<stripe_core::source::sofort::Sofort>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source_order: Option<stripe_core::source::order::Order>,
    ...
    pub status: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub three_d_secure: Option<stripe_core::source::three_d_secure::ThreeDSecure>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub wechat: Option<stripe_core::source::wechat::Wechat>,
}
#[cfg(feature = "min-ser")]
...
impl stripe_types::Object for Source {
    type Id = stripe_core::source::SourceId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

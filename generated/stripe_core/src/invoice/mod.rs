...
pub struct Invoice {
    ...
    pub account_tax_ids: Option<Vec<stripe_types::Expandable<stripe_core::tax_id::TaxId>>>,
    ...
    pub automatic_tax: stripe_core::invoice::automatic_tax::AutomaticTax,
    ...
    pub custom_fields: Option<Vec<stripe_core::invoice::custom_field::CustomField>>,
    ...
    /// Once the invoice is finalized, this field will no longer be updated.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub customer_tax_ids: Option<Vec<stripe_core::invoice::customer_tax_id::CustomerTaxId>>,
    ...
    pub default_tax_rates: Vec<stripe_core::tax_rate::TaxRate>,
    ...
    pub from_invoice: Option<stripe_core::invoice::from_invoice::FromInvoice>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<stripe_core::invoice::InvoiceId>,
    ...
    pub last_finalization_error: Option<Box<stripe_core::api_errors::ApiErrors>>,
    /// The ID of the most recent non-draft revision of this invoice.
    pub latest_revision: Option<stripe_types::Expandable<stripe_core::invoice::Invoice>>,
    /// The individual line items that make up the invoice.
    ///
    /// `lines` is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
    pub lines: stripe_types::List<stripe_core::invoice_line_item::InvoiceLineItem>,
    ...
    pub payment_settings: stripe_core::invoice::payment_settings::PaymentSettings,
    ...
    pub quote: Option<stripe_types::Expandable<stripe_core::quote::Quote>>,
    /// This is the transaction number that appears on email receipts sent for this invoice.
    pub receipt_number: Option<String>,
    /// Options for invoice PDF rendering.
    pub rendering_options: Option<stripe_core::invoice::rendering_options::RenderingOptions>,
    ...
    pub status_transitions: stripe_core::invoice::status_transitions::StatusTransitions,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub threshold_reason: Option<stripe_core::invoice::threshold_reason::ThresholdReason>,
    /// Total after discounts and taxes.
    pub total: i64,
    /// The aggregate amounts calculated per discount across all line items.
    pub total_discount_amounts: Option<Vec<stripe_core::discount_amount::DiscountAmount>>,
    ...
    pub total_tax_amounts: Vec<stripe_core::invoice::tax_amount::TaxAmount>,
    /// The account (if any) the payment will be attributed to for tax reporting, and where funds from the payment will be transferred to for the invoice.
    pub transfer_data: Option<stripe_core::invoice::transfer_data::TransferData>,
...
impl stripe_types::Object for Invoice {
    type Id = Option<stripe_core::invoice::InvoiceId>;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

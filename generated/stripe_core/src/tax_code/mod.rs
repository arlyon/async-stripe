...
pub struct TaxCode {
    ...
    pub id: stripe_core::tax_code::TaxCodeId,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<TaxCodeObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(TaxCodeObject::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for TaxCode {
    type Id = stripe_core::tax_code::TaxCodeId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

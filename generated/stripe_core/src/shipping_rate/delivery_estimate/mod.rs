...
pub maximum: Option<stripe_core::shipping_rate::delivery_estimate::delivery_estimate_bound::DeliveryEstimateBound>,
    /// The lower bound of the estimated range.
    ///
    /// If empty, represents no lower bound.
pub minimum: Option<stripe_core::shipping_rate::delivery_estimate::delivery_estimate_bound::DeliveryEstimateBound>,

...
pub fn retrieve(client:&stripe::Client,test_clock:&stripe_types::test_helpers::test_clock::TestHelpersTestClockId,params:RetrieveTestClock) -> stripe::Response<stripe_types::test_helpers::test_clock::TestClock> {
    client.get_query(&format!("/test_helpers/test_clocks/{test_clock}", test_clock=test_clock), params)
}
        /// Creates a new test clock that can be attached to new customers and quotes.
pub fn create(client:&stripe::Client,params:CreateTestClock) -> stripe::Response<stripe_types::test_helpers::test_clock::TestClock> {
    client.send_form("/test_helpers/test_clocks", params, http_types::Method::Post)
}
        /// Deletes a test clock.
pub fn delete(client:&stripe::Client,test_clock:&stripe_types::test_helpers::test_clock::TestHelpersTestClockId) -> stripe::Response<stripe_types::test_helpers::test_clock::DeletedTestClock> {
...
pub fn advance(client:&stripe::Client,test_clock:&stripe_types::test_helpers::test_clock::TestHelpersTestClockId,params:AdvanceTestClock) -> stripe::Response<stripe_types::test_helpers::test_clock::TestClock> {
...
pub fn list(client:&stripe::Client,params:ListTestClock) -> stripe::Response<stripe_types::List<stripe_types::test_helpers::test_clock::TestClock>> {
...
impl<'a> CreateTestClock<'a> {
    ...
    Self {
        expand: Default::default(),frozen_time,name: Default::default(),
    }
} 
...
impl<'a> AdvanceTestClock<'a> {
    pub fn new(frozen_time: stripe_types::Timestamp,) -> Self {
    Self {
        expand: Default::default(),frozen_time,
    }
} 

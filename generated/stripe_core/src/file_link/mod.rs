...
pub struct FileLink {
    ...
    pub file: stripe_types::Expandable<stripe_core::file::File>,
    /// Unique identifier for the object.
    pub id: stripe_core::file_link::FileLinkId,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<FileLinkObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(FileLinkObject::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for FileLink {
    type Id = stripe_core::file_link::FileLinkId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

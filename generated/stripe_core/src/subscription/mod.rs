...
pub struct Subscription {
    ...
    pub automatic_tax: stripe_core::subscription::automatic_tax::AutomaticTax,
    ...
    pub id: stripe_core::subscription::SubscriptionId,
    /// List of subscription items, each with an attached price.
    pub items: stripe_types::List<stripe_core::subscription_item::SubscriptionItem>,
    /// The most recent invoice this subscription has generated.
    pub latest_invoice: Option<stripe_types::Expandable<stripe_core::invoice::Invoice>>,
    ...
    pub pause_collection: Option<stripe_core::subscription::pause_collection::PauseCollection>,
    /// Payment settings passed on to invoices created by the subscription.
    pub payment_settings: Option<stripe_core::subscription::payment_settings::PaymentSettings>,
    ...
    pub pending_invoice_item_interval: Option<
        stripe_core::subscription::pending_invoice_item_interval::PendingInvoiceItemInterval,
    >,
    ...
    pub pending_setup_intent:
        Option<stripe_types::Expandable<stripe_core::setup_intent::SetupIntent>>,
    /// If specified, [pending updates](https://stripe.com/docs/billing/subscriptions/pending-updates) that will be applied to the subscription once the `latest_invoice` has been paid.
    pub pending_update: Option<stripe_core::subscription::pending_update::PendingUpdate>,
...
impl stripe_types::Object for Subscription {
    type Id = stripe_core::subscription::SubscriptionId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

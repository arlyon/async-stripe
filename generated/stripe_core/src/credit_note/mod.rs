...
pub struct CreditNote {
    ...
    pub customer_balance_transaction: Option<
        stripe_types::Expandable<
            stripe_core::customer_balance_transaction::CustomerBalanceTransaction,
        >,
    >,
    /// The integer amount in %s representing the total amount of discount that was credited.
    pub discount_amount: i64,
    /// The aggregate amounts calculated per discount for all line items.
    pub discount_amounts: Vec<stripe_core::discount_amount::DiscountAmount>,
    /// Unique identifier for the object.
    pub id: stripe_core::credit_note::CreditNoteId,
    /// ID of the invoice.
    pub invoice: stripe_types::Expandable<stripe_core::invoice::Invoice>,
    /// Line items that make up the credit note.
    pub lines: stripe_types::List<stripe_core::credit_note_line_item::CreditNoteLineItem>,
    ...
    pub refund: Option<stripe_types::Expandable<stripe_core::refund::Refund>>,
    ...
    pub tax_amounts: Vec<stripe_core::credit_note::tax_amount::TaxAmount>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CreditNoteObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CreditNoteObject::from_str(s)?);
        Ok(())
    }
}
/// Reason for issuing this credit note, one of `duplicate`, `fraudulent`, `order_change`, or `product_unsatisfactory`.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CreditNoteReason> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CreditNoteReason::from_str(s)?);
        Ok(())
    }
}
/// Status of this credit note, one of `issued` or `void`.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CreditNoteStatus> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CreditNoteStatus::from_str(s)?);
        Ok(())
    }
}
/// Type of this credit note, one of `pre_payment` or `post_payment`.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CreditNoteType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CreditNoteType::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for CreditNote {
    type Id = stripe_core::credit_note::CreditNoteId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

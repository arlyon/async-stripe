...
pub struct Dispute {
    ...
    pub evidence: stripe_core::dispute::evidence::Evidence,
    pub evidence_details: stripe_core::dispute::evidence_details::EvidenceDetails,
    /// Unique identifier for the object.
    pub id: stripe_core::dispute::DisputeId,
...
impl stripe_types::Object for Dispute {
    type Id = stripe_core::dispute::DisputeId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

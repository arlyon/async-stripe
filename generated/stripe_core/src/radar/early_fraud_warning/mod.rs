...
pub struct EarlyFraudWarning {
    ...
    pub id: stripe_core::radar::early_fraud_warning::RadarEarlyFraudWarningId,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<EarlyFraudWarningObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(EarlyFraudWarningObject::from_str(s)?);
        Ok(())
    }
}
impl stripe_types::Object for EarlyFraudWarning {
    type Id = stripe_core::radar::early_fraud_warning::RadarEarlyFraudWarningId;
    fn id(&self) -> Self::Id {
        self.id.clone()
    }
}

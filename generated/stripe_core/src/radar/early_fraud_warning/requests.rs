...
pub fn list(client:&stripe::Client,params:ListEarlyFraudWarning) -> stripe::Response<stripe_types::List<stripe_types::radar::early_fraud_warning::EarlyFraudWarning>> {
...
pub fn retrieve(client:&stripe::Client,early_fraud_warning:&stripe_types::radar::early_fraud_warning::RadarEarlyFraudWarningId,params:RetrieveEarlyFraudWarning) -> stripe::Response<stripe_types::radar::early_fraud_warning::EarlyFraudWarning> {

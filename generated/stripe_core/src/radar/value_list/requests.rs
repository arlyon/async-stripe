...
pub fn list(client:&stripe::Client,params:ListValueList) -> stripe::Response<stripe_types::List<stripe_types::radar::value_list::ValueList>> {
    client.get_query("/radar/value_lists", params)
}
        /// Retrieves a `ValueList` object.
pub fn retrieve(client:&stripe::Client,value_list:&stripe_types::radar::value_list::RadarValueListId,params:RetrieveValueList) -> stripe::Response<stripe_types::radar::value_list::ValueList> {
    client.get_query(&format!("/radar/value_lists/{value_list}", value_list=value_list), params)
}
        /// Creates a new `ValueList` object, which can then be referenced in rules.
pub fn create(client:&stripe::Client,params:CreateValueList) -> stripe::Response<stripe_types::radar::value_list::ValueList> {
...
pub fn update(client:&stripe::Client,value_list:&stripe_types::radar::value_list::RadarValueListId,params:UpdateValueList) -> stripe::Response<stripe_types::radar::value_list::ValueList> {
...
pub fn delete(client:&stripe::Client,value_list:&stripe_types::radar::value_list::RadarValueListId) -> stripe::Response<stripe_types::radar::value_list::DeletedValueList> {
...
impl<'a> CreateValueList<'a> {
    ...
    Self {
        alias,expand: Default::default(),item_type: Default::default(),metadata: Default::default(),name,
    }
} 

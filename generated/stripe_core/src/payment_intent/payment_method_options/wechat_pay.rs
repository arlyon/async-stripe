...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<WechatPayClient> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(WechatPayClient::from_str(s)?);
        Ok(())
    }
}
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<WechatPaySetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(WechatPaySetupFutureUsage::from_str(s)?);
        Ok(())
    }
}

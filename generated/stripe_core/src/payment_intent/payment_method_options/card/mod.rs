...
pub struct Card {
    ...
    pub installments: Option<
        stripe_core::payment_intent::payment_method_options::card::installments::Installments,
    >,
    /// Configuration options for setting up an eMandate for cards issued in India.
    pub mandate_options: Option<
        stripe_core::payment_intent::payment_method_options::card::mandate_options::MandateOptions,
    >,
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for CardCaptureMethod {
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CardCaptureMethod> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CardCaptureMethod::from_str(s)?);
        Ok(())
    }
}
/// Selected network to process this payment intent on.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<CardSetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(CardSetupFutureUsage::from_str(s)?);
        Ok(())
    }
}

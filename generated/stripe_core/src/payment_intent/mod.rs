...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentCancellationReason> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentCancellationReason::from_str(s)?);
        Ok(())
    }
}
/// Controls when the funds will be captured from the customer's account.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentCaptureMethod> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentCaptureMethod::from_str(s)?);
        Ok(())
    }
}
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentConfirmationMethod> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentConfirmationMethod::from_str(s)?);
        Ok(())
    }
}
/// String representing the object's type.
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for PaymentIntentObject {
    fn begin(out: &mut Option<Self>) -> &mut dyn miniserde::Visitor {
        Place::new(out)
    }
}
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentObject::from_str(s)?);
        Ok(())
    }
}
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentSetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentSetupFutureUsage::from_str(s)?);
        Ok(())
    }
}
/// Status of this PaymentIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `requires_capture`, `canceled`, or `succeeded`.
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<PaymentIntentStatus> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentStatus::from_str(s)?);
        Ok(())
    }
}

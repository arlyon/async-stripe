...
pub struct Processing {
    ...
    pub card: Option<stripe_core::payment_intent::processing::card::Card>,
...
#[cfg(feature = "min-ser")]
impl miniserde::Visitor for crate::Place<ProcessingType> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(ProcessingType::from_str(s)?);
        Ok(())
    }
}
pub mod card;

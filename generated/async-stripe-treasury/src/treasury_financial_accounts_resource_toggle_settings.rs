...
impl std::fmt::Debug for TreasuryFinancialAccountsResourceToggleSettings {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("TreasuryFinancialAccountsResourceToggleSettings").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(TreasuryFinancialAccountsResourceToggleSettings {
                requested,
                status,
                status_details,
            });
...
impl std::fmt::Debug for TreasuryFinancialAccountsResourceToggleSettingsStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(TreasuryFinancialAccountsResourceToggleSettingsStatus))
...
impl stripe_miniserde::Deserialize for TreasuryFinancialAccountsResourceToggleSettingsStatus {
    ...
    for crate::Place<TreasuryFinancialAccountsResourceToggleSettingsStatus>
{
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            TreasuryFinancialAccountsResourceToggleSettingsStatus::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

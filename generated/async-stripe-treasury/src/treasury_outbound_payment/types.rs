...
pub struct TreasuryOutboundPayment {
    ...
    pub tracking_details: Option<
        stripe_treasury::TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails,
    >,
    /// The Transaction associated with this object.
    pub transaction: stripe_types::Expandable<stripe_treasury::TreasuryTransaction>,
}
#[cfg(feature = "redact-generated-debug")]
impl std::fmt::Debug for TreasuryOutboundPayment {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("TreasuryOutboundPayment").finish_non_exhaustive()
    }
}
#[doc(hidden)]
    ...
    impl MapBuilder for TreasuryOutboundPaymentBuilder {
        ...
        fn deser_default() -> Self {
            Self {
                ...
                destination_payment_method: Some(None),
                destination_payment_method_details: Some(None),
                end_user_details: Some(None),
                ...
                livemode: None,
                metadata: None,
                returned_details: Some(None),
                statement_descriptor: None,
                status: None,
                status_transitions: None,
                tracking_details: Some(None),
                transaction: None,
            }
        }
...
impl serde::Serialize for TreasuryOutboundPayment {
    fn serialize<S: serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        let mut s = s.serialize_struct("TreasuryOutboundPayment", 22)?;
...
impl std::fmt::Debug for TreasuryOutboundPaymentStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(TreasuryOutboundPaymentStatus)).finish_non_exhaustive()
    }
}

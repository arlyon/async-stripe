...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(OutboundPaymentsPaymentMethodDetailsUsBankAccount {
                account_holder_type,
                account_type,
                bank_name,
                fingerprint,
...
impl stripe_miniserde::Deserialize for OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountHolderType {
...
impl stripe_miniserde::Deserialize for OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountType {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}
...
impl stripe_miniserde::Deserialize for OutboundPaymentsPaymentMethodDetailsUsBankAccountNetwork {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

...
impl std::fmt::Debug for TreasuryOutboundTransfersResourceReturnedDetails {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("TreasuryOutboundTransfersResourceReturnedDetails").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out =
                Some(TreasuryOutboundTransfersResourceReturnedDetails { code, transaction });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for TreasuryOutboundTransfersResourceReturnedDetailsCode {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(TreasuryOutboundTransfersResourceReturnedDetailsCode))
...
impl stripe_miniserde::Deserialize for TreasuryOutboundTransfersResourceReturnedDetailsCode {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<TreasuryOutboundTransfersResourceReturnedDetailsCode> {

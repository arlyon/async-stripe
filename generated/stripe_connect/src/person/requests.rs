...
pub struct ListAccountPerson<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub relationship: Option<ListAccountPersonRelationship>,
    /// A cursor for use in pagination.
...
pub struct CreateAccountPerson<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address_kana: Option<CreateAccountPersonAddressKana<'a>>,
    /// The Kanji variation of the person's address (Japan only).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address_kanji: Option<CreateAccountPersonAddressKanji<'a>>,

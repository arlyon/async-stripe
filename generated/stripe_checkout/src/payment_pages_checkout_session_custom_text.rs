    ...
    impl MapBuilder for PaymentPagesCheckoutSessionCustomTextBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "terms_of_service_acceptance" => Deserialize::begin(&mut self.terms_of_service_acceptance),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "terms_of_service_acceptance" => b.terms_of_service_acceptance = Some(FromValueOpt::from_value(v)?),

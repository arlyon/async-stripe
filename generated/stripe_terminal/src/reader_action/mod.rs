...
pub struct ReaderAction {
    ...
    pub process_payment_intent:
        Option<stripe_terminal::process_payment_intent_action::ProcessPaymentIntentAction>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub process_setup_intent:
        Option<stripe_terminal::process_setup_intent_action::ProcessSetupIntentAction>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub refund_payment: Option<stripe_terminal::refund_payment_action::RefundPaymentAction>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub set_reader_display:
        Option<stripe_terminal::set_reader_display_action::SetReaderDisplayAction>,

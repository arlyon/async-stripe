...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for DeletedConfigurationObject {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<DeletedConfigurationObject> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(DeletedConfigurationObject::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}

...
pub fn update(
    ...
    reader: &stripe_terminal::terminal::reader::TerminalReaderId,
    params: UpdateReader,
...
impl SetReaderDisplayReaderType {
    pub fn as_str(self) -> &'static str {
        use SetReaderDisplayReaderType::*;
        match self {
            Cart => "cart",
        }
    }
...
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
pub struct RefundPaymentReader<'a> {
...
pub struct PresentPaymentMethodReader<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub interac_present: Option<PresentPaymentMethodReaderInteracPresent<'a>>,
...
/// Simulated data for the interac_present payment method.
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
pub struct PresentPaymentMethodReaderInteracPresent<'a> {
    /// Card Number.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub number: Option<&'a str>,
}
impl<'a> PresentPaymentMethodReaderInteracPresent<'a> {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl PresentPaymentMethodReaderType {
    pub fn as_str(self) -> &'static str {
        use PresentPaymentMethodReaderType::*;
        match self {

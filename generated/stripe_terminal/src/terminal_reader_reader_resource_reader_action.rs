        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "process_payment_intent" => b.process_payment_intent = Some(FromValueOpt::from_value(v)?),
                    "process_setup_intent" => b.process_setup_intent = Some(FromValueOpt::from_value(v)?),
                    "refund_payment" => b.refund_payment = Some(FromValueOpt::from_value(v)?),
                    "set_reader_display" => b.set_reader_display = Some(FromValueOpt::from_value(v)?),

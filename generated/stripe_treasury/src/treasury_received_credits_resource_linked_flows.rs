        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "issuing_authorization" => b.issuing_authorization = Some(FromValueOpt::from_value(v)?),
                    "issuing_transaction" => b.issuing_transaction = Some(FromValueOpt::from_value(v)?),
                    "source_flow" => b.source_flow = Some(FromValueOpt::from_value(v)?),
                    "source_flow_details" => b.source_flow_details = Some(FromValueOpt::from_value(v)?),

...
pub struct TreasuryTransactionsResourceTransactionEntry {
    ...
    pub object: TreasuryTransactionsResourceTransactionEntryObject,
...
/// Objects of the same type share the same value.
#[derive(Copy, Clone, Eq, PartialEq)]
pub enum TreasuryTransactionsResourceTransactionEntryObject {
    TreasuryTransactionEntry,
}

impl TreasuryTransactionsResourceTransactionEntryObject {
    pub fn as_str(self) -> &'static str {
        use TreasuryTransactionsResourceTransactionEntryObject::*;
        match self {
...
impl std::str::FromStr for TreasuryTransactionsResourceTransactionEntryObject {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use TreasuryTransactionsResourceTransactionEntryObject::*;
        match s {
...
impl AsRef<str> for TreasuryTransactionsResourceTransactionEntryObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for TreasuryTransactionsResourceTransactionEntryObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for TreasuryTransactionsResourceTransactionEntryObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for TreasuryTransactionsResourceTransactionEntryObject {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> serde::Deserialize<'de> for TreasuryTransactionsResourceTransactionEntryObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for TreasuryTransactionsResourceTransactionEntryObject"))
    }
}
/// The specific money movement that generated the TransactionEntry.
#[derive(Copy, Clone, Eq, PartialEq)]

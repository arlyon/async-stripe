...
const _: () = {
    ...
    impl FromValueOpt for TreasuryFinancialAccountsResourceClosedStatusDetails {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = TreasuryFinancialAccountsResourceClosedStatusDetailsBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
                    "reasons" => b.reasons = Some(FromValueOpt::from_value(v)?),
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TreasuryFinancialAccountsResourceClosedStatusDetailsReasons);

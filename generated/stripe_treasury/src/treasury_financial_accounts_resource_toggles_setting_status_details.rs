...
const _: () = {
    ...
    impl FromValueOpt for TreasuryFinancialAccountsResourceTogglesSettingStatusDetails {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = TreasuryFinancialAccountsResourceTogglesSettingStatusDetailsBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TreasuryFinancialAccountsResourceTogglesSettingStatusDetailsCode);
/// Represents what the user should do, if anything, to activate the Feature.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TreasuryFinancialAccountsResourceTogglesSettingStatusDetailsResolution);
/// The `platform_restrictions` that are restricting this Feature.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TreasuryFinancialAccountsResourceTogglesSettingStatusDetailsRestriction);

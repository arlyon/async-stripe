...
pub struct TreasuryReceivedDebitsResourceDebitReversal {
    ...
    pub object: TreasuryReceivedDebitsResourceDebitReversalObject,
...
/// Objects of the same type share the same value.
#[derive(Copy, Clone, Eq, PartialEq)]
pub enum TreasuryReceivedDebitsResourceDebitReversalObject {
    TreasuryDebitReversal,
}

impl TreasuryReceivedDebitsResourceDebitReversalObject {
    pub fn as_str(self) -> &'static str {
        use TreasuryReceivedDebitsResourceDebitReversalObject::*;
        match self {
...
impl std::str::FromStr for TreasuryReceivedDebitsResourceDebitReversalObject {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use TreasuryReceivedDebitsResourceDebitReversalObject::*;
        match s {
...
impl AsRef<str> for TreasuryReceivedDebitsResourceDebitReversalObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for TreasuryReceivedDebitsResourceDebitReversalObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for TreasuryReceivedDebitsResourceDebitReversalObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for TreasuryReceivedDebitsResourceDebitReversalObject {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> serde::Deserialize<'de> for TreasuryReceivedDebitsResourceDebitReversalObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for TreasuryReceivedDebitsResourceDebitReversalObject"))
    }
}
/// Status of the DebitReversal.
#[derive(Copy, Clone, Eq, PartialEq)]

...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountHolderType);
/// Account type: checkings or savings. Defaults to checking if omitted.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountType);
/// The US bank account network used to send funds.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(OutboundPaymentsPaymentMethodDetailsUsBankAccountNetwork);

...
pub struct TreasuryReceivedCreditsResourceReceivedCredit {
    ...
    pub object: TreasuryReceivedCreditsResourceReceivedCreditObject,
...
/// Objects of the same type share the same value.
#[derive(Copy, Clone, Eq, PartialEq)]
pub enum TreasuryReceivedCreditsResourceReceivedCreditObject {
    TreasuryReceivedCredit,
}

impl TreasuryReceivedCreditsResourceReceivedCreditObject {
    pub fn as_str(self) -> &'static str {
        use TreasuryReceivedCreditsResourceReceivedCreditObject::*;
        match self {
...
impl std::str::FromStr for TreasuryReceivedCreditsResourceReceivedCreditObject {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use TreasuryReceivedCreditsResourceReceivedCreditObject::*;
        match s {
...
impl AsRef<str> for TreasuryReceivedCreditsResourceReceivedCreditObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for TreasuryReceivedCreditsResourceReceivedCreditObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for TreasuryReceivedCreditsResourceReceivedCreditObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for TreasuryReceivedCreditsResourceReceivedCreditObject {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl<'de> serde::Deserialize<'de> for TreasuryReceivedCreditsResourceReceivedCreditObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for TreasuryReceivedCreditsResourceReceivedCreditObject"))
    }
}
/// Status of the ReceivedCredit.
///

...
pub struct TreasuryOutboundPaymentsResourceOutboundPayment {
    ...
    pub object: TreasuryOutboundPaymentsResourceOutboundPaymentObject,
...
pub enum TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    TreasuryOutboundPayment,
}

impl TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    pub fn as_str(self) -> &'static str {
        use TreasuryOutboundPaymentsResourceOutboundPaymentObject::*;
        match self {
...
impl std::str::FromStr for TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    type Err = ();
...
impl AsRef<str> for TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for TreasuryOutboundPaymentsResourceOutboundPaymentObject {
...
impl<'de> serde::Deserialize<'de> for TreasuryOutboundPaymentsResourceOutboundPaymentObject {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: &str = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(s).map_err(|_| serde::de::Error::custom("Unknown value for TreasuryOutboundPaymentsResourceOutboundPaymentObject"))
    }
}
/// Current status of the OutboundPayment: `processing`, `failed`, `posted`, `returned`, `canceled`.
///

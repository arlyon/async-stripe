...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(InboundTransfersPaymentMethodDetailsUsBankAccountAccountHolderType);
/// Account type: checkings or savings. Defaults to checking if omitted.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(InboundTransfersPaymentMethodDetailsUsBankAccountAccountType);
/// The US bank account network used to debit funds.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(InboundTransfersPaymentMethodDetailsUsBankAccountNetwork);

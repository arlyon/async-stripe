...
const _: () = {
    ...
    impl FromValueOpt for OutboundPaymentsPaymentMethodDetailsFinancialAccount {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = OutboundPaymentsPaymentMethodDetailsFinancialAccountBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(OutboundPaymentsPaymentMethodDetailsFinancialAccountNetwork);

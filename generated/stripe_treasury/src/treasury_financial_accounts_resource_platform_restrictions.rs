...
const _: () = {
    ...
    impl FromValueOpt for TreasuryFinancialAccountsResourcePlatformRestrictions {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = TreasuryFinancialAccountsResourcePlatformRestrictionsBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TreasuryFinancialAccountsResourcePlatformRestrictionsInboundFlows);
/// Restricts all outbound money movement.
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TreasuryFinancialAccountsResourcePlatformRestrictionsOutboundFlows);

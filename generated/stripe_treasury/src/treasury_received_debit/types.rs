    ...
    impl MapBuilder for TreasuryReceivedDebitBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "initiating_payment_method_details" => Deserialize::begin(&mut self.initiating_payment_method_details),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "initiating_payment_method_details" => b.initiating_payment_method_details = Some(FromValueOpt::from_value(v)?),

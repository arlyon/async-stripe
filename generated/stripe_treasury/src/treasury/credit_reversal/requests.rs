...
) -> stripe::Response<stripe_types::List<stripe_treasury::treasury::credit_reversal::CreditReversal>>
{
...
pub fn retrieve(
    client: &stripe::Client,
    credit_reversal: &stripe_treasury::treasury::credit_reversal::TreasuryCreditReversalId,

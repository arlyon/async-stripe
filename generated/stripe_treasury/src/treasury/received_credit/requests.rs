...
) -> stripe::Response<stripe_types::List<stripe_treasury::treasury::received_credit::ReceivedCredit>>
{
...
pub fn retrieve(
    client: &stripe::Client,
    id: &stripe_treasury::treasury::received_credit::TreasuryReceivedCreditId,
...
impl ListReceivedCreditLinkedFlowsSourceFlowType {
    pub fn as_str(self) -> &'static str {
        use ListReceivedCreditLinkedFlowsSourceFlowType::*;
        match self {
...
impl CreateReceivedCreditInitiatingPaymentMethodDetailsType {
    pub fn as_str(self) -> &'static str {
        use CreateReceivedCreditInitiatingPaymentMethodDetailsType::*;
        match self {
...
impl CreateReceivedCreditNetwork {
    pub fn as_str(self) -> &'static str {
        use CreateReceivedCreditNetwork::*;
        match self {
            Ach => "ach",

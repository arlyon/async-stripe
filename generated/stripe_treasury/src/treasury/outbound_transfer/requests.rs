...
pub fn retrieve(
    client: &stripe::Client,
    outbound_transfer: &stripe_treasury::treasury::outbound_transfer::TreasuryOutboundTransferId,
...
impl CreateOutboundTransferDestinationPaymentMethodOptionsUsBankAccountNetwork {
    pub fn as_str(self) -> &'static str {
        use CreateOutboundTransferDestinationPaymentMethodOptionsUsBankAccountNetwork::*;
        match self {
            Ach => "ach",
...
impl ListOutboundTransferStatus {
    pub fn as_str(self) -> &'static str {
        use ListOutboundTransferStatus::*;
        match self {
            Canceled => "canceled",
            Failed => "failed",
            Posted => "posted",
...
impl std::str::FromStr for ListOutboundTransferStatus {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use ListOutboundTransferStatus::*;
        match s {
...
impl serde::Serialize for ListOutboundTransferStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl ReturnOutboundTransferOutboundTransferReturnedDetailsCode {
    pub fn as_str(self) -> &'static str {
        use ReturnOutboundTransferOutboundTransferReturnedDetailsCode::*;
        match self {
...
impl std::str::FromStr for ReturnOutboundTransferOutboundTransferReturnedDetailsCode {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use ReturnOutboundTransferOutboundTransferReturnedDetailsCode::*;
        match s {
...
impl serde::Serialize for ReturnOutboundTransferOutboundTransferReturnedDetailsCode {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {

...
) -> stripe::Response<stripe_types::List<stripe_treasury::treasury::received_debit::ReceivedDebit>>
{
...
pub fn retrieve(
    client: &stripe::Client,
    id: &stripe_treasury::treasury::received_debit::TreasuryReceivedDebitId,
...
impl std::str::FromStr for ListReceivedDebitStatus {
    type Err = ();
...
impl serde::Serialize for ListReceivedDebitStatus {
...
impl CreateReceivedDebitInitiatingPaymentMethodDetailsType {
    pub fn as_str(self) -> &'static str {
        use CreateReceivedDebitInitiatingPaymentMethodDetailsType::*;
        match self {
...
impl std::str::FromStr for CreateReceivedDebitInitiatingPaymentMethodDetailsType {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use CreateReceivedDebitInitiatingPaymentMethodDetailsType::*;
        match s {
...
impl serde::Serialize for CreateReceivedDebitInitiatingPaymentMethodDetailsType {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl CreateReceivedDebitNetwork {
    pub fn as_str(self) -> &'static str {
        use CreateReceivedDebitNetwork::*;
        match self {
            Ach => "ach",
        }
    }
...
impl std::str::FromStr for CreateReceivedDebitNetwork {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use CreateReceivedDebitNetwork::*;
        match s {
...
impl serde::Serialize for CreateReceivedDebitNetwork {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {

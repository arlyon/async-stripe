...
pub fn retrieve(
    client: &stripe::Client,
    id: &stripe_treasury::treasury::outbound_payment::TreasuryOutboundPaymentId,
...
impl CreateOutboundPaymentDestinationPaymentMethodDataType {
    pub fn as_str(self) -> &'static str {
        use CreateOutboundPaymentDestinationPaymentMethodDataType::*;
        match self {
...
impl CreateOutboundPaymentDestinationPaymentMethodDataUsBankAccountAccountHolderType {
    pub fn as_str(self) -> &'static str {
        use CreateOutboundPaymentDestinationPaymentMethodDataUsBankAccountAccountHolderType::*;
        match self {
            Company => "company",
...
impl CreateOutboundPaymentDestinationPaymentMethodDataUsBankAccountAccountType {
    pub fn as_str(self) -> &'static str {
        use CreateOutboundPaymentDestinationPaymentMethodDataUsBankAccountAccountType::*;
        match self {
            Checking => "checking",
            Savings => "savings",
        }
...
impl CreateOutboundPaymentDestinationPaymentMethodOptionsUsBankAccountNetwork {
    pub fn as_str(self) -> &'static str {
        use CreateOutboundPaymentDestinationPaymentMethodOptionsUsBankAccountNetwork::*;
        match self {
            Ach => "ach",
...
impl ReturnOutboundPaymentOutboundPaymentReturnedDetailsCode {
    pub fn as_str(self) -> &'static str {
        use ReturnOutboundPaymentOutboundPaymentReturnedDetailsCode::*;
        match self {

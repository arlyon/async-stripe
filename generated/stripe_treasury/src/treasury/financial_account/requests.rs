...
pub fn update(
    client: &stripe::Client,
    financial_account: &stripe_treasury::treasury::financial_account::TreasuryFinancialAccountId,
...
) -> stripe::Response<stripe_treasury::treasury::financial_account_features::FinancialAccountFeatures>
{
    client.send_form(
        &format!(
...
impl CreateFinancialAccountPlatformRestrictionsInboundFlows {
    pub fn as_str(self) -> &'static str {
        use CreateFinancialAccountPlatformRestrictionsInboundFlows::*;
        match self {
...
impl CreateFinancialAccountPlatformRestrictionsOutboundFlows {
    pub fn as_str(self) -> &'static str {
        use CreateFinancialAccountPlatformRestrictionsOutboundFlows::*;
        match self {
            Restricted => "restricted",
            Unrestricted => "unrestricted",
        }
...
impl UpdateFinancialAccountPlatformRestrictionsInboundFlows {
    pub fn as_str(self) -> &'static str {
        use UpdateFinancialAccountPlatformRestrictionsInboundFlows::*;
        match self {
            Restricted => "restricted",
            Unrestricted => "unrestricted",
        }
...
impl UpdateFinancialAccountPlatformRestrictionsOutboundFlows {
    pub fn as_str(self) -> &'static str {
        use UpdateFinancialAccountPlatformRestrictionsOutboundFlows::*;
        match self {
            Restricted => "restricted",
            Unrestricted => "unrestricted",
        }

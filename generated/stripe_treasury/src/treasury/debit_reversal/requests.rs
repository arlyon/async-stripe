...
pub fn retrieve(
    client: &stripe::Client,
    debit_reversal: &stripe_treasury::treasury::debit_reversal::TreasuryDebitReversalId,
...
) -> stripe::Response<stripe_types::List<stripe_treasury::treasury::debit_reversal::DebitReversal>>
{
...
impl ListDebitReversalResolution {
    pub fn as_str(self) -> &'static str {
        use ListDebitReversalResolution::*;
        match self {
            Lost => "lost",
            Won => "won",
        }

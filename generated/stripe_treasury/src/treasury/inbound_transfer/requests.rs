...
pub fn cancel(
    ...
    inbound_transfer: &stripe_treasury::treasury::inbound_transfer::TreasuryInboundTransferId,
...
pub fn retrieve(
    client: &stripe::Client,
    id: &stripe_treasury::treasury::inbound_transfer::TreasuryInboundTransferId,
...
impl FailInboundTransferFailureDetailsCode {
    pub fn as_str(self) -> &'static str {
        use FailInboundTransferFailureDetailsCode::*;
        match self {

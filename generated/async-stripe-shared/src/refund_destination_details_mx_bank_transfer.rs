...
impl std::fmt::Debug for RefundDestinationDetailsMxBankTransfer {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("RefundDestinationDetailsMxBankTransfer").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out =
                Some(RefundDestinationDetailsMxBankTransfer { reference, reference_status });
            Ok(())
        }
    }
};

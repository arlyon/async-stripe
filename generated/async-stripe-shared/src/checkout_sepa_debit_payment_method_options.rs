...
pub struct CheckoutSepaDebitPaymentMethodOptions {
    pub mandate_options: Option<stripe_shared::CheckoutPaymentMethodOptionsMandateOptionsSepaDebit>,
...
impl std::fmt::Debug for CheckoutSepaDebitPaymentMethodOptions {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("CheckoutSepaDebitPaymentMethodOptions").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct CheckoutSepaDebitPaymentMethodOptionsBuilder {
    mandate_options:
        Option<Option<stripe_shared::CheckoutPaymentMethodOptionsMandateOptionsSepaDebit>>,
...
impl std::fmt::Debug for CheckoutSepaDebitPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CheckoutSepaDebitPaymentMethodOptionsSetupFutureUsage))

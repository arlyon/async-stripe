...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out =
                Some(CheckoutAuBecsDebitPaymentMethodOptions { setup_future_usage, target_date });
            Ok(())
        }
    }
};
...
impl stripe_miniserde::Deserialize for CheckoutAuBecsDebitPaymentMethodOptionsSetupFutureUsage {

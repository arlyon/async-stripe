...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(CheckoutP24PaymentMethodOptions { setup_future_usage });
            Ok(())
        }
    }
};
...
impl stripe_miniserde::Deserialize for CheckoutP24PaymentMethodOptionsSetupFutureUsage {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<CheckoutP24PaymentMethodOptionsSetupFutureUsage> {

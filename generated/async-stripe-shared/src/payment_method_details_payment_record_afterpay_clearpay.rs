...
impl std::fmt::Debug for PaymentMethodDetailsPaymentRecordAfterpayClearpay {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentMethodDetailsPaymentRecordAfterpayClearpay").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out =
                Some(PaymentMethodDetailsPaymentRecordAfterpayClearpay { order_id, reference });
            Ok(())
        }
    }
};

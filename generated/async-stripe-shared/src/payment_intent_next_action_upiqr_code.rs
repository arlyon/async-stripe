...
impl std::fmt::Debug for PaymentIntentNextActionUpiqrCode {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentNextActionUpiqrCode").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl MapBuilder for PaymentIntentNextActionUpiqrCodeBuilder {
        ...
        fn deser_default() -> Self {
            Self { expires_at: None, image_url_png: None, image_url_svg: None }
        }

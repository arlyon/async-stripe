...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsBlik {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentPaymentMethodOptionsBlik").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentIntentPaymentMethodOptionsBlik { setup_future_usage });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsBlikSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentIntentPaymentMethodOptionsBlikSetupFutureUsage))
...
impl stripe_miniserde::Deserialize for PaymentIntentPaymentMethodOptionsBlikSetupFutureUsage {
    ...
    for crate::Place<PaymentIntentPaymentMethodOptionsBlikSetupFutureUsage>
{
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            PaymentIntentPaymentMethodOptionsBlikSetupFutureUsage::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

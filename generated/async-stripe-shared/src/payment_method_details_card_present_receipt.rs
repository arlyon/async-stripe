...
impl std::fmt::Debug for PaymentMethodDetailsCardPresentReceipt {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentMethodDetailsCardPresentReceipt").finish_non_exhaustive()
    }
}
#[doc(hidden)]
    ...
    impl Map for Builder<'_> {
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "cardholder_verification_method" => {
                    Deserialize::begin(&mut self.builder.cardholder_verification_method)
                }
        ...
        fn finish(&mut self) -> Result<()> {
            let (
                ...
                self.builder.cardholder_verification_method.take(),
            ...
            *self.out = Some(PaymentMethodDetailsCardPresentReceipt {
                account_type,
                application_cryptogram,
                application_preferred_name,
                authorization_code,
...
impl std::fmt::Debug for PaymentMethodDetailsCardPresentReceiptAccountType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentMethodDetailsCardPresentReceiptAccountType))
...
impl stripe_miniserde::Deserialize for PaymentMethodDetailsCardPresentReceiptAccountType {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<PaymentMethodDetailsCardPresentReceiptAccountType> {

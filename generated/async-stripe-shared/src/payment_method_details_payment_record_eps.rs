...
pub struct PaymentMethodDetailsPaymentRecordEps {
    ...
    pub bank: Option<PaymentMethodDetailsPaymentRecordEpsBank>,
...
impl std::fmt::Debug for PaymentMethodDetailsPaymentRecordEps {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentMethodDetailsPaymentRecordEps").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct PaymentMethodDetailsPaymentRecordEpsBuilder {
    bank: Option<Option<PaymentMethodDetailsPaymentRecordEpsBank>>,
...
const _: () = {
    ...
    impl Deserialize for PaymentMethodDetailsPaymentRecordEps {
    ...
    struct Builder<'a> {
        out: &'a mut Option<PaymentMethodDetailsPaymentRecordEps>,
        builder: PaymentMethodDetailsPaymentRecordEpsBuilder,
    }

    impl Visitor for Place<PaymentMethodDetailsPaymentRecordEps> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder: PaymentMethodDetailsPaymentRecordEpsBuilder::deser_default(),
            }))
        }
    }

    impl MapBuilder for PaymentMethodDetailsPaymentRecordEpsBuilder {
        type Out = PaymentMethodDetailsPaymentRecordEps;
        ...
        fn deser_default() -> Self {
            Self { bank: Some(None), verified_name: Some(None) }
        }
    ...
    impl ObjectDeser for PaymentMethodDetailsPaymentRecordEps {
        type Builder = PaymentMethodDetailsPaymentRecordEpsBuilder;
    }

    impl FromValueOpt for PaymentMethodDetailsPaymentRecordEps {
        fn from_value(v: Value) -> Option<Self> {
            let Value::Object(obj) = v else {
                return None;
            };
            let mut b = PaymentMethodDetailsPaymentRecordEpsBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
...
#[derive(Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum PaymentMethodDetailsPaymentRecordEpsBank {
...
impl PaymentMethodDetailsPaymentRecordEpsBank {
    pub fn as_str(&self) -> &str {
        use PaymentMethodDetailsPaymentRecordEpsBank::*;
        match self {
...
impl std::str::FromStr for PaymentMethodDetailsPaymentRecordEpsBank {
        ...
        match s {
            ...
            v => {
                tracing::warn!(
                    ...
                    v,
                    "PaymentMethodDetailsPaymentRecordEpsBank"
                );
...
impl std::fmt::Display for PaymentMethodDetailsPaymentRecordEpsBank {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
...
impl std::fmt::Debug for PaymentMethodDetailsPaymentRecordEpsBank {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl std::fmt::Debug for PaymentMethodDetailsPaymentRecordEpsBank {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentMethodDetailsPaymentRecordEpsBank)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
impl serde::Serialize for PaymentMethodDetailsPaymentRecordEpsBank {
...
impl miniserde::Deserialize for PaymentMethodDetailsPaymentRecordEpsBank {
    fn begin(out: &mut Option<Self>) -> &mut dyn miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl miniserde::de::Visitor for crate::Place<PaymentMethodDetailsPaymentRecordEpsBank> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentMethodDetailsPaymentRecordEpsBank::from_str(s).expect("infallible"));
        Ok(())
    }
}

stripe_types::impl_from_val_with_from_str!(PaymentMethodDetailsPaymentRecordEpsBank);
#[cfg(feature = "deserialize")]
impl<'de> serde::Deserialize<'de> for PaymentMethodDetailsPaymentRecordEpsBank {

...
pub struct IssuingCardAuthorizationControls {
    ...
    pub allowed_card_presences: Option<Vec<IssuingCardAuthorizationControlsAllowedCardPresences>>,
    ...
    /// Provide an empty value to unset this control.
    pub blocked_card_presences: Option<Vec<IssuingCardAuthorizationControlsBlockedCardPresences>>,
...
pub struct IssuingCardAuthorizationControlsBuilder {
    allowed_card_presences:
        Option<Option<Vec<IssuingCardAuthorizationControlsAllowedCardPresences>>>,
    ...
    blocked_card_presences:
        Option<Option<Vec<IssuingCardAuthorizationControlsBlockedCardPresences>>>,
...
const _: () = {
    ...
    impl Visitor for Place<IssuingCardAuthorizationControls> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder: IssuingCardAuthorizationControlsBuilder::deser_default(),
            }))
        }
    }
    ...
    impl FromValueOpt for IssuingCardAuthorizationControls {
...
#[derive(Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum IssuingCardAuthorizationControlsAllowedCardPresences {
    NotPresent,
    Present,
    /// An unrecognized value from Stripe. Should not be used as a request parameter.
    Unknown(String),
}
impl IssuingCardAuthorizationControlsAllowedCardPresences {
    pub fn as_str(&self) -> &str {
        use IssuingCardAuthorizationControlsAllowedCardPresences::*;
        match self {
...
impl std::str::FromStr for IssuingCardAuthorizationControlsAllowedCardPresences {
...
impl std::fmt::Display for IssuingCardAuthorizationControlsAllowedCardPresences {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
...
impl std::fmt::Debug for IssuingCardAuthorizationControlsAllowedCardPresences {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl std::fmt::Debug for IssuingCardAuthorizationControlsAllowedCardPresences {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(IssuingCardAuthorizationControlsAllowedCardPresences))
            .finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
impl serde::Serialize for IssuingCardAuthorizationControlsAllowedCardPresences {
...
impl miniserde::Deserialize for IssuingCardAuthorizationControlsAllowedCardPresences {
    fn begin(out: &mut Option<Self>) -> &mut dyn miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl miniserde::de::Visitor for crate::Place<IssuingCardAuthorizationControlsAllowedCardPresences> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            IssuingCardAuthorizationControlsAllowedCardPresences::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

stripe_types::impl_from_val_with_from_str!(IssuingCardAuthorizationControlsAllowedCardPresences);
#[cfg(feature = "deserialize")]
impl<'de> serde::Deserialize<'de> for IssuingCardAuthorizationControlsAllowedCardPresences {
...
impl miniserde::de::Visitor for crate::Place<IssuingCardAuthorizationControlsAllowedCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            IssuingCardAuthorizationControlsAllowedCategories::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

stripe_types::impl_from_val_with_from_str!(IssuingCardAuthorizationControlsAllowedCategories);
#[cfg(feature = "deserialize")]
...
#[derive(Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum IssuingCardAuthorizationControlsBlockedCardPresences {
    NotPresent,
    Present,
    /// An unrecognized value from Stripe. Should not be used as a request parameter.
    Unknown(String),
}
impl IssuingCardAuthorizationControlsBlockedCardPresences {
    pub fn as_str(&self) -> &str {
        use IssuingCardAuthorizationControlsBlockedCardPresences::*;
        match self {
            NotPresent => "not_present",
            Present => "present",
            Unknown(v) => v,
...
impl std::str::FromStr for IssuingCardAuthorizationControlsBlockedCardPresences {
    type Err = std::convert::Infallible;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use IssuingCardAuthorizationControlsBlockedCardPresences::*;
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "IssuingCardAuthorizationControlsBlockedCardPresences"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
...
impl std::fmt::Display for IssuingCardAuthorizationControlsBlockedCardPresences {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
#[cfg(not(feature = "redact-generated-debug"))]
impl std::fmt::Debug for IssuingCardAuthorizationControlsBlockedCardPresences {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl std::fmt::Debug for IssuingCardAuthorizationControlsBlockedCardPresences {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(IssuingCardAuthorizationControlsBlockedCardPresences))
            .finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
impl serde::Serialize for IssuingCardAuthorizationControlsBlockedCardPresences {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl miniserde::Deserialize for IssuingCardAuthorizationControlsBlockedCardPresences {
    fn begin(out: &mut Option<Self>) -> &mut dyn miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl miniserde::de::Visitor for crate::Place<IssuingCardAuthorizationControlsBlockedCardPresences> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            IssuingCardAuthorizationControlsBlockedCardPresences::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

stripe_types::impl_from_val_with_from_str!(IssuingCardAuthorizationControlsBlockedCardPresences);
#[cfg(feature = "deserialize")]
impl<'de> serde::Deserialize<'de> for IssuingCardAuthorizationControlsBlockedCardPresences {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: std::borrow::Cow<'de, str> = serde::Deserialize::deserialize(deserializer)?;
        Ok(Self::from_str(&s).expect("infallible"))
...
impl miniserde::de::Visitor for crate::Place<IssuingCardAuthorizationControlsBlockedCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            IssuingCardAuthorizationControlsBlockedCategories::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

stripe_types::impl_from_val_with_from_str!(IssuingCardAuthorizationControlsBlockedCategories);
#[cfg(feature = "deserialize")]

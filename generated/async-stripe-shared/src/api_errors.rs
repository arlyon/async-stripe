...
impl ApiErrorsCode {
    pub fn as_str(&self) -> &str {
        ...
        match self {
            ...
            CapabilityNotActive => "capability_not_active",
            ...
            InvalidCanceledSubscriptionFields => "invalid_canceled_subscription_fields",
            ...
            StorerCapabilityMissing => "storer_capability_missing",
            StorerCapabilityNotActive => "storer_capability_not_active",
...
impl std::str::FromStr for ApiErrorsCode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match s {
            ...
            "action_blocked" => Ok(ActionBlocked),
            ...
            "authentication_failure" => Ok(AuthenticationFailure),
            ...
            "capability_not_active" => Ok(CapabilityNotActive),
            ...
            "expired_payment_method" => Ok(ExpiredPaymentMethod),
            ...
            "invalid_canceled_subscription_fields" => Ok(InvalidCanceledSubscriptionFields),
            ...
            "payment_method_restricted" => Ok(PaymentMethodRestricted),
            ...
            "request_blocked" => Ok(RequestBlocked),
            ...
            "storer_capability_missing" => Ok(StorerCapabilityMissing),
            "storer_capability_not_active" => Ok(StorerCapabilityNotActive),

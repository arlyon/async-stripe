...
const _: () = {
    ...
    impl MapBuilder for SourceTypeKlarnaBuilder {
        ...
        fn deser_default() -> Self {
            Self {
                background_image_url: Some(None),
                client_token: Some(None),
                first_name: Some(None),
                last_name: Some(None),
                locale: Some(None),
                logo_url: Some(None),
                page_title: Some(None),
                pay_later_asset_urls_descriptive: Some(None),
                pay_later_asset_urls_standard: Some(None),
                pay_later_name: Some(None),
                pay_later_redirect_url: Some(None),
                pay_now_asset_urls_descriptive: Some(None),
                pay_now_asset_urls_standard: Some(None),
                pay_now_name: Some(None),
                pay_now_redirect_url: Some(None),
                pay_over_time_asset_urls_descriptive: Some(None),
                pay_over_time_asset_urls_standard: Some(None),
                pay_over_time_name: Some(None),
                pay_over_time_redirect_url: Some(None),
                payment_method_categories: Some(None),
                purchase_country: Some(None),
                purchase_type: Some(None),
                redirect_url: Some(None),
                shipping_delay: Some(None),
                shipping_first_name: Some(None),
                shipping_last_name: Some(None),
            }
        }

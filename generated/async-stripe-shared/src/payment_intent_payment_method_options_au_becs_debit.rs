...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsAuBecsDebit {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentPaymentMethodOptionsAuBecsDebit").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentIntentPaymentMethodOptionsAuBecsDebit {
                setup_future_usage,
                target_date,
            });
            Ok(())
...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsAuBecsDebitSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentIntentPaymentMethodOptionsAuBecsDebitSetupFutureUsage))
...
impl stripe_miniserde::Deserialize for PaymentIntentPaymentMethodOptionsAuBecsDebitSetupFutureUsage {

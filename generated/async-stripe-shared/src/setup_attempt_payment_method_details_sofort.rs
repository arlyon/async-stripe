...
const _: () = {
    ...
    impl Visitor for Place<SetupAttemptPaymentMethodDetailsSofort> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder: SetupAttemptPaymentMethodDetailsSofortBuilder::deser_default(),
            }))
        }
    }
    ...
    impl FromValueOpt for SetupAttemptPaymentMethodDetailsSofort {
        fn from_value(v: Value) -> Option<Self> {
            let Value::Object(obj) = v else {
                return None;
            };
            let mut b = SetupAttemptPaymentMethodDetailsSofortBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
...
impl miniserde::de::Visitor
    for crate::Place<SetupAttemptPaymentMethodDetailsSofortPreferredLanguage>
{
...
stripe_types::impl_from_val_with_from_str!(SetupAttemptPaymentMethodDetailsSofortPreferredLanguage);

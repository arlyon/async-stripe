...
impl miniserde::de::Visitor for crate::Place<PaymentMethodOptionsKrCardCaptureMethod> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            PaymentMethodOptionsKrCardCaptureMethod::from_str(s).map_err(|_| miniserde::Error)?,
        );
        Ok(())
    }
}
...
impl<'de> serde::Deserialize<'de> for PaymentMethodOptionsKrCardCaptureMethod {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str(&s).map_err(|_| {
            serde::de::Error::custom("Unknown value for PaymentMethodOptionsKrCardCaptureMethod")
        })
    }
}
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
...
impl miniserde::de::Visitor for crate::Place<PaymentMethodOptionsKrCardSetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            PaymentMethodOptionsKrCardSetupFutureUsage::from_str(s)
...
impl<'de> serde::Deserialize<'de> for PaymentMethodOptionsKrCardSetupFutureUsage {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        let s: std::borrow::Cow<'de, str> = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(&s).map_err(|_| {
            serde::de::Error::custom("Unknown value for PaymentMethodOptionsKrCardSetupFutureUsage")
        })
    }
}

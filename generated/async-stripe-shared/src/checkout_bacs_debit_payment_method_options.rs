...
pub struct CheckoutBacsDebitPaymentMethodOptions {
    pub mandate_options: Option<stripe_shared::CheckoutPaymentMethodOptionsMandateOptionsBacsDebit>,
...
impl std::fmt::Debug for CheckoutBacsDebitPaymentMethodOptions {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("CheckoutBacsDebitPaymentMethodOptions").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct CheckoutBacsDebitPaymentMethodOptionsBuilder {
    mandate_options:
        Option<Option<stripe_shared::CheckoutPaymentMethodOptionsMandateOptionsBacsDebit>>,
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(CheckoutBacsDebitPaymentMethodOptions {
                mandate_options,
                setup_future_usage,
                target_date,
            });
...
impl std::fmt::Debug for CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage))
...
impl stripe_miniserde::Deserialize for CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage {
    ...
    for crate::Place<CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage>
{
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

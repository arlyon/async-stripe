...
impl std::fmt::Debug for AccountFutureRequirements {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("AccountFutureRequirements").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(AccountFutureRequirements {
                alternatives,
                current_deadline,
                currently_due,
                disabled_reason,
...
impl std::fmt::Debug for AccountFutureRequirementsDisabledReason {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(AccountFutureRequirementsDisabledReason)).finish_non_exhaustive()
    }
}
...
impl stripe_miniserde::Deserialize for AccountFutureRequirementsDisabledReason {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<AccountFutureRequirementsDisabledReason> {

...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentMethodDetailsInteracPresentReceipt {
                account_type,
                application_cryptogram,
                application_preferred_name,
                authorization_code,
...
impl stripe_miniserde::Deserialize for PaymentMethodDetailsInteracPresentReceiptAccountType {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<PaymentMethodDetailsInteracPresentReceiptAccountType> {

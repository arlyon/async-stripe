...
impl std::fmt::Debug for DisputeTransactionShippingAddress {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("DisputeTransactionShippingAddress").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct DisputeTransactionShippingAddressBuilder {
...
const _: () = {
    ...
    impl Deserialize for DisputeTransactionShippingAddress {
    ...
    struct Builder<'a> {
        out: &'a mut Option<DisputeTransactionShippingAddress>,
        builder: DisputeTransactionShippingAddressBuilder,
    }

    impl Visitor for Place<DisputeTransactionShippingAddress> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder: DisputeTransactionShippingAddressBuilder::deser_default(),
            }))
        }
    }

    impl MapBuilder for DisputeTransactionShippingAddressBuilder {
        type Out = DisputeTransactionShippingAddress;
    ...
    impl ObjectDeser for DisputeTransactionShippingAddress {
        type Builder = DisputeTransactionShippingAddressBuilder;
    }
    ...
    impl FromValueOpt for DisputeTransactionShippingAddress {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = DisputeTransactionShippingAddressBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {

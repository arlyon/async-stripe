...
impl std::fmt::Debug for PaymentIntentNextActionKonbiniLawson {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentNextActionKonbiniLawson").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out =
                Some(PaymentIntentNextActionKonbiniLawson { confirmation_number, payment_code });
            Ok(())
        }
    }
};

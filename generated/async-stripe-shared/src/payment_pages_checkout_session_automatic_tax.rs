...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentPagesCheckoutSessionAutomaticTax {
                enabled,
                liability,
                provider,
                status,
...
impl stripe_miniserde::Deserialize for PaymentPagesCheckoutSessionAutomaticTaxStatus {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<PaymentPagesCheckoutSessionAutomaticTaxStatus> {

...
impl std::fmt::Debug for PaymentMethodDetailsIdeal {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentMethodDetailsIdeal").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
impl std::fmt::Debug for PaymentMethodDetailsIdealBank {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentMethodDetailsIdealBank)).finish_non_exhaustive()
    }
}
...
impl std::fmt::Debug for PaymentMethodDetailsIdealBic {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentMethodDetailsIdealBic)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]

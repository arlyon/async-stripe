...
impl std::fmt::Debug for PaymentPagesCheckoutSessionCustomFieldsNumeric {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentPagesCheckoutSessionCustomFieldsNumeric").finish_non_exhaustive()
    }
}
#[doc(hidden)]

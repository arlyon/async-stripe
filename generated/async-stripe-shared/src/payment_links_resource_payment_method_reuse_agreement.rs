...
impl std::fmt::Debug for PaymentLinksResourcePaymentMethodReuseAgreement {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentLinksResourcePaymentMethodReuseAgreement").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentLinksResourcePaymentMethodReuseAgreement { position });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for PaymentLinksResourcePaymentMethodReuseAgreementPosition {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentLinksResourcePaymentMethodReuseAgreementPosition))
...
impl stripe_miniserde::Deserialize for PaymentLinksResourcePaymentMethodReuseAgreementPosition {

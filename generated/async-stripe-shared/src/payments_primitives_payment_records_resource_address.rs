...
impl std::fmt::Debug for PaymentsPrimitivesPaymentRecordsResourceAddress {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentsPrimitivesPaymentRecordsResourceAddress").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct PaymentsPrimitivesPaymentRecordsResourceAddressBuilder {
...
const _: () = {
    ...
    struct Builder<'a> {
        out: &'a mut Option<PaymentsPrimitivesPaymentRecordsResourceAddress>,
        builder: PaymentsPrimitivesPaymentRecordsResourceAddressBuilder,
    }

    impl Visitor for Place<PaymentsPrimitivesPaymentRecordsResourceAddress> {

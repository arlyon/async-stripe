...
pub struct PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions {
    ...
    pub setup_future_usage:
        Option<PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage>,
}
...
pub struct PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsBuilder {
    ...
    setup_future_usage:
        Option<Option<PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage>>,
}
...
#[derive(Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage {
    None,
    /// An unrecognized value from Stripe. Should not be used as a request parameter.
    Unknown(String),
}
impl PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage {
    pub fn as_str(&self) -> &str {
        use PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage::*;
        match self {
            None => "none",
            Unknown(v) => v,
        }
...
impl std::str::FromStr
    for PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage
{
    type Err = std::convert::Infallible;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage::*;
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
...
impl miniserde::de::Visitor
    for crate::Place<PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage>
{
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsSetupFutureUsage::from_str(s)
                .expect("infallible"),
        );
        Ok(())
    }

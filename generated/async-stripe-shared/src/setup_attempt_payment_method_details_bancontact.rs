...
impl std::fmt::Debug for SetupAttemptPaymentMethodDetailsBancontact {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SetupAttemptPaymentMethodDetailsBancontact").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(SetupAttemptPaymentMethodDetailsBancontact {
                bank_code,
                bank_name,
                bic,
                generated_sepa_debit,
...
impl std::fmt::Debug for SetupAttemptPaymentMethodDetailsBancontactPreferredLanguage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(SetupAttemptPaymentMethodDetailsBancontactPreferredLanguage))
...
impl stripe_miniserde::Deserialize for SetupAttemptPaymentMethodDetailsBancontactPreferredLanguage {
...
impl stripe_miniserde::de::Visitor
    for crate::Place<SetupAttemptPaymentMethodDetailsBancontactPreferredLanguage>
{
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            SetupAttemptPaymentMethodDetailsBancontactPreferredLanguage::from_str(s)
                .expect("infallible"),
        );
        Ok(())
    }

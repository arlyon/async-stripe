...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(IssuingCardSpendingLimit { amount, categories, interval });
            Ok(())
        }
    }
};
...
impl stripe_miniserde::Deserialize for IssuingCardSpendingLimitCategories {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<IssuingCardSpendingLimitCategories> {
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(IssuingCardSpendingLimitCategories::from_str(s).expect("infallible"));
        Ok(())
    }
}
...
impl stripe_miniserde::Deserialize for IssuingCardSpendingLimitInterval {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<IssuingCardSpendingLimitInterval> {
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(IssuingCardSpendingLimitInterval::from_str(s).expect("infallible"));
        Ok(())
    }
}
#[cfg(feature = "deserialize")]

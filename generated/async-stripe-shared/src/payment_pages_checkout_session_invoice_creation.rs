...
impl std::fmt::Debug for PaymentPagesCheckoutSessionInvoiceCreation {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentPagesCheckoutSessionInvoiceCreation").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentPagesCheckoutSessionInvoiceCreation { enabled, invoice_data });
            Ok(())
        }
    }
};

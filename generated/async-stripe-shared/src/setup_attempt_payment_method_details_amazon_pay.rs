...
impl std::fmt::Debug for SetupAttemptPaymentMethodDetailsAmazonPay {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SetupAttemptPaymentMethodDetailsAmazonPay").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(SetupAttemptPaymentMethodDetailsAmazonPay {});
            Ok(())
        }
    }
};

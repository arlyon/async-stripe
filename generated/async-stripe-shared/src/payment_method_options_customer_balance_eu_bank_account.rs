...
impl std::fmt::Debug for PaymentMethodOptionsCustomerBalanceEuBankAccount {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentMethodOptionsCustomerBalanceEuBankAccount").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentMethodOptionsCustomerBalanceEuBankAccount { country });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for PaymentMethodOptionsCustomerBalanceEuBankAccountCountry {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentMethodOptionsCustomerBalanceEuBankAccountCountry))
...
impl stripe_miniserde::Deserialize for PaymentMethodOptionsCustomerBalanceEuBankAccountCountry {

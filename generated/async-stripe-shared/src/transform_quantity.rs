...
impl std::fmt::Debug for TransformQuantity {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("TransformQuantity").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(TransformQuantity { divide_by, round });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for TransformQuantityRound {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(TransformQuantityRound)).finish_non_exhaustive()
    }
}
...
impl stripe_miniserde::Deserialize for TransformQuantityRound {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<TransformQuantityRound> {

...
pub struct SetupIntentPaymentMethodOptionsUpi {
    pub mandate_options: Option<stripe_shared::PaymentMethodOptionsMandateOptionsUpi>,
}
#[cfg(feature = "redact-generated-debug")]
impl std::fmt::Debug for SetupIntentPaymentMethodOptionsUpi {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SetupIntentPaymentMethodOptionsUpi").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct SetupIntentPaymentMethodOptionsUpiBuilder {
    mandate_options: Option<Option<stripe_shared::PaymentMethodOptionsMandateOptionsUpi>>,
}
...
const _: () = {
    ...
    impl Deserialize for SetupIntentPaymentMethodOptionsUpi {
    ...
    struct Builder<'a> {
        out: &'a mut Option<SetupIntentPaymentMethodOptionsUpi>,
        builder: SetupIntentPaymentMethodOptionsUpiBuilder,
    }

    impl Visitor for Place<SetupIntentPaymentMethodOptionsUpi> {
    ...
    impl MapBuilder for SetupIntentPaymentMethodOptionsUpiBuilder {
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            Some(Self::Out { mandate_options: self.mandate_options.take().flatten() })
        }
    }

...
impl std::fmt::Debug for SubscriptionsTrialsResourceEndBehavior {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SubscriptionsTrialsResourceEndBehavior").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(SubscriptionsTrialsResourceEndBehavior { missing_payment_method });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod))
...
impl stripe_miniserde::Deserialize for SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod {

...
pub struct SubscriptionsResourceTrialSettingsTrialSettings {
    pub end_behavior: stripe_shared::SubscriptionsResourceTrialSettingsEndBehavior,
}
#[cfg(feature = "redact-generated-debug")]
impl std::fmt::Debug for SubscriptionsResourceTrialSettingsTrialSettings {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("SubscriptionsResourceTrialSettingsTrialSettings").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct SubscriptionsResourceTrialSettingsTrialSettingsBuilder {
    end_behavior: Option<stripe_shared::SubscriptionsResourceTrialSettingsEndBehavior>,
}
...
const _: () = {
    ...
    impl Deserialize for SubscriptionsResourceTrialSettingsTrialSettings {
    ...
    struct Builder<'a> {
        out: &'a mut Option<SubscriptionsResourceTrialSettingsTrialSettings>,
        builder: SubscriptionsResourceTrialSettingsTrialSettingsBuilder,
    }

    impl Visitor for Place<SubscriptionsResourceTrialSettingsTrialSettings> {

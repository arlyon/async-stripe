...
impl std::fmt::Debug for PaymentPagesCheckoutSessionShippingCost {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentPagesCheckoutSessionShippingCost").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentPagesCheckoutSessionShippingCost {
                amount_subtotal,
                amount_tax,
                amount_total,
                shipping_rate,

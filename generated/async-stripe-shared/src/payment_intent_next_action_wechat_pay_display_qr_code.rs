...
impl std::fmt::Debug for PaymentIntentNextActionWechatPayDisplayQrCode {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentNextActionWechatPayDisplayQrCode").finish_non_exhaustive()
    }
}
#[doc(hidden)]

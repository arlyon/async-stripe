...
impl std::fmt::Debug for PaymentPagesCheckoutSessionTaxIdCollection {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentPagesCheckoutSessionTaxIdCollection").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentPagesCheckoutSessionTaxIdCollection { enabled, required });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for PaymentPagesCheckoutSessionTaxIdCollectionRequired {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentPagesCheckoutSessionTaxIdCollectionRequired))
...
impl stripe_miniserde::Deserialize for PaymentPagesCheckoutSessionTaxIdCollectionRequired {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<PaymentPagesCheckoutSessionTaxIdCollectionRequired> {

...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsBacsDebit {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentPaymentMethodOptionsBacsDebit").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentIntentPaymentMethodOptionsBacsDebit {
                mandate_options,
                setup_future_usage,
                target_date,
            });
...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage))
...
impl stripe_miniserde::Deserialize for PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage {

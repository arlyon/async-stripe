...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(SetupIntentPaymentMethodOptionsCardMandateOptions {
                amount,
                amount_type,
                currency,
                description,
...
impl stripe_miniserde::Deserialize for SetupIntentPaymentMethodOptionsCardMandateOptionsAmountType {
...
impl stripe_miniserde::Deserialize for SetupIntentPaymentMethodOptionsCardMandateOptionsInterval {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}
...
impl stripe_miniserde::Deserialize for SetupIntentPaymentMethodOptionsCardMandateOptionsSupportedTypes {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

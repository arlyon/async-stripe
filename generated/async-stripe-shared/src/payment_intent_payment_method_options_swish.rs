...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsSwish {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentIntentPaymentMethodOptionsSwish").finish_non_exhaustive()
    }
}
#[doc(hidden)]
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            let (Some(reference), Some(setup_future_usage)) =
                (self.builder.reference.take(), self.builder.setup_future_usage.take())
            else {
                return Ok(());
            };
            *self.out =
                Some(PaymentIntentPaymentMethodOptionsSwish { reference, setup_future_usage });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for PaymentIntentPaymentMethodOptionsSwishSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(PaymentIntentPaymentMethodOptionsSwishSetupFutureUsage))
...
impl stripe_miniserde::Deserialize for PaymentIntentPaymentMethodOptionsSwishSetupFutureUsage {

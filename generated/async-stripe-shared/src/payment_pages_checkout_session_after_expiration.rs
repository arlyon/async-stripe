...
pub struct PaymentPagesCheckoutSessionAfterExpiration {
    ...
    pub recovery: Option<stripe_shared::PaymentPagesCheckoutSessionAfterExpirationRecovery>,
}
#[cfg(feature = "redact-generated-debug")]
impl std::fmt::Debug for PaymentPagesCheckoutSessionAfterExpiration {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentPagesCheckoutSessionAfterExpiration").finish_non_exhaustive()
    }
}
#[doc(hidden)]
pub struct PaymentPagesCheckoutSessionAfterExpirationBuilder {
    recovery: Option<Option<stripe_shared::PaymentPagesCheckoutSessionAfterExpirationRecovery>>,
}
...
const _: () = {
    ...
    impl MapBuilder for PaymentPagesCheckoutSessionAfterExpirationBuilder {
        ...
        fn deser_default() -> Self {
            Self { recovery: Some(None) }
        }

        fn take_out(&mut self) -> Option<Self::Out> {
            Some(Self::Out { recovery: self.recovery.take().flatten() })
        }
    }

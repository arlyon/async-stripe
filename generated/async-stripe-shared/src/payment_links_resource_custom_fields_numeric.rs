...
impl std::fmt::Debug for PaymentLinksResourceCustomFieldsNumeric {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentLinksResourceCustomFieldsNumeric").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentLinksResourceCustomFieldsNumeric {
                default_value,
                maximum_length,
                minimum_length,
            });

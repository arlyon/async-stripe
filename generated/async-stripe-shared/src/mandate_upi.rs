...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(MandateUpi { amount, amount_type, description, end_date });
            Ok(())
        }
    }
};
...
impl stripe_miniserde::Deserialize for MandateUpiAmountType {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<MandateUpiAmountType> {

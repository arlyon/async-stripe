...
impl std::fmt::Debug for PaymentLinksResourceCompletionBehaviorConfirmationPage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentLinksResourceCompletionBehaviorConfirmationPage")
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out =
                Some(PaymentLinksResourceCompletionBehaviorConfirmationPage { custom_message });
            Ok(())
        }
    }
};

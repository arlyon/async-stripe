...
impl std::fmt::Debug for PaymentPagesCheckoutSessionCustomFieldsDropdown {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("PaymentPagesCheckoutSessionCustomFieldsDropdown").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentPagesCheckoutSessionCustomFieldsDropdown {
                default_value,
                options,
                value,
            });

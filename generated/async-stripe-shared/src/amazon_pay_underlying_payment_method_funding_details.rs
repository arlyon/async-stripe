...
impl std::fmt::Debug for AmazonPayUnderlyingPaymentMethodFundingDetails {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct("AmazonPayUnderlyingPaymentMethodFundingDetails").finish_non_exhaustive()
    }
}
#[doc(hidden)]
...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(AmazonPayUnderlyingPaymentMethodFundingDetails { card, type_ });
            Ok(())
        }
    }
};
...
impl std::fmt::Debug for AmazonPayUnderlyingPaymentMethodFundingDetailsType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(AmazonPayUnderlyingPaymentMethodFundingDetailsType))
...
impl stripe_miniserde::Deserialize for AmazonPayUnderlyingPaymentMethodFundingDetailsType {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<AmazonPayUnderlyingPaymentMethodFundingDetailsType> {
    fn string(&mut self, s: &str) -> stripe_miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            AmazonPayUnderlyingPaymentMethodFundingDetailsType::from_str(s).expect("infallible"),
        );
        Ok(())
    }
}

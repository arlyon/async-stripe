...
pub struct CheckoutSamsungPayPaymentMethodOptions {
    ...
    pub setup_future_usage: Option<CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage>,
}
...
pub struct CheckoutSamsungPayPaymentMethodOptionsBuilder {
    ...
    setup_future_usage: Option<Option<CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage>>,
}
...
#[derive(Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    None,
    /// An unrecognized value from Stripe. Should not be used as a request parameter.
    Unknown(String),
}
impl CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    pub fn as_str(&self) -> &str {
        use CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage::*;
        match self {
            None => "none",
            Unknown(v) => v,
        }
...
impl std::str::FromStr for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    type Err = std::convert::Infallible;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage::*;
        match s {
            ...
            v => {
                tracing::warn!(
                    "Unknown value '{}' for enum '{}'",
                    v,
                    "CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage"
                );
                Ok(Unknown(v.to_owned()))
            }
        }
...
impl std::fmt::Display for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
#[cfg(not(feature = "redact-generated-debug"))]
impl std::fmt::Debug for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
...
impl std::fmt::Debug for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage))
            .finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]
impl serde::Serialize for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl miniserde::Deserialize for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    fn begin(out: &mut Option<Self>) -> &mut dyn miniserde::de::Visitor {
        crate::Place::new(out)
    }
}
...
impl miniserde::de::Visitor
    for crate::Place<CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage>
{
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(
            CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage::from_str(s)
                .expect("infallible"),
        );
        Ok(())
    }
...
stripe_types::impl_from_val_with_from_str!(CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage);
#[cfg(feature = "deserialize")]
impl<'de> serde::Deserialize<'de> for CheckoutSamsungPayPaymentMethodOptionsSetupFutureUsage {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: std::borrow::Cow<'de, str> = serde::Deserialize::deserialize(deserializer)?;
        Ok(Self::from_str(&s).expect("infallible"))

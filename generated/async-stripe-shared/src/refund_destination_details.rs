...
pub struct RefundDestinationDetails {
    ...
    pub scalapay: Option<stripe_shared::DestinationDetailsUnimplemented>,
...
pub struct RefundDestinationDetailsBuilder {
    ...
    scalapay: Option<Option<stripe_shared::DestinationDetailsUnimplemented>>,
    ...
    impl MapBuilder for RefundDestinationDetailsBuilder {
        ...
        fn deser_default() -> Self {
            Self {
                ...
                au_bank_transfer: Some(None),
                blik: Some(None),
                br_bank_transfer: Some(None),
                card: Some(None),
                cashapp: Some(None),
                crypto: Some(None),
                customer_cash_balance: Some(None),
                eps: Some(None),
                eu_bank_transfer: Some(None),
                gb_bank_transfer: Some(None),
                giropay: Some(None),
                grabpay: Some(None),
                jp_bank_transfer: Some(None),
                klarna: Some(None),
                mb_way: Some(None),
                multibanco: Some(None),
                mx_bank_transfer: Some(None),
                nz_bank_transfer: Some(None),
                p24: Some(None),
                paynow: Some(None),
                paypal: Some(None),
                pix: Some(None),
                ...
                sofort: Some(None),
                swish: Some(None),
                th_bank_transfer: Some(None),
                twint: Some(None),
                type_: None,
                us_bank_transfer: Some(None),

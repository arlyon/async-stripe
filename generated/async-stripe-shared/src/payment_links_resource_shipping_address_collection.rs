...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(PaymentLinksResourceShippingAddressCollection { allowed_countries });
            Ok(())
        }
    }
};
...
impl stripe_miniserde::Deserialize for PaymentLinksResourceShippingAddressCollectionAllowedCountries {

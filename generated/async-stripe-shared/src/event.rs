...
impl EventType {
    pub fn as_str(&self) -> &str {
        ...
        match self {
            ...
            BillingCreditBalanceTransactionCreated => "billing.credit_balance_transaction.created",
            BillingCreditGrantCreated => "billing.credit_grant.created",
            BillingCreditGrantUpdated => "billing.credit_grant.updated",
            BillingMeterCreated => "billing.meter.created",
            BillingMeterDeactivated => "billing.meter.deactivated",
            BillingMeterReactivated => "billing.meter.reactivated",
            BillingMeterUpdated => "billing.meter.updated",
            ...
            ReserveHoldCreated => "reserve.hold.created",
            ReserveHoldUpdated => "reserve.hold.updated",
            ReservePlanCreated => "reserve.plan.created",
            ReservePlanDisabled => "reserve.plan.disabled",
            ReservePlanExpired => "reserve.plan.expired",
            ReservePlanUpdated => "reserve.plan.updated",
            ReserveReleaseCreated => "reserve.release.created",
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match s {
            ...
            "billing.credit_balance_transaction.created" => {
                Ok(BillingCreditBalanceTransactionCreated)
            }
            "billing.credit_grant.created" => Ok(BillingCreditGrantCreated),
            "billing.credit_grant.updated" => Ok(BillingCreditGrantUpdated),
            "billing.meter.created" => Ok(BillingMeterCreated),
            "billing.meter.deactivated" => Ok(BillingMeterDeactivated),
            "billing.meter.reactivated" => Ok(BillingMeterReactivated),
            "billing.meter.updated" => Ok(BillingMeterUpdated),
            ...
            "reserve.hold.created" => Ok(ReserveHoldCreated),
            "reserve.hold.updated" => Ok(ReserveHoldUpdated),
            "reserve.plan.created" => Ok(ReservePlanCreated),
            "reserve.plan.disabled" => Ok(ReservePlanDisabled),
            "reserve.plan.expired" => Ok(ReservePlanExpired),
            "reserve.plan.updated" => Ok(ReservePlanUpdated),
            "reserve.release.created" => Ok(ReserveReleaseCreated),
...
impl std::fmt::Debug for EventType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.debug_struct(stringify!(EventType)).finish_non_exhaustive()
    }
}
#[cfg(feature = "serialize")]

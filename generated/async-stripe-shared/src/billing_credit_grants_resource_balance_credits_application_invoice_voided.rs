...
const _: () = {
    ...
    impl Visitor for Place<BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
            out: &mut self.out,
            builder: BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedBuilder::deser_default(),
        }))
        }
    }

    impl MapBuilder for BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedBuilder {
        type Out = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided;
        ...
        fn deser_default() -> Self {
            Self { invoice: None, invoice_line_item: None }
        }
    ...
    impl ObjectDeser for BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided {
        type Builder = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedBuilder;
    }

    impl FromValueOpt for BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoided {
        fn from_value(v: Value) -> Option<Self> {
            let Value::Object(obj) = v else {
                return None;
            };
            let mut b = BillingCreditGrantsResourceBalanceCreditsApplicationInvoiceVoidedBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {

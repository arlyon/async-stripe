...
const _: () = {
    ...
    impl Map for Builder<'_> {
        ...
        fn finish(&mut self) -> Result<()> {
            ...
            *self.out = Some(SubscriptionPaymentMethodOptionsCard {
                mandate_options,
                network,
                request_three_d_secure,
            });
...
impl stripe_miniserde::Deserialize for SubscriptionPaymentMethodOptionsCardNetwork {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

impl stripe_miniserde::de::Visitor for crate::Place<SubscriptionPaymentMethodOptionsCardNetwork> {
...
impl stripe_miniserde::Deserialize for SubscriptionPaymentMethodOptionsCardRequestThreeDSecure {
    fn begin(out: &mut Option<Self>) -> &mut dyn stripe_miniserde::de::Visitor {
        crate::Place::new(out)
    }
}

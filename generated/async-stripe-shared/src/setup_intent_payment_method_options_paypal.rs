...
const _: () = {
    ...
    impl Visitor for Place<SetupIntentPaymentMethodOptionsPaypal> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder {
                out: &mut self.out,
                builder: SetupIntentPaymentMethodOptionsPaypalBuilder::deser_default(),
            }))
        }
    }
    ...
    impl MapBuilder for SetupIntentPaymentMethodOptionsPaypalBuilder {
        ...
        fn deser_default() -> Self {
            Self { billing_agreement_id: Some(None) }
        }

        fn take_out(&mut self) -> Option<Self::Out> {
            Some(Self::Out { billing_agreement_id: self.billing_agreement_id.take().flatten() })
        }
    }
    ...
    impl FromValueOpt for SetupIntentPaymentMethodOptionsPaypal {

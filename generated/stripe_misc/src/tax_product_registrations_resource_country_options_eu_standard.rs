...
const _: () = {
    ...
    impl FromValueOpt for TaxProductRegistrationsResourceCountryOptionsEuStandard {
        fn from_value(v: Value) -> Option<Self> {
            ...
            let mut b = TaxProductRegistrationsResourceCountryOptionsEuStandardBuilder::deser_default();
            for (k, v) in obj {
                match k.as_str() {
                    "place_of_supply_scheme" => b.place_of_supply_scheme = Some(FromValueOpt::from_value(v)?),
...
#[cfg(feature = "min-ser")]
stripe_types::impl_from_val_with_from_str!(TaxProductRegistrationsResourceCountryOptionsEuStandardPlaceOfSupplyScheme);

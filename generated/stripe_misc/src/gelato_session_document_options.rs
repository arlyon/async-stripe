        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "require_live_capture" => b.require_live_capture = Some(FromValueOpt::from_value(v)?),
                    "require_matching_selfie" => b.require_matching_selfie = Some(FromValueOpt::from_value(v)?),

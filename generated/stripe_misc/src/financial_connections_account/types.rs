    ...
    impl MapBuilder for FinancialConnectionsAccountBuilder {
        ...
        fn key(&mut self, k: &str) -> Result<&mut dyn Visitor> {
            Ok(match k {
                ...
                "supported_payment_method_types" => Deserialize::begin(&mut self.supported_payment_method_types),
        ...
        fn from_value(v: Value) -> Option<Self> {
            ...
            for (k, v) in obj {
                match k.as_str() {
                    ...
                    "supported_payment_method_types" => b.supported_payment_method_types = Some(FromValueOpt::from_value(v)?),
